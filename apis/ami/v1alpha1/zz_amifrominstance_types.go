...
var (
	...
	AmiFromInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: AmiFromInstanceKind}.String()
	AmiFromInstanceKindAPIVersion   = AmiFromInstanceKind + "." + GroupVersion.String()
	AmiFromInstanceGroupVersionKind = GroupVersion.WithKind(AmiFromInstanceKind)
)
