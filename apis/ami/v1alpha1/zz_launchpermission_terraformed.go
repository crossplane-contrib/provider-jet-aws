...
// GetTerraformResourceIDField returns Terraform identifier field for this LaunchPermission
func (tr *LaunchPermission) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *LaunchPermission) GetObservation() (map[string]interface{}, error) {
...
func (tr *LaunchPermission) SetObservation(obs map[string]interface{}) error {
...
func (tr *LaunchPermission) GetParameters() (map[string]interface{}, error) {
...
func (tr *LaunchPermission) SetParameters(params map[string]interface{}) error {
