...
var (
	AmiKind             = "Ami"
	AmiGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AmiKind}.String()
	AmiKindAPIVersion   = AmiKind + "." + v1alpha1.GroupVersion.String()
	AmiGroupVersionKind = v1alpha1.GroupVersion.WithKind(AmiKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Ami{}, &AmiList{})
}
