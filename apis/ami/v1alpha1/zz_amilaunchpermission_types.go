...
var (
	...
	AmiLaunchPermissionGroupKind        = schema.GroupKind{Group: Group, Kind: AmiLaunchPermissionKind}.String()
	AmiLaunchPermissionKindAPIVersion   = AmiLaunchPermissionKind + "." + GroupVersion.String()
	AmiLaunchPermissionGroupVersionKind = GroupVersion.WithKind(AmiLaunchPermissionKind)
)
