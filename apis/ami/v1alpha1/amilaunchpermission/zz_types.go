...
// AmiLaunchPermission is the Schema for the AmiLaunchPermissions API
...
var (
	AmiLaunchPermissionKind             = "AmiLaunchPermission"
	AmiLaunchPermissionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AmiLaunchPermissionKind}.String()
	AmiLaunchPermissionKindAPIVersion   = AmiLaunchPermissionKind + "." + v1alpha1.GroupVersion.String()
	AmiLaunchPermissionGroupVersionKind = v1alpha1.GroupVersion.WithKind(AmiLaunchPermissionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AmiLaunchPermission{}, &AmiLaunchPermissionList{})
}
