...
// +groupName=cloud9.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/cloud9/v1alpha1"
)
...
var (
	...
	Cloud9EnvironmentEc2GroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Cloud9EnvironmentEc2Kind}.String()
	Cloud9EnvironmentEc2KindAPIVersion   = Cloud9EnvironmentEc2Kind + "." + v1alpha1.GroupVersion.String()
	Cloud9EnvironmentEc2GroupVersionKind = v1alpha1.GroupVersion.WithKind(Cloud9EnvironmentEc2Kind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Cloud9EnvironmentEc2{}, &Cloud9EnvironmentEc2List{})
}
