...
var (
	EnvironmentEc2Kind             = "EnvironmentEc2"
	EnvironmentEc2GroupKind        = schema.GroupKind{Group: Group, Kind: EnvironmentEc2Kind}.String()
	EnvironmentEc2KindAPIVersion   = EnvironmentEc2Kind + "." + GroupVersion.String()
	EnvironmentEc2GroupVersionKind = GroupVersion.WithKind(EnvironmentEc2Kind)
)
