...
var (
	...
	SesEmailIdentityGroupKind        = schema.GroupKind{Group: Group, Kind: SesEmailIdentityKind}.String()
	SesEmailIdentityKindAPIVersion   = SesEmailIdentityKind + "." + GroupVersion.String()
	SesEmailIdentityGroupVersionKind = GroupVersion.WithKind(SesEmailIdentityKind)
)
