...
var (
	ReceiptRuleSetKind             = "ReceiptRuleSet"
	ReceiptRuleSetGroupKind        = schema.GroupKind{Group: Group, Kind: ReceiptRuleSetKind}.String()
	ReceiptRuleSetKindAPIVersion   = ReceiptRuleSetKind + "." + GroupVersion.String()
	ReceiptRuleSetGroupVersionKind = GroupVersion.WithKind(ReceiptRuleSetKind)
)
