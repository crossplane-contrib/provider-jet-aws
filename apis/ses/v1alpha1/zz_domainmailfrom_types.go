...
var (
	DomainMailFromKind             = "DomainMailFrom"
	DomainMailFromGroupKind        = schema.GroupKind{Group: Group, Kind: DomainMailFromKind}.String()
	DomainMailFromKindAPIVersion   = DomainMailFromKind + "." + GroupVersion.String()
	DomainMailFromGroupVersionKind = GroupVersion.WithKind(DomainMailFromKind)
)
