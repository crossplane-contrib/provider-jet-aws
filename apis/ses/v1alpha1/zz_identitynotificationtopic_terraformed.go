...
// GetTerraformResourceIDField returns Terraform identifier field for this IdentityNotificationTopic
func (tr *IdentityNotificationTopic) GetTerraformResourceIDField() string {
	return "id"
}
