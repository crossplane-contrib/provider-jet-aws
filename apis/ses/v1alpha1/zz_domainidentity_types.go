...
var (
	DomainIdentityKind             = "DomainIdentity"
	DomainIdentityGroupKind        = schema.GroupKind{Group: Group, Kind: DomainIdentityKind}.String()
	DomainIdentityKindAPIVersion   = DomainIdentityKind + "." + GroupVersion.String()
	DomainIdentityGroupVersionKind = GroupVersion.WithKind(DomainIdentityKind)
)
