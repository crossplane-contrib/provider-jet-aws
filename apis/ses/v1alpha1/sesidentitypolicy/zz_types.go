...
var (
	...
	SesIdentityPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SesIdentityPolicyKind}.String()
	SesIdentityPolicyKindAPIVersion   = SesIdentityPolicyKind + "." + v1alpha1.GroupVersion.String()
	SesIdentityPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(SesIdentityPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SesIdentityPolicy{}, &SesIdentityPolicyList{})
}
