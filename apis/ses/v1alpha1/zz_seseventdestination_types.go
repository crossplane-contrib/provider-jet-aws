...
var (
	...
	SesEventDestinationGroupKind        = schema.GroupKind{Group: Group, Kind: SesEventDestinationKind}.String()
	SesEventDestinationKindAPIVersion   = SesEventDestinationKind + "." + GroupVersion.String()
	SesEventDestinationGroupVersionKind = GroupVersion.WithKind(SesEventDestinationKind)
)

func init() {
	SchemeBuilder.Register(&SesEventDestination{}, &SesEventDestinationList{})
}
