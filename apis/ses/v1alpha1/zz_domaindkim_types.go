...
var (
	DomainDkimKind             = "DomainDkim"
	DomainDkimGroupKind        = schema.GroupKind{Group: Group, Kind: DomainDkimKind}.String()
	DomainDkimKindAPIVersion   = DomainDkimKind + "." + GroupVersion.String()
	DomainDkimGroupVersionKind = GroupVersion.WithKind(DomainDkimKind)
)
