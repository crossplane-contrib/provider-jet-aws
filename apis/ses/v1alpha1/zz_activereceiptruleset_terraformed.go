...
// GetTerraformResourceIDField returns Terraform identifier field for this ActiveReceiptRuleSet
func (tr *ActiveReceiptRuleSet) GetTerraformResourceIDField() string {
	return "id"
}
