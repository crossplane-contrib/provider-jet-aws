...
var (
	ReceiptFilterKind             = "ReceiptFilter"
	ReceiptFilterGroupKind        = schema.GroupKind{Group: Group, Kind: ReceiptFilterKind}.String()
	ReceiptFilterKindAPIVersion   = ReceiptFilterKind + "." + GroupVersion.String()
	ReceiptFilterGroupVersionKind = GroupVersion.WithKind(ReceiptFilterKind)
)
