...
// GetTerraformResourceIDField returns Terraform identifier field for this DomainIdentityVerification
func (tr *DomainIdentityVerification) GetTerraformResourceIDField() string {
	return "id"
}
