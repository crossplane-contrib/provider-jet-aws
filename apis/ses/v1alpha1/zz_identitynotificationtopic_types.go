...
var (
	IdentityNotificationTopicKind             = "IdentityNotificationTopic"
	IdentityNotificationTopicGroupKind        = schema.GroupKind{Group: Group, Kind: IdentityNotificationTopicKind}.String()
	IdentityNotificationTopicKindAPIVersion   = IdentityNotificationTopicKind + "." + GroupVersion.String()
	IdentityNotificationTopicGroupVersionKind = GroupVersion.WithKind(IdentityNotificationTopicKind)
)
