...
var (
	IdentityPolicyKind             = "IdentityPolicy"
	IdentityPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: IdentityPolicyKind}.String()
	IdentityPolicyKindAPIVersion   = IdentityPolicyKind + "." + GroupVersion.String()
	IdentityPolicyGroupVersionKind = GroupVersion.WithKind(IdentityPolicyKind)
)
