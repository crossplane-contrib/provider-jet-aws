...
var (
	DomainIdentityVerification_Kind             = "DomainIdentityVerification"
	DomainIdentityVerification_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainIdentityVerification_Kind}.String()
	DomainIdentityVerification_KindAPIVersion   = DomainIdentityVerification_Kind + "." + CRDGroupVersion.String()
	DomainIdentityVerification_GroupVersionKind = CRDGroupVersion.WithKind(DomainIdentityVerification_Kind)
)
