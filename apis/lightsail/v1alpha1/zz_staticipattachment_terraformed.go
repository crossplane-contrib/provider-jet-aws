...
// GetTerraformResourceIDField returns Terraform identifier field for this StaticIpAttachment
func (tr *StaticIpAttachment) GetTerraformResourceIDField() string {
	return "id"
}
