...
// GetTerraformResourceIDField returns Terraform identifier field for this InstancePublicPorts
func (tr *InstancePublicPorts) GetTerraformResourceIDField() string {
	return "id"
}
