...
var (
	...
	LightsailKeyPairGroupKind        = schema.GroupKind{Group: Group, Kind: LightsailKeyPairKind}.String()
	LightsailKeyPairKindAPIVersion   = LightsailKeyPairKind + "." + GroupVersion.String()
	LightsailKeyPairGroupVersionKind = GroupVersion.WithKind(LightsailKeyPairKind)
)

func init() {
	SchemeBuilder.Register(&LightsailKeyPair{}, &LightsailKeyPairList{})
}
