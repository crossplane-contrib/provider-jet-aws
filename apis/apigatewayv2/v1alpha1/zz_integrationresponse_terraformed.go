...
// GetTerraformResourceIDField returns Terraform identifier field for this IntegrationResponse
func (tr *IntegrationResponse) GetTerraformResourceIDField() string {
	return "id"
}
