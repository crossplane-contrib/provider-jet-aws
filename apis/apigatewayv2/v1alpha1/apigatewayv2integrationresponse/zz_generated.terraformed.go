...
// GetTerraformResourceType returns Terraform resource type for this Apigatewayv2IntegrationResponse
func (mg *Apigatewayv2IntegrationResponse) GetTerraformResourceType() string {
	return "aws_apigatewayv2_integration_response"
}

// GetTerraformResourceIdField returns Terraform identifier field for this Apigatewayv2IntegrationResponse
