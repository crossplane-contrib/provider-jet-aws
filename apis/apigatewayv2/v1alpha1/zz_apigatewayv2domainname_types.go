...
var (
	...
	Apigatewayv2DomainNameGroupKind        = schema.GroupKind{Group: Group, Kind: Apigatewayv2DomainNameKind}.String()
	Apigatewayv2DomainNameKindAPIVersion   = Apigatewayv2DomainNameKind + "." + GroupVersion.String()
	Apigatewayv2DomainNameGroupVersionKind = GroupVersion.WithKind(Apigatewayv2DomainNameKind)
)
