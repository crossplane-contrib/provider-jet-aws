...
var (
	...
	Apigatewayv2VpcLinkGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Apigatewayv2VpcLinkKind}.String()
	Apigatewayv2VpcLinkKindAPIVersion   = Apigatewayv2VpcLinkKind + "." + v1alpha1.GroupVersion.String()
	Apigatewayv2VpcLinkGroupVersionKind = v1alpha1.GroupVersion.WithKind(Apigatewayv2VpcLinkKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Apigatewayv2VpcLink{}, &Apigatewayv2VpcLinkList{})
}
