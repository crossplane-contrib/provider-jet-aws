...
var (
	...
	NetworkInterfaceAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: NetworkInterfaceAttachmentKind}.String()
	NetworkInterfaceAttachmentKindAPIVersion   = NetworkInterfaceAttachmentKind + "." + v1alpha1.GroupVersion.String()
	NetworkInterfaceAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(NetworkInterfaceAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &NetworkInterfaceAttachment{}, &NetworkInterfaceAttachmentList{})
}
