...
var (
	...
	NetworkInterfaceSgAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: NetworkInterfaceSgAttachmentKind}.String()
	NetworkInterfaceSgAttachmentKindAPIVersion   = NetworkInterfaceSgAttachmentKind + "." + GroupVersion.String()
	NetworkInterfaceSgAttachmentGroupVersionKind = GroupVersion.WithKind(NetworkInterfaceSgAttachmentKind)
)
