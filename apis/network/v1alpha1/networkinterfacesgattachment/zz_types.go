...
var (
	NetworkInterfaceSgAttachmentKind             = "NetworkInterfaceSgAttachment"
	NetworkInterfaceSgAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: NetworkInterfaceSgAttachmentKind}.String()
	NetworkInterfaceSgAttachmentKindAPIVersion   = NetworkInterfaceSgAttachmentKind + "." + v1alpha1.GroupVersion.String()
	NetworkInterfaceSgAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(NetworkInterfaceSgAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &NetworkInterfaceSgAttachment{}, &NetworkInterfaceSgAttachmentList{})
}
