...
// GetItems of this RedshiftClusterList.
func (l *RedshiftClusterList) GetItems() []resource.Managed {
...
// GetItems of this RedshiftParameterGroupList.
func (l *RedshiftParameterGroupList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this RedshiftSecurityGroupList.
func (l *RedshiftSecurityGroupList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
