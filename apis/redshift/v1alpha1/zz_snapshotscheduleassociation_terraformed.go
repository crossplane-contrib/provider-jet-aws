...
// GetTerraformResourceIDField returns Terraform identifier field for this SnapshotScheduleAssociation
func (tr *SnapshotScheduleAssociation) GetTerraformResourceIDField() string {
	return "id"
}
