...
// GetTerraformResourceIDField returns Terraform identifier field for this S3BucketAssociation
func (tr *S3BucketAssociation) GetTerraformResourceIDField() string {
	return "id"
}
