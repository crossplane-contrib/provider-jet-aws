...
// GetTerraformResourceIDField returns Terraform identifier field for this MemberAccountAssociation
func (tr *MemberAccountAssociation) GetTerraformResourceIDField() string {
	return "id"
}
