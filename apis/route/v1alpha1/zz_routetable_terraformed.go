...
// GetTerraformResourceIDField returns Terraform identifier field for this RouteTable
func (tr *RouteTable) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this RouteTable
func (tr *RouteTable) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *RouteTable) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this RouteTable
func (tr *RouteTable) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
