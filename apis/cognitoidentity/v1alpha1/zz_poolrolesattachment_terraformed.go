...
func (tr *PoolRolesAttachment) GetObservation() (map[string]interface{}, error) {
...
func (tr *PoolRolesAttachment) SetObservation(obs map[string]interface{}) error {
...
func (tr *PoolRolesAttachment) GetParameters() (map[string]interface{}, error) {
...
func (tr *PoolRolesAttachment) SetParameters(params map[string]interface{}) error {
