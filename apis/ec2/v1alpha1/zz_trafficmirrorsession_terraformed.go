...
// GetTerraformResourceIDField returns Terraform identifier field for this TrafficMirrorSession
func (tr *TrafficMirrorSession) GetTerraformResourceIDField() string {
	return "id"
}
