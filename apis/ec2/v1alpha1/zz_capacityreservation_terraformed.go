...
// GetTerraformResourceIDField returns Terraform identifier field for this CapacityReservation
func (tr *CapacityReservation) GetTerraformResourceIDField() string {
	return "id"
}
