...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitGatewayPeeringAttachment
func (tr *TransitGatewayPeeringAttachment) GetTerraformResourceIDField() string {
	return "id"
}
