...
// Ec2ClientVpnRouteStatus defines the observed state of Ec2ClientVpnRoute.
type Ec2ClientVpnRouteStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          Ec2ClientVpnRouteObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// Ec2ClientVpnRoute is the Schema for the Ec2ClientVpnRoutes API
...
// Ec2ClientVpnRouteList contains a list of Ec2ClientVpnRoutes
...
var (
	Ec2ClientVpnRouteKind             = "Ec2ClientVpnRoute"
	Ec2ClientVpnRouteGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Ec2ClientVpnRouteKind}.String()
	Ec2ClientVpnRouteKindAPIVersion   = Ec2ClientVpnRouteKind + "." + v1alpha1.GroupVersion.String()
	Ec2ClientVpnRouteGroupVersionKind = v1alpha1.GroupVersion.WithKind(Ec2ClientVpnRouteKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Ec2ClientVpnRoute{}, &Ec2ClientVpnRouteList{})
}
