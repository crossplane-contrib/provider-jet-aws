...
// GetTerraformResourceIDField returns Terraform identifier field for this LocalGatewayRouteTableVpcAssociation
func (tr *LocalGatewayRouteTableVpcAssociation) GetTerraformResourceIDField() string {
	return "id"
}
