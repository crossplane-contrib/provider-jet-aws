...
var (
	...
	Ec2TransitGatewayRouteTableGroupKind        = schema.GroupKind{Group: Group, Kind: Ec2TransitGatewayRouteTableKind}.String()
	Ec2TransitGatewayRouteTableKindAPIVersion   = Ec2TransitGatewayRouteTableKind + "." + GroupVersion.String()
	Ec2TransitGatewayRouteTableGroupVersionKind = GroupVersion.WithKind(Ec2TransitGatewayRouteTableKind)
)
