...
var (
	ClientVpnAuthorizationRuleKind             = "ClientVpnAuthorizationRule"
	ClientVpnAuthorizationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: ClientVpnAuthorizationRuleKind}.String()
	ClientVpnAuthorizationRuleKindAPIVersion   = ClientVpnAuthorizationRuleKind + "." + GroupVersion.String()
	ClientVpnAuthorizationRuleGroupVersionKind = GroupVersion.WithKind(ClientVpnAuthorizationRuleKind)
)
