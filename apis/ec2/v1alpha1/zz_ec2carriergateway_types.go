...
var (
	...
	Ec2CarrierGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: Ec2CarrierGatewayKind}.String()
	Ec2CarrierGatewayKindAPIVersion   = Ec2CarrierGatewayKind + "." + GroupVersion.String()
	Ec2CarrierGatewayGroupVersionKind = GroupVersion.WithKind(Ec2CarrierGatewayKind)
)
