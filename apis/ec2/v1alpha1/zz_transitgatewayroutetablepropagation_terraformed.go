...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitGatewayRouteTablePropagation
func (tr *TransitGatewayRouteTablePropagation) GetTerraformResourceIDField() string {
	return "id"
}
