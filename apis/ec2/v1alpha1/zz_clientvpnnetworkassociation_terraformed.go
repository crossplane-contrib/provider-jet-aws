...
// GetTerraformResourceIDField returns Terraform identifier field for this ClientVpnNetworkAssociation
func (tr *ClientVpnNetworkAssociation) GetTerraformResourceIDField() string {
	return "id"
}
