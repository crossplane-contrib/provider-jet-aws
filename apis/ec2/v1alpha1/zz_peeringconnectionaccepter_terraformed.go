...
func (tr *PeeringConnectionAccepter) GetObservation() (map[string]interface{}, error) {
...
func (tr *PeeringConnectionAccepter) SetObservation(obs map[string]interface{}) error {
...
func (tr *PeeringConnectionAccepter) GetParameters() (map[string]interface{}, error) {
...
func (tr *PeeringConnectionAccepter) SetParameters(params map[string]interface{}) error {
