...
func (tr *Ec2TransitGatewayPrefixListReference) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Ec2TransitGatewayPrefixListReference) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this Ec2TransitGatewayPrefixListReference
func (tr *Ec2TransitGatewayPrefixListReference) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
