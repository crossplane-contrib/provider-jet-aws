...
func (tr *Ec2LocalGatewayRouteTableVpcAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Ec2LocalGatewayRouteTableVpcAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this Ec2LocalGatewayRouteTableVpcAssociation
func (tr *Ec2LocalGatewayRouteTableVpcAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
