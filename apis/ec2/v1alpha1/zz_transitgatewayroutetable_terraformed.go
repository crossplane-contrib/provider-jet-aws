...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitGatewayRouteTable
func (tr *TransitGatewayRouteTable) GetTerraformResourceIDField() string {
	return "id"
}
