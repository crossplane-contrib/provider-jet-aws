...
func (tr *Ec2TransitGatewayRouteTable) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Ec2TransitGatewayRouteTable) SetObservation(obs map[string]interface{}) error {
...
func (tr *Ec2TransitGatewayRouteTable) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// LateInitialize this Ec2TransitGatewayRouteTable using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Ec2TransitGatewayRouteTable) LateInitialize(attrs []byte) (bool, error) {
	params := &Ec2TransitGatewayRouteTableParameters{}
...
// GetConnectionDetails of this Ec2TransitGatewayRouteTable
func (tr *Ec2TransitGatewayRouteTable) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
