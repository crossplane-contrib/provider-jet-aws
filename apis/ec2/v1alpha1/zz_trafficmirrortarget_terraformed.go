...
// GetTerraformResourceIDField returns Terraform identifier field for this TrafficMirrorTarget
func (tr *TrafficMirrorTarget) GetTerraformResourceIDField() string {
	return "id"
}
