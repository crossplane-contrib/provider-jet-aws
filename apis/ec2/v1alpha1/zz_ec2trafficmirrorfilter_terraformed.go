...
func (tr *Ec2TrafficMirrorFilter) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Ec2TrafficMirrorFilter) SetObservation(obs map[string]interface{}) error {
...
func (tr *Ec2TrafficMirrorFilter) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Ec2TrafficMirrorFilter) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Ec2TrafficMirrorFilter using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Ec2TrafficMirrorFilter) LateInitialize(attrs []byte) (bool, error) {
	params := &Ec2TrafficMirrorFilterParameters{}
...
// GetConnectionDetails of this Ec2TrafficMirrorFilter
func (tr *Ec2TrafficMirrorFilter) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
