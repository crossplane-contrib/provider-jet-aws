...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitGatewayPeeringAttachmentAccepter
func (tr *TransitGatewayPeeringAttachmentAccepter) GetTerraformResourceIDField() string {
	return "id"
}
