...
// GetTerraformResourceIDField returns Terraform identifier field for this AvailabilityZoneGroup
func (tr *AvailabilityZoneGroup) GetTerraformResourceIDField() string {
	return "id"
}
