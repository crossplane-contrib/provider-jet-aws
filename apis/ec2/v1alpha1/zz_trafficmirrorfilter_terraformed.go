...
// GetTerraformResourceIDField returns Terraform identifier field for this TrafficMirrorFilter
func (tr *TrafficMirrorFilter) GetTerraformResourceIDField() string {
	return "id"
}
