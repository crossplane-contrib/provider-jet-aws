...
EnableClassiclink bool `json:"enableClassiclink" tf:"enable_classiclink"`

EnableClassiclinkDnsSupport bool `json:"enableClassiclinkDnsSupport" tf:"enable_classiclink_dns_support"`

EnableDnsHostnames bool `json:"enableDnsHostnames" tf:"enable_dns_hostnames"`

EnableDnsSupport bool `json:"enableDnsSupport" tf:"enable_dns_support"`
