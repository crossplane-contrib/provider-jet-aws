...
// GetTerraformResourceIDField returns Terraform identifier field for this TrafficMirrorFilterRule
func (tr *TrafficMirrorFilterRule) GetTerraformResourceIDField() string {
	return "id"
}
