...
var (
	ClientVpnNetworkAssociationKind             = "ClientVpnNetworkAssociation"
	ClientVpnNetworkAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: ClientVpnNetworkAssociationKind}.String()
	ClientVpnNetworkAssociationKindAPIVersion   = ClientVpnNetworkAssociationKind + "." + GroupVersion.String()
	ClientVpnNetworkAssociationGroupVersionKind = GroupVersion.WithKind(ClientVpnNetworkAssociationKind)
)
