...
var (
	TrafficMirrorFilterKind             = "TrafficMirrorFilter"
	TrafficMirrorFilterGroupKind        = schema.GroupKind{Group: Group, Kind: TrafficMirrorFilterKind}.String()
	TrafficMirrorFilterKindAPIVersion   = TrafficMirrorFilterKind + "." + GroupVersion.String()
	TrafficMirrorFilterGroupVersionKind = GroupVersion.WithKind(TrafficMirrorFilterKind)
)
