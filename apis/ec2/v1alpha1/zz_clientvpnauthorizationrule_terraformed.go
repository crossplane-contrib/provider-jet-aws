...
// GetTerraformResourceIDField returns Terraform identifier field for this ClientVpnAuthorizationRule
func (tr *ClientVpnAuthorizationRule) GetTerraformResourceIDField() string {
	return "id"
}
