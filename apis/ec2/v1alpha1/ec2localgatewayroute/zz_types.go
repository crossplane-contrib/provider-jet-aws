...
var (
	...
	Ec2LocalGatewayRouteGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Ec2LocalGatewayRouteKind}.String()
	Ec2LocalGatewayRouteKindAPIVersion   = Ec2LocalGatewayRouteKind + "." + v1alpha1.GroupVersion.String()
	Ec2LocalGatewayRouteGroupVersionKind = v1alpha1.GroupVersion.WithKind(Ec2LocalGatewayRouteKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Ec2LocalGatewayRoute{}, &Ec2LocalGatewayRouteList{})
}
