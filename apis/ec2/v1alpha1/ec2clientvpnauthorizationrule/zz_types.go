...
var (
	...
	Ec2ClientVpnAuthorizationRuleGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Ec2ClientVpnAuthorizationRuleKind}.String()
	Ec2ClientVpnAuthorizationRuleKindAPIVersion   = Ec2ClientVpnAuthorizationRuleKind + "." + v1alpha1.GroupVersion.String()
	Ec2ClientVpnAuthorizationRuleGroupVersionKind = v1alpha1.GroupVersion.WithKind(Ec2ClientVpnAuthorizationRuleKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Ec2ClientVpnAuthorizationRule{}, &Ec2ClientVpnAuthorizationRuleList{})
}
