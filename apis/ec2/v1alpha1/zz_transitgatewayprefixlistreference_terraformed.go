...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitGatewayPrefixListReference
func (tr *TransitGatewayPrefixListReference) GetTerraformResourceIDField() string {
	return "id"
}
