...
func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Ec2TransitGatewayPrefixListReference{}, &Ec2TransitGatewayPrefixListReferenceList{})
}
