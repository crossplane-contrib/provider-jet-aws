...
func (tr *Ec2TransitGatewayPrefixListReference) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Ec2TransitGatewayPrefixListReference
func (tr *Ec2TransitGatewayPrefixListReference) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Ec2TransitGatewayPrefixListReference
func (tr *Ec2TransitGatewayPrefixListReference) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this Ec2TransitGatewayPrefixListReference
func (tr *Ec2TransitGatewayPrefixListReference) SetParameters(data []byte) error {
