...
var (
	TagKind             = "Tag"
	TagGroupKind        = schema.GroupKind{Group: Group, Kind: TagKind}.String()
	TagKindAPIVersion   = TagKind + "." + GroupVersion.String()
	TagGroupVersionKind = GroupVersion.WithKind(TagKind)
)
