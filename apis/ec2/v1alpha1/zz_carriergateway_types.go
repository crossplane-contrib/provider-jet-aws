...
var (
	CarrierGatewayKind             = "CarrierGateway"
	CarrierGatewayGroupKind        = schema.GroupKind{Group: Group, Kind: CarrierGatewayKind}.String()
	CarrierGatewayKindAPIVersion   = CarrierGatewayKind + "." + GroupVersion.String()
	CarrierGatewayGroupVersionKind = GroupVersion.WithKind(CarrierGatewayKind)
)
