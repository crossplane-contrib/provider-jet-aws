...
var (
	WebsiteCertificateAuthorityAssociationKind             = "WebsiteCertificateAuthorityAssociation"
	WebsiteCertificateAuthorityAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: WebsiteCertificateAuthorityAssociationKind}.String()
	WebsiteCertificateAuthorityAssociationKindAPIVersion   = WebsiteCertificateAuthorityAssociationKind + "." + GroupVersion.String()
	WebsiteCertificateAuthorityAssociationGroupVersionKind = GroupVersion.WithKind(WebsiteCertificateAuthorityAssociationKind)
)
