...
var (
	...
	ServicecatalogTagOptionResourceAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: ServicecatalogTagOptionResourceAssociationKind}.String()
	ServicecatalogTagOptionResourceAssociationKindAPIVersion   = ServicecatalogTagOptionResourceAssociationKind + "." + GroupVersion.String()
	ServicecatalogTagOptionResourceAssociationGroupVersionKind = GroupVersion.WithKind(ServicecatalogTagOptionResourceAssociationKind)
)

func init() {
	SchemeBuilder.Register(&ServicecatalogTagOptionResourceAssociation{}, &ServicecatalogTagOptionResourceAssociationList{})
}
