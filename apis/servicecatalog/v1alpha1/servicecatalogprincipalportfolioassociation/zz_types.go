...
var (
	...
	ServicecatalogPrincipalPortfolioAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ServicecatalogPrincipalPortfolioAssociationKind}.String()
	ServicecatalogPrincipalPortfolioAssociationKindAPIVersion   = ServicecatalogPrincipalPortfolioAssociationKind + "." + v1alpha1.GroupVersion.String()
	ServicecatalogPrincipalPortfolioAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ServicecatalogPrincipalPortfolioAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ServicecatalogPrincipalPortfolioAssociation{}, &ServicecatalogPrincipalPortfolioAssociationList{})
}
