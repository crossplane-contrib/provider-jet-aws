...
var (
	OrganizationsAccessKind             = "OrganizationsAccess"
	OrganizationsAccessGroupKind        = schema.GroupKind{Group: Group, Kind: OrganizationsAccessKind}.String()
	OrganizationsAccessKindAPIVersion   = OrganizationsAccessKind + "." + GroupVersion.String()
	OrganizationsAccessGroupVersionKind = GroupVersion.WithKind(OrganizationsAccessKind)
)
