...
// GetTerraformResourceIDField returns Terraform identifier field for this PrincipalPortfolioAssociation
func (tr *PrincipalPortfolioAssociation) GetTerraformResourceIDField() string {
	return "id"
}
