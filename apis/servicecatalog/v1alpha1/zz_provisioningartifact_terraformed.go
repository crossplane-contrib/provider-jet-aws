...
// GetTerraformResourceIDField returns Terraform identifier field for this ProvisioningArtifact
func (tr *ProvisioningArtifact) GetTerraformResourceIDField() string {
	return "id"
}
