...
var (
	...
	ServicecatalogPortfolioGroupKind        = schema.GroupKind{Group: Group, Kind: ServicecatalogPortfolioKind}.String()
	ServicecatalogPortfolioKindAPIVersion   = ServicecatalogPortfolioKind + "." + GroupVersion.String()
	ServicecatalogPortfolioGroupVersionKind = GroupVersion.WithKind(ServicecatalogPortfolioKind)
)

func init() {
	SchemeBuilder.Register(&ServicecatalogPortfolio{}, &ServicecatalogPortfolioList{})
}
