...
var (
	...
	ServicecatalogPortfolioShareGroupKind        = schema.GroupKind{Group: Group, Kind: ServicecatalogPortfolioShareKind}.String()
	ServicecatalogPortfolioShareKindAPIVersion   = ServicecatalogPortfolioShareKind + "." + GroupVersion.String()
	ServicecatalogPortfolioShareGroupVersionKind = GroupVersion.WithKind(ServicecatalogPortfolioShareKind)
)
