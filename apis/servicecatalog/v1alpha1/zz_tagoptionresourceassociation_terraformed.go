...
// GetTerraformResourceIDField returns Terraform identifier field for this TagOptionResourceAssociation
func (tr *TagOptionResourceAssociation) GetTerraformResourceIDField() string {
	return "id"
}
