...
// GetTerraformResourceIDField returns Terraform identifier field for this BudgetResourceAssociation
func (tr *BudgetResourceAssociation) GetTerraformResourceIDField() string {
	return "id"
}
