...
var (
	...
	ServicecatalogProductPortfolioAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ServicecatalogProductPortfolioAssociationKind}.String()
	ServicecatalogProductPortfolioAssociationKindAPIVersion   = ServicecatalogProductPortfolioAssociationKind + "." + v1alpha1.GroupVersion.String()
	ServicecatalogProductPortfolioAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ServicecatalogProductPortfolioAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ServicecatalogProductPortfolioAssociation{}, &ServicecatalogProductPortfolioAssociationList{})
}
