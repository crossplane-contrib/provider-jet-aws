...
// GetTerraformResourceIDField returns Terraform identifier field for this ProvisionedProduct
func (tr *ProvisionedProduct) GetTerraformResourceIDField() string {
	return "id"
}
