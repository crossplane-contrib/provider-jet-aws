...
var (
	...
	Macie2CustomDataIdentifierGroupKind        = schema.GroupKind{Group: Group, Kind: Macie2CustomDataIdentifierKind}.String()
	Macie2CustomDataIdentifierKindAPIVersion   = Macie2CustomDataIdentifierKind + "." + GroupVersion.String()
	Macie2CustomDataIdentifierGroupVersionKind = GroupVersion.WithKind(Macie2CustomDataIdentifierKind)
)

func init() {
	SchemeBuilder.Register(&Macie2CustomDataIdentifier{}, &Macie2CustomDataIdentifierList{})
}
