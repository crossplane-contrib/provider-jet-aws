...
// GetTerraformResourceIDField returns Terraform identifier field for this InvitationAccepter
func (tr *InvitationAccepter) GetTerraformResourceIDField() string {
	return "id"
}
