...
// GetTerraformResourceIDField returns Terraform identifier field for this CustomDataIdentifier
func (tr *CustomDataIdentifier) GetTerraformResourceIDField() string {
	return "id"
}
