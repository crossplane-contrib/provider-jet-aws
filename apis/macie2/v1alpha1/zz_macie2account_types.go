...
var (
	...
	Macie2AccountGroupKind        = schema.GroupKind{Group: Group, Kind: Macie2AccountKind}.String()
	Macie2AccountKindAPIVersion   = Macie2AccountKind + "." + GroupVersion.String()
	Macie2AccountGroupVersionKind = GroupVersion.WithKind(Macie2AccountKind)
)

func init() {
	SchemeBuilder.Register(&Macie2Account{}, &Macie2AccountList{})
}
