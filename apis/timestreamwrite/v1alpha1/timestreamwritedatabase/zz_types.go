...
var (
	...
	TimestreamwriteDatabaseGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: TimestreamwriteDatabaseKind}.String()
	TimestreamwriteDatabaseKindAPIVersion   = TimestreamwriteDatabaseKind + "." + v1alpha1.GroupVersion.String()
	TimestreamwriteDatabaseGroupVersionKind = v1alpha1.GroupVersion.WithKind(TimestreamwriteDatabaseKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &TimestreamwriteDatabase{}, &TimestreamwriteDatabaseList{})
}
