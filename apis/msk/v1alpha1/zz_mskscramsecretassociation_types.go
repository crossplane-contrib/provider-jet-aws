...
var (
	...
	MskScramSecretAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: MskScramSecretAssociationKind}.String()
	MskScramSecretAssociationKindAPIVersion   = MskScramSecretAssociationKind + "." + GroupVersion.String()
	MskScramSecretAssociationGroupVersionKind = GroupVersion.WithKind(MskScramSecretAssociationKind)
)

func init() {
	SchemeBuilder.Register(&MskScramSecretAssociation{}, &MskScramSecretAssociationList{})
}
