...
// +groupName=ecrpublic.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/ecrpublic/v1alpha1"
)
...
var (
	...
	EcrpublicRepositoryGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EcrpublicRepositoryKind}.String()
	EcrpublicRepositoryKindAPIVersion   = EcrpublicRepositoryKind + "." + v1alpha1.GroupVersion.String()
	EcrpublicRepositoryGroupVersionKind = v1alpha1.GroupVersion.WithKind(EcrpublicRepositoryKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EcrpublicRepository{}, &EcrpublicRepositoryList{})
}
