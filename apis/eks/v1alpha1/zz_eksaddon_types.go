...
var (
	...
	EksAddonGroupKind        = schema.GroupKind{Group: Group, Kind: EksAddonKind}.String()
	EksAddonKindAPIVersion   = EksAddonKind + "." + GroupVersion.String()
	EksAddonGroupVersionKind = GroupVersion.WithKind(EksAddonKind)
)
