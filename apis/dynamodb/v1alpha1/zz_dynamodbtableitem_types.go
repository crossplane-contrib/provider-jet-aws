...
var (
	...
	DynamodbTableItemGroupKind        = schema.GroupKind{Group: Group, Kind: DynamodbTableItemKind}.String()
	DynamodbTableItemKindAPIVersion   = DynamodbTableItemKind + "." + GroupVersion.String()
	DynamodbTableItemGroupVersionKind = GroupVersion.WithKind(DynamodbTableItemKind)
)

func init() {
	SchemeBuilder.Register(&DynamodbTableItem{}, &DynamodbTableItemList{})
}
