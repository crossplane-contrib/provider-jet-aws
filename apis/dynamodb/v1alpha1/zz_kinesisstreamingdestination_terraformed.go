...
// GetTerraformResourceIDField returns Terraform identifier field for this KinesisStreamingDestination
func (tr *KinesisStreamingDestination) GetTerraformResourceIDField() string {
	return "id"
}
