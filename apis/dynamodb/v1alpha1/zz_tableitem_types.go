...
var (
	TableItemKind             = "TableItem"
	TableItemGroupKind        = schema.GroupKind{Group: Group, Kind: TableItemKind}.String()
	TableItemKindAPIVersion   = TableItemKind + "." + GroupVersion.String()
	TableItemGroupVersionKind = GroupVersion.WithKind(TableItemKind)
)
