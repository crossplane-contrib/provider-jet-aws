...
var (
	...
	DynamodbTableGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DynamodbTableKind}.String()
	DynamodbTableKindAPIVersion   = DynamodbTableKind + "." + v1alpha1.GroupVersion.String()
	DynamodbTableGroupVersionKind = v1alpha1.GroupVersion.WithKind(DynamodbTableKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DynamodbTable{}, &DynamodbTableList{})
}
