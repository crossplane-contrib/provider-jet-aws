...
var (
	LocationSmbKind             = "LocationSmb"
	LocationSmbGroupKind        = schema.GroupKind{Group: Group, Kind: LocationSmbKind}.String()
	LocationSmbKindAPIVersion   = LocationSmbKind + "." + GroupVersion.String()
	LocationSmbGroupVersionKind = GroupVersion.WithKind(LocationSmbKind)
)
