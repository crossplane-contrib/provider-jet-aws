...
var (
	...
	DatasyncLocationEfsGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DatasyncLocationEfsKind}.String()
	DatasyncLocationEfsKindAPIVersion   = DatasyncLocationEfsKind + "." + v1alpha1.GroupVersion.String()
	DatasyncLocationEfsGroupVersionKind = v1alpha1.GroupVersion.WithKind(DatasyncLocationEfsKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DatasyncLocationEfs{}, &DatasyncLocationEfsList{})
}
