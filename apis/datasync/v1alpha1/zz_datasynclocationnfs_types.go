...
var (
	...
	DatasyncLocationNfsGroupKind        = schema.GroupKind{Group: Group, Kind: DatasyncLocationNfsKind}.String()
	DatasyncLocationNfsKindAPIVersion   = DatasyncLocationNfsKind + "." + GroupVersion.String()
	DatasyncLocationNfsGroupVersionKind = GroupVersion.WithKind(DatasyncLocationNfsKind)
)
