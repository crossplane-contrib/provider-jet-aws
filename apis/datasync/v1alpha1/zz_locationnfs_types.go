...
var (
	LocationNfsKind             = "LocationNfs"
	LocationNfsGroupKind        = schema.GroupKind{Group: Group, Kind: LocationNfsKind}.String()
	LocationNfsKindAPIVersion   = LocationNfsKind + "." + GroupVersion.String()
	LocationNfsGroupVersionKind = GroupVersion.WithKind(LocationNfsKind)
)
