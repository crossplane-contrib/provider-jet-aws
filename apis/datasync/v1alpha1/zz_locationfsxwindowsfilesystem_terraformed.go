...
// GetTerraformResourceIDField returns Terraform identifier field for this LocationFsxWindowsFileSystem
func (tr *LocationFsxWindowsFileSystem) GetTerraformResourceIDField() string {
	return "id"
}
