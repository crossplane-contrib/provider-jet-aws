...
var (
	LocationFsxWindowsFileSystemKind             = "LocationFsxWindowsFileSystem"
	LocationFsxWindowsFileSystemGroupKind        = schema.GroupKind{Group: Group, Kind: LocationFsxWindowsFileSystemKind}.String()
	LocationFsxWindowsFileSystemKindAPIVersion   = LocationFsxWindowsFileSystemKind + "." + GroupVersion.String()
	LocationFsxWindowsFileSystemGroupVersionKind = GroupVersion.WithKind(LocationFsxWindowsFileSystemKind)
)
