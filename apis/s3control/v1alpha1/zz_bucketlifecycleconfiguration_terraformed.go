...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketLifecycleConfiguration
func (tr *BucketLifecycleConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
