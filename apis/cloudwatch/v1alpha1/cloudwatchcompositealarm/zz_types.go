...
var (
	...
	CloudwatchCompositeAlarmGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CloudwatchCompositeAlarmKind}.String()
	CloudwatchCompositeAlarmKindAPIVersion   = CloudwatchCompositeAlarmKind + "." + v1alpha1.GroupVersion.String()
	CloudwatchCompositeAlarmGroupVersionKind = v1alpha1.GroupVersion.WithKind(CloudwatchCompositeAlarmKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CloudwatchCompositeAlarm{}, &CloudwatchCompositeAlarmList{})
}
