...
var (
	...
	CloudwatchQueryDefinitionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CloudwatchQueryDefinitionKind}.String()
	CloudwatchQueryDefinitionKindAPIVersion   = CloudwatchQueryDefinitionKind + "." + v1alpha1.GroupVersion.String()
	CloudwatchQueryDefinitionGroupVersionKind = v1alpha1.GroupVersion.WithKind(CloudwatchQueryDefinitionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CloudwatchQueryDefinition{}, &CloudwatchQueryDefinitionList{})
}
