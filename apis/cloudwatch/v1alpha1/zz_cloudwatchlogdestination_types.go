...
var (
	...
	CloudwatchLogDestinationGroupKind        = schema.GroupKind{Group: Group, Kind: CloudwatchLogDestinationKind}.String()
	CloudwatchLogDestinationKindAPIVersion   = CloudwatchLogDestinationKind + "." + GroupVersion.String()
	CloudwatchLogDestinationGroupVersionKind = GroupVersion.WithKind(CloudwatchLogDestinationKind)
)

func init() {
	SchemeBuilder.Register(&CloudwatchLogDestination{}, &CloudwatchLogDestinationList{})
}
