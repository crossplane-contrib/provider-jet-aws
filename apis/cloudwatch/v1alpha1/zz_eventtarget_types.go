...
var (
	EventTarget_Kind             = "EventTarget"
	EventTarget_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EventTarget_Kind}.String()
	EventTarget_KindAPIVersion   = EventTarget_Kind + "." + CRDGroupVersion.String()
	EventTarget_GroupVersionKind = CRDGroupVersion.WithKind(EventTarget_Kind)
)
