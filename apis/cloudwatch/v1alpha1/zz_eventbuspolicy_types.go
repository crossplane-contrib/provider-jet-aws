...
var (
	EventBusPolicy_Kind             = "EventBusPolicy"
	EventBusPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EventBusPolicy_Kind}.String()
	EventBusPolicy_KindAPIVersion   = EventBusPolicy_Kind + "." + CRDGroupVersion.String()
	EventBusPolicy_GroupVersionKind = CRDGroupVersion.WithKind(EventBusPolicy_Kind)
)
