...
var (
	...
	CloudwatchEventArchiveGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CloudwatchEventArchiveKind}.String()
	CloudwatchEventArchiveKindAPIVersion   = CloudwatchEventArchiveKind + "." + v1alpha1.GroupVersion.String()
	CloudwatchEventArchiveGroupVersionKind = v1alpha1.GroupVersion.WithKind(CloudwatchEventArchiveKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CloudwatchEventArchive{}, &CloudwatchEventArchiveList{})
}
