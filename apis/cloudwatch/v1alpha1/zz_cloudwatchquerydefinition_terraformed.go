...
// GetTerraformResourceType returns Terraform resource type for this CloudwatchQueryDefinition
func (mg *CloudwatchQueryDefinition) GetTerraformResourceType() string {
	return "aws_cloudwatch_query_definition"
}

// GetTerraformResourceIdField returns Terraform identifier field for this CloudwatchQueryDefinition
