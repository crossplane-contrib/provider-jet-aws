...
// CloudwatchEventRuleSpec defines the desired state of CloudwatchEventRule
type CloudwatchEventRuleSpec struct {
	xpv1.ResourceSpec `json:",inline"`
	ForProvider       CloudwatchEventRuleParameters `json:"forProvider"`
}

// CloudwatchEventRuleStatus defines the observed state of CloudwatchEventRule.
type CloudwatchEventRuleStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          CloudwatchEventRuleObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// CloudwatchEventRule is the Schema for the CloudwatchEventRules API
...
// CloudwatchEventRuleList contains a list of CloudwatchEventRules
...
var (
	CloudwatchEventRuleKind             = "CloudwatchEventRule"
	CloudwatchEventRuleGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CloudwatchEventRuleKind}.String()
	CloudwatchEventRuleKindAPIVersion   = CloudwatchEventRuleKind + "." + v1alpha1.GroupVersion.String()
	CloudwatchEventRuleGroupVersionKind = v1alpha1.GroupVersion.WithKind(CloudwatchEventRuleKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CloudwatchEventRule{}, &CloudwatchEventRuleList{})
}
