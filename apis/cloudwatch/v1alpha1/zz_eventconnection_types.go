...
var (
	EventConnection_Kind             = "EventConnection"
	EventConnection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EventConnection_Kind}.String()
	EventConnection_KindAPIVersion   = EventConnection_Kind + "." + CRDGroupVersion.String()
	EventConnection_GroupVersionKind = CRDGroupVersion.WithKind(EventConnection_Kind)
)
