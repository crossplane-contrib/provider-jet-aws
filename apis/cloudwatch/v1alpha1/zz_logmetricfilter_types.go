...
var (
	LogMetricFilter_Kind             = "LogMetricFilter"
	LogMetricFilter_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LogMetricFilter_Kind}.String()
	LogMetricFilter_KindAPIVersion   = LogMetricFilter_Kind + "." + CRDGroupVersion.String()
	LogMetricFilter_GroupVersionKind = CRDGroupVersion.WithKind(LogMetricFilter_Kind)
)
