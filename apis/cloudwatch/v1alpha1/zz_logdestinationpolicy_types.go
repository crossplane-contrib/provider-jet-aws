...
var (
	LogDestinationPolicy_Kind             = "LogDestinationPolicy"
	LogDestinationPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LogDestinationPolicy_Kind}.String()
	LogDestinationPolicy_KindAPIVersion   = LogDestinationPolicy_Kind + "." + CRDGroupVersion.String()
	LogDestinationPolicy_GroupVersionKind = CRDGroupVersion.WithKind(LogDestinationPolicy_Kind)
)
