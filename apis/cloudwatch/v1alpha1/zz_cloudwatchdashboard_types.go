...
var (
	...
	CloudwatchDashboardGroupKind        = schema.GroupKind{Group: Group, Kind: CloudwatchDashboardKind}.String()
	CloudwatchDashboardKindAPIVersion   = CloudwatchDashboardKind + "." + GroupVersion.String()
	CloudwatchDashboardGroupVersionKind = GroupVersion.WithKind(CloudwatchDashboardKind)
)
