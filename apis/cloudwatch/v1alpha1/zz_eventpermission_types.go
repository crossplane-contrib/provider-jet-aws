...
var (
	EventPermission_Kind             = "EventPermission"
	EventPermission_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EventPermission_Kind}.String()
	EventPermission_KindAPIVersion   = EventPermission_Kind + "." + CRDGroupVersion.String()
	EventPermission_GroupVersionKind = CRDGroupVersion.WithKind(EventPermission_Kind)
)
