...
var (
	...
	CloudwatchLogStreamGroupKind        = schema.GroupKind{Group: Group, Kind: CloudwatchLogStreamKind}.String()
	CloudwatchLogStreamKindAPIVersion   = CloudwatchLogStreamKind + "." + GroupVersion.String()
	CloudwatchLogStreamGroupVersionKind = GroupVersion.WithKind(CloudwatchLogStreamKind)
)

func init() {
	SchemeBuilder.Register(&CloudwatchLogStream{}, &CloudwatchLogStreamList{})
}
