...
// GetTerraformResourceIDField returns Terraform identifier field for this ConfigurationProfile
func (tr *ConfigurationProfile) GetTerraformResourceIDField() string {
	return "id"
}
