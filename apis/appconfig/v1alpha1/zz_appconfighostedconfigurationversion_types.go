...
var (
	...
	AppconfigHostedConfigurationVersionGroupKind        = schema.GroupKind{Group: Group, Kind: AppconfigHostedConfigurationVersionKind}.String()
	AppconfigHostedConfigurationVersionKindAPIVersion   = AppconfigHostedConfigurationVersionKind + "." + GroupVersion.String()
	AppconfigHostedConfigurationVersionGroupVersionKind = GroupVersion.WithKind(AppconfigHostedConfigurationVersionKind)
)
