...
// GetTerraformResourceIDField returns Terraform identifier field for this DeploymentStrategy
func (tr *DeploymentStrategy) GetTerraformResourceIDField() string {
	return "id"
}
