...
var (
	...
	AppconfigConfigurationProfileGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppconfigConfigurationProfileKind}.String()
	AppconfigConfigurationProfileKindAPIVersion   = AppconfigConfigurationProfileKind + "." + v1alpha1.GroupVersion.String()
	AppconfigConfigurationProfileGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppconfigConfigurationProfileKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppconfigConfigurationProfile{}, &AppconfigConfigurationProfileList{})
}
