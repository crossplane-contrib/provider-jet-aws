...
var (
	...
	AppconfigDeploymentStrategyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppconfigDeploymentStrategyKind}.String()
	AppconfigDeploymentStrategyKindAPIVersion   = AppconfigDeploymentStrategyKind + "." + v1alpha1.GroupVersion.String()
	AppconfigDeploymentStrategyGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppconfigDeploymentStrategyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppconfigDeploymentStrategy{}, &AppconfigDeploymentStrategyList{})
}
