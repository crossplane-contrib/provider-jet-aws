...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedConfigurationVersion
func (tr *HostedConfigurationVersion) GetTerraformResourceIDField() string {
	return "id"
}
