...
var (
	...
	AppconfigDeploymentGroupKind        = schema.GroupKind{Group: Group, Kind: AppconfigDeploymentKind}.String()
	AppconfigDeploymentKindAPIVersion   = AppconfigDeploymentKind + "." + GroupVersion.String()
	AppconfigDeploymentGroupVersionKind = GroupVersion.WithKind(AppconfigDeploymentKind)
)
