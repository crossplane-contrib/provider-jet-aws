...
var (
	...
	AppconfigEnvironmentGroupKind        = schema.GroupKind{Group: Group, Kind: AppconfigEnvironmentKind}.String()
	AppconfigEnvironmentKindAPIVersion   = AppconfigEnvironmentKind + "." + GroupVersion.String()
	AppconfigEnvironmentGroupVersionKind = GroupVersion.WithKind(AppconfigEnvironmentKind)
)
