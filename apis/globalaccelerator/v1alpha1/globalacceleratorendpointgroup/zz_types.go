...
var (
	...
	GlobalacceleratorEndpointGroupGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlobalacceleratorEndpointGroupKind}.String()
	GlobalacceleratorEndpointGroupKindAPIVersion   = GlobalacceleratorEndpointGroupKind + "." + v1alpha1.GroupVersion.String()
	GlobalacceleratorEndpointGroupGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlobalacceleratorEndpointGroupKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlobalacceleratorEndpointGroup{}, &GlobalacceleratorEndpointGroupList{})
}
