...
// GetTerraformResourceType returns Terraform resource type for this CloudhsmV2Hsm
func (mg *CloudhsmV2Hsm) GetTerraformResourceType() string {
	return "aws_cloudhsm_v2_hsm"
}

// GetTerraformResourceIdField returns Terraform identifier field for this CloudhsmV2Hsm
