...
var (
	...
	CloudhsmV2ClusterGroupKind        = schema.GroupKind{Group: Group, Kind: CloudhsmV2ClusterKind}.String()
	CloudhsmV2ClusterKindAPIVersion   = CloudhsmV2ClusterKind + "." + GroupVersion.String()
	CloudhsmV2ClusterGroupVersionKind = GroupVersion.WithKind(CloudhsmV2ClusterKind)
)

func init() {
	SchemeBuilder.Register(&CloudhsmV2Cluster{}, &CloudhsmV2ClusterList{})
}
