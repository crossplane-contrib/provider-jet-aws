...
var (
	UserPoolUiCustomizationKind             = "UserPoolUiCustomization"
	UserPoolUiCustomizationGroupKind        = schema.GroupKind{Group: Group, Kind: UserPoolUiCustomizationKind}.String()
	UserPoolUiCustomizationKindAPIVersion   = UserPoolUiCustomizationKind + "." + GroupVersion.String()
	UserPoolUiCustomizationGroupVersionKind = GroupVersion.WithKind(UserPoolUiCustomizationKind)
)
