...
// GetTerraformResourceIDField returns Terraform identifier field for this UserPoolUiCustomization
func (tr *UserPoolUiCustomization) GetTerraformResourceIDField() string {
	return "id"
}
