...
var (
	...
	CognitoResourceServerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CognitoResourceServerKind}.String()
	CognitoResourceServerKindAPIVersion   = CognitoResourceServerKind + "." + v1alpha1.GroupVersion.String()
	CognitoResourceServerGroupVersionKind = v1alpha1.GroupVersion.WithKind(CognitoResourceServerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CognitoResourceServer{}, &CognitoResourceServerList{})
}
