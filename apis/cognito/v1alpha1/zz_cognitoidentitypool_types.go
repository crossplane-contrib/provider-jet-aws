...
var (
	...
	CognitoIdentityPoolGroupKind        = schema.GroupKind{Group: Group, Kind: CognitoIdentityPoolKind}.String()
	CognitoIdentityPoolKindAPIVersion   = CognitoIdentityPoolKind + "." + GroupVersion.String()
	CognitoIdentityPoolGroupVersionKind = GroupVersion.WithKind(CognitoIdentityPoolKind)
)
