...
var (
	...
	CognitoUserPoolUiCustomizationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CognitoUserPoolUiCustomizationKind}.String()
	CognitoUserPoolUiCustomizationKindAPIVersion   = CognitoUserPoolUiCustomizationKind + "." + v1alpha1.GroupVersion.String()
	CognitoUserPoolUiCustomizationGroupVersionKind = v1alpha1.GroupVersion.WithKind(CognitoUserPoolUiCustomizationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CognitoUserPoolUiCustomization{}, &CognitoUserPoolUiCustomizationList{})
}
