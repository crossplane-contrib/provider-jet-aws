...
var (
	...
	DocdbClusterParameterGroupGroupKind        = schema.GroupKind{Group: Group, Kind: DocdbClusterParameterGroupKind}.String()
	DocdbClusterParameterGroupKindAPIVersion   = DocdbClusterParameterGroupKind + "." + GroupVersion.String()
	DocdbClusterParameterGroupGroupVersionKind = GroupVersion.WithKind(DocdbClusterParameterGroupKind)
)

func init() {
	SchemeBuilder.Register(&DocdbClusterParameterGroup{}, &DocdbClusterParameterGroupList{})
}
