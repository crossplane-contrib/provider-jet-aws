...
var (
	...
	DocdbClusterGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DocdbClusterKind}.String()
	DocdbClusterKindAPIVersion   = DocdbClusterKind + "." + v1alpha1.GroupVersion.String()
	DocdbClusterGroupVersionKind = v1alpha1.GroupVersion.WithKind(DocdbClusterKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DocdbCluster{}, &DocdbClusterList{})
}
