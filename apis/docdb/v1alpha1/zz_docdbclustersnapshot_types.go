...
var (
	...
	DocdbClusterSnapshotGroupKind        = schema.GroupKind{Group: Group, Kind: DocdbClusterSnapshotKind}.String()
	DocdbClusterSnapshotKindAPIVersion   = DocdbClusterSnapshotKind + "." + GroupVersion.String()
	DocdbClusterSnapshotGroupVersionKind = GroupVersion.WithKind(DocdbClusterSnapshotKind)
)

func init() {
	SchemeBuilder.Register(&DocdbClusterSnapshot{}, &DocdbClusterSnapshotList{})
}
