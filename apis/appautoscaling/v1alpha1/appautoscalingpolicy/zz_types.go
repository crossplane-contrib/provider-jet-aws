...
var (
	...
	AppautoscalingPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppautoscalingPolicyKind}.String()
	AppautoscalingPolicyKindAPIVersion   = AppautoscalingPolicyKind + "." + v1alpha1.GroupVersion.String()
	AppautoscalingPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppautoscalingPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppautoscalingPolicy{}, &AppautoscalingPolicyList{})
}
