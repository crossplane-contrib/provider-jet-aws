...
// GetTerraformResourceIDField returns Terraform identifier field for this ScheduledAction
func (tr *ScheduledAction) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ScheduledAction) GetObservation() (map[string]interface{}, error) {
...
func (tr *ScheduledAction) SetObservation(obs map[string]interface{}) error {
...
func (tr *ScheduledAction) GetParameters() (map[string]interface{}, error) {
...
func (tr *ScheduledAction) SetParameters(params map[string]interface{}) error {
