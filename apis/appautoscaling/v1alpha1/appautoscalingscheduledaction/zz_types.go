...
var (
	...
	AppautoscalingScheduledActionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppautoscalingScheduledActionKind}.String()
	AppautoscalingScheduledActionKindAPIVersion   = AppautoscalingScheduledActionKind + "." + v1alpha1.GroupVersion.String()
	AppautoscalingScheduledActionGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppautoscalingScheduledActionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppautoscalingScheduledAction{}, &AppautoscalingScheduledActionList{})
}
