...
var (
	...
	PinpointEmailChannelGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: PinpointEmailChannelKind}.String()
	PinpointEmailChannelKindAPIVersion   = PinpointEmailChannelKind + "." + v1alpha1.GroupVersion.String()
	PinpointEmailChannelGroupVersionKind = v1alpha1.GroupVersion.WithKind(PinpointEmailChannelKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &PinpointEmailChannel{}, &PinpointEmailChannelList{})
}
