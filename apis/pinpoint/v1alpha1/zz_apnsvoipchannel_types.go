...
var (
	ApnsVoipChannelKind             = "ApnsVoipChannel"
	ApnsVoipChannelGroupKind        = schema.GroupKind{Group: Group, Kind: ApnsVoipChannelKind}.String()
	ApnsVoipChannelKindAPIVersion   = ApnsVoipChannelKind + "." + GroupVersion.String()
	ApnsVoipChannelGroupVersionKind = GroupVersion.WithKind(ApnsVoipChannelKind)
)
