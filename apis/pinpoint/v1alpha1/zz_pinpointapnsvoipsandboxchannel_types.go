...
var (
	...
	PinpointApnsVoipSandboxChannelGroupKind        = schema.GroupKind{Group: Group, Kind: PinpointApnsVoipSandboxChannelKind}.String()
	PinpointApnsVoipSandboxChannelKindAPIVersion   = PinpointApnsVoipSandboxChannelKind + "." + GroupVersion.String()
	PinpointApnsVoipSandboxChannelGroupVersionKind = GroupVersion.WithKind(PinpointApnsVoipSandboxChannelKind)
)

func init() {
	SchemeBuilder.Register(&PinpointApnsVoipSandboxChannel{}, &PinpointApnsVoipSandboxChannelList{})
}
