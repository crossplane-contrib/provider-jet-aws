...
// GetTerraformResourceIDField returns Terraform identifier field for this ApnsVoipSandboxChannel
func (tr *ApnsVoipSandboxChannel) GetTerraformResourceIDField() string {
	return "id"
}
