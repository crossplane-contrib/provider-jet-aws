...
var (
	...
	PinpointGcmChannelGroupKind        = schema.GroupKind{Group: Group, Kind: PinpointGcmChannelKind}.String()
	PinpointGcmChannelKindAPIVersion   = PinpointGcmChannelKind + "." + GroupVersion.String()
	PinpointGcmChannelGroupVersionKind = GroupVersion.WithKind(PinpointGcmChannelKind)
)

func init() {
	SchemeBuilder.Register(&PinpointGcmChannel{}, &PinpointGcmChannelList{})
}
