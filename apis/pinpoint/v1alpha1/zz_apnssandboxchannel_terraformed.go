...
// GetTerraformResourceIDField returns Terraform identifier field for this ApnsSandboxChannel
func (tr *ApnsSandboxChannel) GetTerraformResourceIDField() string {
	return "id"
}
