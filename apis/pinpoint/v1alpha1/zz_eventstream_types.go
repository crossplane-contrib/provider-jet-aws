...
var (
	...
	EventStreamGroupKind        = schema.GroupKind{Group: Group, Kind: EventStreamKind}.String()
	EventStreamKindAPIVersion   = EventStreamKind + "." + GroupVersion.String()
	EventStreamGroupVersionKind = GroupVersion.WithKind(EventStreamKind)
)
