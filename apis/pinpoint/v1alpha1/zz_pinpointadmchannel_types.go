...
var (
	...
	PinpointAdmChannelGroupKind        = schema.GroupKind{Group: Group, Kind: PinpointAdmChannelKind}.String()
	PinpointAdmChannelKindAPIVersion   = PinpointAdmChannelKind + "." + GroupVersion.String()
	PinpointAdmChannelGroupVersionKind = GroupVersion.WithKind(PinpointAdmChannelKind)
)

func init() {
	SchemeBuilder.Register(&PinpointAdmChannel{}, &PinpointAdmChannelList{})
}
