...
var (
	...
	DaxSubnetGroupGroupKind        = schema.GroupKind{Group: Group, Kind: DaxSubnetGroupKind}.String()
	DaxSubnetGroupKindAPIVersion   = DaxSubnetGroupKind + "." + GroupVersion.String()
	DaxSubnetGroupGroupVersionKind = GroupVersion.WithKind(DaxSubnetGroupKind)
)

func init() {
	SchemeBuilder.Register(&DaxSubnetGroup{}, &DaxSubnetGroupList{})
}
