...
var (
	...
	XrayGroupGroupKind        = schema.GroupKind{Group: Group, Kind: XrayGroupKind}.String()
	XrayGroupKindAPIVersion   = XrayGroupKind + "." + GroupVersion.String()
	XrayGroupGroupVersionKind = GroupVersion.WithKind(XrayGroupKind)
)
