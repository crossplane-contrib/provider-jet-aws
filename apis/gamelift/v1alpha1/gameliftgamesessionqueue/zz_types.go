...
// GameliftGameSessionQueueSpec defines the desired state of GameliftGameSessionQueue
type GameliftGameSessionQueueSpec struct {
	xpv1.ResourceSpec `json:",inline"`
	ForProvider       GameliftGameSessionQueueParameters `json:"forProvider"`
}

// GameliftGameSessionQueueStatus defines the observed state of GameliftGameSessionQueue.
type GameliftGameSessionQueueStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          GameliftGameSessionQueueObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// GameliftGameSessionQueue is the Schema for the GameliftGameSessionQueues API
...
// GameliftGameSessionQueueList contains a list of GameliftGameSessionQueues
...
var (
	GameliftGameSessionQueueKind             = "GameliftGameSessionQueue"
	GameliftGameSessionQueueGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GameliftGameSessionQueueKind}.String()
	GameliftGameSessionQueueKindAPIVersion   = GameliftGameSessionQueueKind + "." + v1alpha1.GroupVersion.String()
	GameliftGameSessionQueueGroupVersionKind = v1alpha1.GroupVersion.WithKind(GameliftGameSessionQueueKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GameliftGameSessionQueue{}, &GameliftGameSessionQueueList{})
}
