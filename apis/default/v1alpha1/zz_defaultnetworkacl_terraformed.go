...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultNetworkAcl
func (tr *DefaultNetworkAcl) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this DefaultNetworkAcl
func (tr *DefaultNetworkAcl) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *DefaultNetworkAcl) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this DefaultNetworkAcl
func (tr *DefaultNetworkAcl) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
