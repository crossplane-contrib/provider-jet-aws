...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultRouteTable
func (tr *DefaultRouteTable) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this DefaultRouteTable
func (tr *DefaultRouteTable) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *DefaultRouteTable) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this DefaultRouteTable
func (tr *DefaultRouteTable) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
