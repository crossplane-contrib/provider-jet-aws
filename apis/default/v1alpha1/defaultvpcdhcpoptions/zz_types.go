...
var (
	...
	DefaultVpcDhcpOptionsGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DefaultVpcDhcpOptionsKind}.String()
	DefaultVpcDhcpOptionsKindAPIVersion   = DefaultVpcDhcpOptionsKind + "." + v1alpha1.GroupVersion.String()
	DefaultVpcDhcpOptionsGroupVersionKind = v1alpha1.GroupVersion.WithKind(DefaultVpcDhcpOptionsKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DefaultVpcDhcpOptions{}, &DefaultVpcDhcpOptionsList{})
}
