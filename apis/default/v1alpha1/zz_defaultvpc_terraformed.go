...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultVpc
func (tr *DefaultVpc) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this DefaultVpc
func (tr *DefaultVpc) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *DefaultVpc) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this DefaultVpc
func (tr *DefaultVpc) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
