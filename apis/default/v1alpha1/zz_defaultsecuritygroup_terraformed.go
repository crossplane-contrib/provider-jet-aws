...
// GetTerraformResourceIDField returns Terraform identifier field for this DefaultSecurityGroup
func (tr *DefaultSecurityGroup) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this DefaultSecurityGroup
func (tr *DefaultSecurityGroup) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *DefaultSecurityGroup) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this DefaultSecurityGroup
func (tr *DefaultSecurityGroup) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
