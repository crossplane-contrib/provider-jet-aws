...
var (
	...
	DefaultSubnetGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DefaultSubnetKind}.String()
	DefaultSubnetKindAPIVersion   = DefaultSubnetKind + "." + v1alpha1.GroupVersion.String()
	DefaultSubnetGroupVersionKind = v1alpha1.GroupVersion.WithKind(DefaultSubnetKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DefaultSubnet{}, &DefaultSubnetList{})
}
