...
import (
	...
	v1alpha2ecs "github.com/dkb-bank/provider-jet-aws/apis/ecs/v1alpha2"
	v1alpha2eks "github.com/dkb-bank/provider-jet-aws/apis/eks/v1alpha2"
	v1alpha2elasticache "github.com/dkb-bank/provider-jet-aws/apis/elasticache/v1alpha2"
	v1alpha2elbv2 "github.com/dkb-bank/provider-jet-aws/apis/elbv2/v1alpha2"
	v1alpha2globalaccelerator "github.com/dkb-bank/provider-jet-aws/apis/globalaccelerator/v1alpha2"
	v1alpha2grafana "github.com/dkb-bank/provider-jet-aws/apis/grafana/v1alpha2"
	v1alpha2iam "github.com/dkb-bank/provider-jet-aws/apis/iam/v1alpha2"
	...
	v1alpha2s3 "github.com/dkb-bank/provider-jet-aws/apis/s3/v1alpha2"
	v1alpha1apis "github.com/dkb-bank/provider-jet-aws/apis/v1alpha1"
)
