...
var (
	...
	CodebuildSourceCredentialGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CodebuildSourceCredentialKind}.String()
	CodebuildSourceCredentialKindAPIVersion   = CodebuildSourceCredentialKind + "." + v1alpha1.GroupVersion.String()
	CodebuildSourceCredentialGroupVersionKind = v1alpha1.GroupVersion.WithKind(CodebuildSourceCredentialKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CodebuildSourceCredential{}, &CodebuildSourceCredentialList{})
}
