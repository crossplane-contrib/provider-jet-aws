...
var (
	SourceCredentialKind             = "SourceCredential"
	SourceCredentialGroupKind        = schema.GroupKind{Group: Group, Kind: SourceCredentialKind}.String()
	SourceCredentialKindAPIVersion   = SourceCredentialKind + "." + GroupVersion.String()
	SourceCredentialGroupVersionKind = GroupVersion.WithKind(SourceCredentialKind)
)
