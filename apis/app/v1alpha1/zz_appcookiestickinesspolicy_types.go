...
var (
	...
	AppCookieStickinessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: AppCookieStickinessPolicyKind}.String()
	AppCookieStickinessPolicyKindAPIVersion   = AppCookieStickinessPolicyKind + "." + GroupVersion.String()
	AppCookieStickinessPolicyGroupVersionKind = GroupVersion.WithKind(AppCookieStickinessPolicyKind)
)
