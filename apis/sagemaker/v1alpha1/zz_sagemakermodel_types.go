...
var (
	...
	SagemakerModelGroupKind        = schema.GroupKind{Group: Group, Kind: SagemakerModelKind}.String()
	SagemakerModelKindAPIVersion   = SagemakerModelKind + "." + GroupVersion.String()
	SagemakerModelGroupVersionKind = GroupVersion.WithKind(SagemakerModelKind)
)
