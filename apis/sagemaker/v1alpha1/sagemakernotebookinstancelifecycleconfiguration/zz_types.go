...
var (
	...
	SagemakerNotebookInstanceLifecycleConfigurationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SagemakerNotebookInstanceLifecycleConfigurationKind}.String()
	SagemakerNotebookInstanceLifecycleConfigurationKindAPIVersion   = SagemakerNotebookInstanceLifecycleConfigurationKind + "." + v1alpha1.GroupVersion.String()
	SagemakerNotebookInstanceLifecycleConfigurationGroupVersionKind = v1alpha1.GroupVersion.WithKind(SagemakerNotebookInstanceLifecycleConfigurationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SagemakerNotebookInstanceLifecycleConfiguration{}, &SagemakerNotebookInstanceLifecycleConfigurationList{})
}
