...
// GetTerraformResourceIDField returns Terraform identifier field for this EndpointConfiguration
func (tr *EndpointConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
