...
var (
	...
	SagemakerImageVersionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SagemakerImageVersionKind}.String()
	SagemakerImageVersionKindAPIVersion   = SagemakerImageVersionKind + "." + v1alpha1.GroupVersion.String()
	SagemakerImageVersionGroupVersionKind = v1alpha1.GroupVersion.WithKind(SagemakerImageVersionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SagemakerImageVersion{}, &SagemakerImageVersionList{})
}
