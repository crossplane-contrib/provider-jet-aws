...
var (
	...
	SagemakerNotebookInstanceGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SagemakerNotebookInstanceKind}.String()
	SagemakerNotebookInstanceKindAPIVersion   = SagemakerNotebookInstanceKind + "." + v1alpha1.GroupVersion.String()
	SagemakerNotebookInstanceGroupVersionKind = v1alpha1.GroupVersion.WithKind(SagemakerNotebookInstanceKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SagemakerNotebookInstance{}, &SagemakerNotebookInstanceList{})
}
