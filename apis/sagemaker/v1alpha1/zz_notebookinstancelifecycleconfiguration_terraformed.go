...
// GetTerraformResourceIDField returns Terraform identifier field for this NotebookInstanceLifecycleConfiguration
func (tr *NotebookInstanceLifecycleConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
