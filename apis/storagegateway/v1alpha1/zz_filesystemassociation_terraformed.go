...
// GetTerraformResourceIDField returns Terraform identifier field for this FileSystemAssociation
func (tr *FileSystemAssociation) GetTerraformResourceIDField() string {
	return "id"
}
