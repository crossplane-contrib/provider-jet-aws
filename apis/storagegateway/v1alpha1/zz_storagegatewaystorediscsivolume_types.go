...
var (
	...
	StoragegatewayStoredIscsiVolumeGroupKind        = schema.GroupKind{Group: Group, Kind: StoragegatewayStoredIscsiVolumeKind}.String()
	StoragegatewayStoredIscsiVolumeKindAPIVersion   = StoragegatewayStoredIscsiVolumeKind + "." + GroupVersion.String()
	StoragegatewayStoredIscsiVolumeGroupVersionKind = GroupVersion.WithKind(StoragegatewayStoredIscsiVolumeKind)
)

func init() {
	SchemeBuilder.Register(&StoragegatewayStoredIscsiVolume{}, &StoragegatewayStoredIscsiVolumeList{})
}
