...
var (
	...
	StoragegatewaySmbFileShareGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: StoragegatewaySmbFileShareKind}.String()
	StoragegatewaySmbFileShareKindAPIVersion   = StoragegatewaySmbFileShareKind + "." + v1alpha1.GroupVersion.String()
	StoragegatewaySmbFileShareGroupVersionKind = v1alpha1.GroupVersion.WithKind(StoragegatewaySmbFileShareKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &StoragegatewaySmbFileShare{}, &StoragegatewaySmbFileShareList{})
}
