...
var (
	...
	StoragegatewayUploadBufferGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: StoragegatewayUploadBufferKind}.String()
	StoragegatewayUploadBufferKindAPIVersion   = StoragegatewayUploadBufferKind + "." + v1alpha1.GroupVersion.String()
	StoragegatewayUploadBufferGroupVersionKind = v1alpha1.GroupVersion.WithKind(StoragegatewayUploadBufferKind)
)
