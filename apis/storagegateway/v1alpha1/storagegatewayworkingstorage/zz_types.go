...
var (
	...
	StoragegatewayWorkingStorageGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: StoragegatewayWorkingStorageKind}.String()
	StoragegatewayWorkingStorageKindAPIVersion   = StoragegatewayWorkingStorageKind + "." + v1alpha1.GroupVersion.String()
	StoragegatewayWorkingStorageGroupVersionKind = v1alpha1.GroupVersion.WithKind(StoragegatewayWorkingStorageKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &StoragegatewayWorkingStorage{}, &StoragegatewayWorkingStorageList{})
}
