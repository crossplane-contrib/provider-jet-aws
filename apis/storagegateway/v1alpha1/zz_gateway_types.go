...
type GatewayParameters struct {
	...
	// +kubebuilder:validation:Optional
	AverageDownloadRateLimitInBitsPerSec *float64 `json:"averageDownloadRateLimitInBitsPerSec,omitempty" tf:"average_download_rate_limit_in_bits_per_sec,omitempty"`

	// +kubebuilder:validation:Optional
	AverageUploadRateLimitInBitsPerSec *float64 `json:"averageUploadRateLimitInBitsPerSec,omitempty" tf:"average_upload_rate_limit_in_bits_per_sec,omitempty"`
