...
var (
	...
	SchemasRegistryGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SchemasRegistryKind}.String()
	SchemasRegistryKindAPIVersion   = SchemasRegistryKind + "." + v1alpha1.GroupVersion.String()
	SchemasRegistryGroupVersionKind = v1alpha1.GroupVersion.WithKind(SchemasRegistryKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SchemasRegistry{}, &SchemasRegistryList{})
}
