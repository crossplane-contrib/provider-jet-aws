...
var (
	AdminAccountKind             = "AdminAccount"
	AdminAccountGroupKind        = schema.GroupKind{Group: Group, Kind: AdminAccountKind}.String()
	AdminAccountKindAPIVersion   = AdminAccountKind + "." + GroupVersion.String()
	AdminAccountGroupVersionKind = GroupVersion.WithKind(AdminAccountKind)
)
