...
// GetTerraformResourceIDField returns Terraform identifier field for this AdminAccount
func (tr *AdminAccount) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this AdminAccount using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdminAccount) LateInitialize(attrs []byte) (bool, error) {
	params := &AdminAccountParameters{}
