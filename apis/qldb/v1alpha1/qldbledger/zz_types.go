...
// +groupName=qldb.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/qldb/v1alpha1"
)
...
var (
	...
	QldbLedgerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: QldbLedgerKind}.String()
	QldbLedgerKindAPIVersion   = QldbLedgerKind + "." + v1alpha1.GroupVersion.String()
	QldbLedgerGroupVersionKind = v1alpha1.GroupVersion.WithKind(QldbLedgerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &QldbLedger{}, &QldbLedgerList{})
}
