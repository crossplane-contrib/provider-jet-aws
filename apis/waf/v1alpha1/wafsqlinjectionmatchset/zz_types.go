...
var (
	...
	WafSqlInjectionMatchSetGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: WafSqlInjectionMatchSetKind}.String()
	WafSqlInjectionMatchSetKindAPIVersion   = WafSqlInjectionMatchSetKind + "." + v1alpha1.GroupVersion.String()
	WafSqlInjectionMatchSetGroupVersionKind = v1alpha1.GroupVersion.WithKind(WafSqlInjectionMatchSetKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &WafSqlInjectionMatchSet{}, &WafSqlInjectionMatchSetList{})
}
