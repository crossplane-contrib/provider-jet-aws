...
var (
	...
	WafGeoMatchSetGroupKind        = schema.GroupKind{Group: Group, Kind: WafGeoMatchSetKind}.String()
	WafGeoMatchSetKindAPIVersion   = WafGeoMatchSetKind + "." + GroupVersion.String()
	WafGeoMatchSetGroupVersionKind = GroupVersion.WithKind(WafGeoMatchSetKind)
)

func init() {
	SchemeBuilder.Register(&WafGeoMatchSet{}, &WafGeoMatchSetList{})
}
