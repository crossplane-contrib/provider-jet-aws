...
var (
	...
	WafByteMatchSetGroupKind        = schema.GroupKind{Group: Group, Kind: WafByteMatchSetKind}.String()
	WafByteMatchSetKindAPIVersion   = WafByteMatchSetKind + "." + GroupVersion.String()
	WafByteMatchSetGroupVersionKind = GroupVersion.WithKind(WafByteMatchSetKind)
)

func init() {
	SchemeBuilder.Register(&WafByteMatchSet{}, &WafByteMatchSetList{})
}
