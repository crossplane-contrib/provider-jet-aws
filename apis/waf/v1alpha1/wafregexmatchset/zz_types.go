...
var (
	...
	WafRegexMatchSetGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: WafRegexMatchSetKind}.String()
	WafRegexMatchSetKindAPIVersion   = WafRegexMatchSetKind + "." + v1alpha1.GroupVersion.String()
	WafRegexMatchSetGroupVersionKind = v1alpha1.GroupVersion.WithKind(WafRegexMatchSetKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &WafRegexMatchSet{}, &WafRegexMatchSetList{})
}
