...
// ByteMatchSet is the Schema for the ByteMatchSets API
...
var (
	ByteMatchSetKind             = "ByteMatchSet"
	ByteMatchSetGroupKind        = schema.GroupKind{Group: Group, Kind: ByteMatchSetKind}.String()
	ByteMatchSetKindAPIVersion   = ByteMatchSetKind + "." + GroupVersion.String()
	ByteMatchSetGroupVersionKind = GroupVersion.WithKind(ByteMatchSetKind)
)
