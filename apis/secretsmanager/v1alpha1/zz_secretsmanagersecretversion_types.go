...
var (
	...
	SecretsmanagerSecretVersionGroupKind        = schema.GroupKind{Group: Group, Kind: SecretsmanagerSecretVersionKind}.String()
	SecretsmanagerSecretVersionKindAPIVersion   = SecretsmanagerSecretVersionKind + "." + GroupVersion.String()
	SecretsmanagerSecretVersionGroupVersionKind = GroupVersion.WithKind(SecretsmanagerSecretVersionKind)
)

func init() {
	SchemeBuilder.Register(&SecretsmanagerSecretVersion{}, &SecretsmanagerSecretVersionList{})
}
