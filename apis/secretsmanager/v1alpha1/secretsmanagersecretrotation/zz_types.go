...
type SecretsmanagerSecretRotationParameters struct {
	...
	RotationRules []RotationRulesParameters `json:"rotationRules" tf:"rotation_rules"`
...
var (
	...
	SecretsmanagerSecretRotationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SecretsmanagerSecretRotationKind}.String()
	SecretsmanagerSecretRotationKindAPIVersion   = SecretsmanagerSecretRotationKind + "." + v1alpha1.GroupVersion.String()
	SecretsmanagerSecretRotationGroupVersionKind = v1alpha1.GroupVersion.WithKind(SecretsmanagerSecretRotationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SecretsmanagerSecretRotation{}, &SecretsmanagerSecretRotationList{})
}
