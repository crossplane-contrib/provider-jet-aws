...
var (
	...
	SecretsmanagerSecretPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SecretsmanagerSecretPolicyKind}.String()
	SecretsmanagerSecretPolicyKindAPIVersion   = SecretsmanagerSecretPolicyKind + "." + v1alpha1.GroupVersion.String()
	SecretsmanagerSecretPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(SecretsmanagerSecretPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SecretsmanagerSecretPolicy{}, &SecretsmanagerSecretPolicyList{})
}
