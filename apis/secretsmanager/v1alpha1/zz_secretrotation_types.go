...
var (
	...
	SecretRotationGroupKind        = schema.GroupKind{Group: Group, Kind: SecretRotationKind}.String()
	SecretRotationKindAPIVersion   = SecretRotationKind + "." + GroupVersion.String()
	SecretRotationGroupVersionKind = GroupVersion.WithKind(SecretRotationKind)
)
