...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultLock
func (tr *VaultLock) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *VaultLock) GetObservation() (map[string]interface{}, error) {
...
func (tr *VaultLock) SetObservation(obs map[string]interface{}) error {
...
func (tr *VaultLock) GetParameters() (map[string]interface{}, error) {
...
func (tr *VaultLock) SetParameters(params map[string]interface{}) error {
