...
// GlacierVaultSpec defines the desired state of GlacierVault
type GlacierVaultSpec struct {
	xpv1.ResourceSpec `json:",inline"`
	ForProvider       GlacierVaultParameters `json:"forProvider"`
}

// GlacierVaultStatus defines the observed state of GlacierVault.
type GlacierVaultStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          GlacierVaultObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// GlacierVault is the Schema for the GlacierVaults API
...
// GlacierVaultList contains a list of GlacierVaults
...
var (
	GlacierVaultKind             = "GlacierVault"
	GlacierVaultGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlacierVaultKind}.String()
	GlacierVaultKindAPIVersion   = GlacierVaultKind + "." + v1alpha1.GroupVersion.String()
	GlacierVaultGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlacierVaultKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlacierVault{}, &GlacierVaultList{})
}
