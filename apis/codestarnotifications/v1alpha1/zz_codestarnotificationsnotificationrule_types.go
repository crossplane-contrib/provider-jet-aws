...
var (
	...
	CodestarnotificationsNotificationRuleGroupKind        = schema.GroupKind{Group: Group, Kind: CodestarnotificationsNotificationRuleKind}.String()
	CodestarnotificationsNotificationRuleKindAPIVersion   = CodestarnotificationsNotificationRuleKind + "." + GroupVersion.String()
	CodestarnotificationsNotificationRuleGroupVersionKind = GroupVersion.WithKind(CodestarnotificationsNotificationRuleKind)
)
