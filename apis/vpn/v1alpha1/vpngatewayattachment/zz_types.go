...
var (
	...
	VpnGatewayAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpnGatewayAttachmentKind}.String()
	VpnGatewayAttachmentKindAPIVersion   = VpnGatewayAttachmentKind + "." + v1alpha1.GroupVersion.String()
	VpnGatewayAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpnGatewayAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpnGatewayAttachment{}, &VpnGatewayAttachmentList{})
}
