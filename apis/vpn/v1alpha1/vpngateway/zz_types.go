...
var (
	...
	VpnGatewayGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpnGatewayKind}.String()
	VpnGatewayKindAPIVersion   = VpnGatewayKind + "." + v1alpha1.GroupVersion.String()
	VpnGatewayGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpnGatewayKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpnGateway{}, &VpnGatewayList{})
}
