...
// GetTerraformResourceIDField returns Terraform identifier field for this ApplicationSnapshot
func (tr *ApplicationSnapshot) GetTerraformResourceIDField() string {
	return "id"
}
