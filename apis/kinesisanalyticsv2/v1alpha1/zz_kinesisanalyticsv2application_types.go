...
var (
	...
	Kinesisanalyticsv2ApplicationGroupKind        = schema.GroupKind{Group: Group, Kind: Kinesisanalyticsv2ApplicationKind}.String()
	Kinesisanalyticsv2ApplicationKindAPIVersion   = Kinesisanalyticsv2ApplicationKind + "." + GroupVersion.String()
	Kinesisanalyticsv2ApplicationGroupVersionKind = GroupVersion.WithKind(Kinesisanalyticsv2ApplicationKind)
)
