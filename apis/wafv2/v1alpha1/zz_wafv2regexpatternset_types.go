...
var (
	...
	Wafv2RegexPatternSetGroupKind        = schema.GroupKind{Group: Group, Kind: Wafv2RegexPatternSetKind}.String()
	Wafv2RegexPatternSetKindAPIVersion   = Wafv2RegexPatternSetKind + "." + GroupVersion.String()
	Wafv2RegexPatternSetGroupVersionKind = GroupVersion.WithKind(Wafv2RegexPatternSetKind)
)

func init() {
	SchemeBuilder.Register(&Wafv2RegexPatternSet{}, &Wafv2RegexPatternSetList{})
}
