...
var (
	...
	Wafv2WebAclAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Wafv2WebAclAssociationKind}.String()
	Wafv2WebAclAssociationKindAPIVersion   = Wafv2WebAclAssociationKind + "." + v1alpha1.GroupVersion.String()
	Wafv2WebAclAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(Wafv2WebAclAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Wafv2WebAclAssociation{}, &Wafv2WebAclAssociationList{})
}
