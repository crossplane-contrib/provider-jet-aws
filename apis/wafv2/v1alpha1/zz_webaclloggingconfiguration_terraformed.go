...
// GetTerraformResourceIDField returns Terraform identifier field for this WebAclLoggingConfiguration
func (tr *WebAclLoggingConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
