...
// GetTerraformResourceIDField returns Terraform identifier field for this EipAssociation
func (tr *EipAssociation) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this EipAssociation
func (tr *EipAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *EipAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this EipAssociation
func (tr *EipAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
