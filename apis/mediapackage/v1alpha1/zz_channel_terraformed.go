...
func (tr *Channel) GetObservation() (map[string]interface{}, error) {
...
func (tr *Channel) SetObservation(obs map[string]interface{}) error {
...
func (tr *Channel) GetParameters() (map[string]interface{}, error) {
...
func (tr *Channel) SetParameters(params map[string]interface{}) error {
