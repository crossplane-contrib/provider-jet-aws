...
// GetTerraformResourceIDField returns Terraform identifier field for this Canary
func (tr *Canary) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this Canary using its observed tfState.
