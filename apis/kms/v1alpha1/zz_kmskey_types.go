...
var (
	KmsKeyKind             = "KmsKey"
	KmsKeyGroupKind        = schema.GroupKind{Group: Group, Kind: KmsKeyKind}.String()
	KmsKeyKindAPIVersion   = KmsKeyKind + "." + GroupVersion.String()
	KmsKeyGroupVersionKind = GroupVersion.WithKind(KmsKeyKind)
)
