...
var (
	...
	KmsAliasGroupKind        = schema.GroupKind{Group: Group, Kind: KmsAliasKind}.String()
	KmsAliasKindAPIVersion   = KmsAliasKind + "." + GroupVersion.String()
	KmsAliasGroupVersionKind = GroupVersion.WithKind(KmsAliasKind)
)
