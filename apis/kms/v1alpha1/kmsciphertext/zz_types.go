...
var (
	...
	KmsCiphertextGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: KmsCiphertextKind}.String()
	KmsCiphertextKindAPIVersion   = KmsCiphertextKind + "." + v1alpha1.GroupVersion.String()
	KmsCiphertextGroupVersionKind = v1alpha1.GroupVersion.WithKind(KmsCiphertextKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &KmsCiphertext{}, &KmsCiphertextList{})
}
