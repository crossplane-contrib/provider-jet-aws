...
var (
	...
	DevicefarmProjectGroupKind        = schema.GroupKind{Group: Group, Kind: DevicefarmProjectKind}.String()
	DevicefarmProjectKindAPIVersion   = DevicefarmProjectKind + "." + GroupVersion.String()
	DevicefarmProjectGroupVersionKind = GroupVersion.WithKind(DevicefarmProjectKind)
)

func init() {
	SchemeBuilder.Register(&DevicefarmProject{}, &DevicefarmProjectList{})
}
