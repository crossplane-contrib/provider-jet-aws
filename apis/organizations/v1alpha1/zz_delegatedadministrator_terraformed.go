...
// GetTerraformResourceIDField returns Terraform identifier field for this DelegatedAdministrator
func (tr *DelegatedAdministrator) GetTerraformResourceIDField() string {
	return "id"
}
