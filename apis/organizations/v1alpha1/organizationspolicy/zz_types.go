...
var (
	...
	OrganizationsPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: OrganizationsPolicyKind}.String()
	OrganizationsPolicyKindAPIVersion   = OrganizationsPolicyKind + "." + v1alpha1.GroupVersion.String()
	OrganizationsPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(OrganizationsPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &OrganizationsPolicy{}, &OrganizationsPolicyList{})
}
