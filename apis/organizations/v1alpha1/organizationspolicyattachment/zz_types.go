...
var (
	...
	OrganizationsPolicyAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: OrganizationsPolicyAttachmentKind}.String()
	OrganizationsPolicyAttachmentKindAPIVersion   = OrganizationsPolicyAttachmentKind + "." + v1alpha1.GroupVersion.String()
	OrganizationsPolicyAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(OrganizationsPolicyAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &OrganizationsPolicyAttachment{}, &OrganizationsPolicyAttachmentList{})
}
