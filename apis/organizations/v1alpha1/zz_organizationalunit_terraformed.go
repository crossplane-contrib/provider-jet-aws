...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationalUnit
func (tr *OrganizationalUnit) GetTerraformResourceIDField() string {
	return "id"
}
