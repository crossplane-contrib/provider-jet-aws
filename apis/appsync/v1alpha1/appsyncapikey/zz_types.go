...
var (
	...
	AppsyncApiKeyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppsyncApiKeyKind}.String()
	AppsyncApiKeyKindAPIVersion   = AppsyncApiKeyKind + "." + v1alpha1.GroupVersion.String()
	AppsyncApiKeyGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppsyncApiKeyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppsyncApiKey{}, &AppsyncApiKeyList{})
}
