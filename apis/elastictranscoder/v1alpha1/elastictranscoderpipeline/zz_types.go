...
var (
	...
	ElastictranscoderPipelineGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ElastictranscoderPipelineKind}.String()
	ElastictranscoderPipelineKindAPIVersion   = ElastictranscoderPipelineKind + "." + v1alpha1.GroupVersion.String()
	ElastictranscoderPipelineGroupVersionKind = v1alpha1.GroupVersion.WithKind(ElastictranscoderPipelineKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ElastictranscoderPipeline{}, &ElastictranscoderPipelineList{})
}
