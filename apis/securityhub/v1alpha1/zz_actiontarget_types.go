...
var (
	ActionTargetKind             = "ActionTarget"
	ActionTargetGroupKind        = schema.GroupKind{Group: Group, Kind: ActionTargetKind}.String()
	ActionTargetKindAPIVersion   = ActionTargetKind + "." + GroupVersion.String()
	ActionTargetGroupVersionKind = GroupVersion.WithKind(ActionTargetKind)
)
