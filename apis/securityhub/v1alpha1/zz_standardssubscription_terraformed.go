...
// GetTerraformResourceIDField returns Terraform identifier field for this StandardsSubscription
func (tr *StandardsSubscription) GetTerraformResourceIDField() string {
	return "id"
}
