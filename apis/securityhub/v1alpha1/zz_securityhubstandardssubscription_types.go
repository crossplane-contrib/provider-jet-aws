...
var (
	...
	SecurityhubStandardsSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: SecurityhubStandardsSubscriptionKind}.String()
	SecurityhubStandardsSubscriptionKindAPIVersion   = SecurityhubStandardsSubscriptionKind + "." + GroupVersion.String()
	SecurityhubStandardsSubscriptionGroupVersionKind = GroupVersion.WithKind(SecurityhubStandardsSubscriptionKind)
)

func init() {
	SchemeBuilder.Register(&SecurityhubStandardsSubscription{}, &SecurityhubStandardsSubscriptionList{})
}
