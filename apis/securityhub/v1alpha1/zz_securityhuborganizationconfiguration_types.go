...
var (
	...
	SecurityhubOrganizationConfigurationGroupKind        = schema.GroupKind{Group: Group, Kind: SecurityhubOrganizationConfigurationKind}.String()
	SecurityhubOrganizationConfigurationKindAPIVersion   = SecurityhubOrganizationConfigurationKind + "." + GroupVersion.String()
	SecurityhubOrganizationConfigurationGroupVersionKind = GroupVersion.WithKind(SecurityhubOrganizationConfigurationKind)
)
