...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationAdminAccount
func (tr *OrganizationAdminAccount) GetTerraformResourceIDField() string {
	return "id"
}
