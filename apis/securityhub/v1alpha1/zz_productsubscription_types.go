...
var (
	ProductSubscriptionKind             = "ProductSubscription"
	ProductSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: ProductSubscriptionKind}.String()
	ProductSubscriptionKindAPIVersion   = ProductSubscriptionKind + "." + GroupVersion.String()
	ProductSubscriptionGroupVersionKind = GroupVersion.WithKind(ProductSubscriptionKind)
)
