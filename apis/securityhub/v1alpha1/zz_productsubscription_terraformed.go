...
// GetTerraformResourceIDField returns Terraform identifier field for this ProductSubscription
func (tr *ProductSubscription) GetTerraformResourceIDField() string {
	return "id"
}
