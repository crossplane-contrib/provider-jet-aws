...
var (
	...
	SecurityhubMemberGroupKind        = schema.GroupKind{Group: Group, Kind: SecurityhubMemberKind}.String()
	SecurityhubMemberKindAPIVersion   = SecurityhubMemberKind + "." + GroupVersion.String()
	SecurityhubMemberGroupVersionKind = GroupVersion.WithKind(SecurityhubMemberKind)
)

func init() {
	SchemeBuilder.Register(&SecurityhubMember{}, &SecurityhubMemberList{})
}
