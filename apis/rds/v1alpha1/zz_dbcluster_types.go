...
type DBClusterParameters struct {
	...
	// +kubebuilder:validation:Optional
	RestoreToPointInTime []DBClusterRestoreToPointInTimeParameters `json:"restoreToPointInTime,omitempty" tf:"restore_to_point_in_time,omitempty"`

	// +kubebuilder:validation:Optional
	S3Import []DBClusterS3ImportParameters `json:"s3Import,omitempty" tf:"s3_import,omitempty"`
...
type DBClusterRestoreToPointInTimeObservation struct {
}

type DBClusterRestoreToPointInTimeParameters struct {
...
type DBClusterS3ImportObservation struct {
}

type DBClusterS3ImportParameters struct {
