...
// RdsClusterParameterGroup is the Schema for the RdsClusterParameterGroups API
...
// RdsClusterParameterGroupList contains a list of RdsClusterParameterGroups
...
var (
	RdsClusterParameterGroupKind             = "RdsClusterParameterGroup"
	RdsClusterParameterGroupGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: RdsClusterParameterGroupKind}.String()
	RdsClusterParameterGroupKindAPIVersion   = RdsClusterParameterGroupKind + "." + v1alpha1.GroupVersion.String()
	RdsClusterParameterGroupGroupVersionKind = v1alpha1.GroupVersion.WithKind(RdsClusterParameterGroupKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &RdsClusterParameterGroup{}, &RdsClusterParameterGroupList{})
}
