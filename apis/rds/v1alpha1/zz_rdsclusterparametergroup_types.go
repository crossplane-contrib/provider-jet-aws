...
var (
	...
	RdsClusterParameterGroupGroupKind        = schema.GroupKind{Group: Group, Kind: RdsClusterParameterGroupKind}.String()
	RdsClusterParameterGroupKindAPIVersion   = RdsClusterParameterGroupKind + "." + GroupVersion.String()
	RdsClusterParameterGroupGroupVersionKind = GroupVersion.WithKind(RdsClusterParameterGroupKind)
)

func init() {
	SchemeBuilder.Register(&RdsClusterParameterGroup{}, &RdsClusterParameterGroupList{})
}
