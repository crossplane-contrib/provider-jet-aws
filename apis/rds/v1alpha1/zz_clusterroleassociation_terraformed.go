...
// GetTerraformResourceIDField returns Terraform identifier field for this ClusterRoleAssociation
func (tr *ClusterRoleAssociation) GetTerraformResourceIDField() string {
	return "id"
}
