...
var (
	...
	RdsClusterEndpointGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: RdsClusterEndpointKind}.String()
	RdsClusterEndpointKindAPIVersion   = RdsClusterEndpointKind + "." + v1alpha1.GroupVersion.String()
	RdsClusterEndpointGroupVersionKind = v1alpha1.GroupVersion.WithKind(RdsClusterEndpointKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &RdsClusterEndpoint{}, &RdsClusterEndpointList{})
}
