...
var (
	...
	RdsClusterRoleAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: RdsClusterRoleAssociationKind}.String()
	RdsClusterRoleAssociationKindAPIVersion   = RdsClusterRoleAssociationKind + "." + v1alpha1.GroupVersion.String()
	RdsClusterRoleAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(RdsClusterRoleAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &RdsClusterRoleAssociation{}, &RdsClusterRoleAssociationList{})
}
