...
var (
	...
	EcrRepositoryPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: EcrRepositoryPolicyKind}.String()
	EcrRepositoryPolicyKindAPIVersion   = EcrRepositoryPolicyKind + "." + GroupVersion.String()
	EcrRepositoryPolicyGroupVersionKind = GroupVersion.WithKind(EcrRepositoryPolicyKind)
)
