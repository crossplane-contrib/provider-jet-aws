...
// GetTerraformResourceIDField returns Terraform identifier field for this ReplicationConfiguration
func (tr *ReplicationConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
