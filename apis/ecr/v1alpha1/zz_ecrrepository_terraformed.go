...
// GetTerraformResourceType returns Terraform resource type for this EcrRepository
func (mg *EcrRepository) GetTerraformResourceType() string {
	return "aws_ecr_repository"
}

// GetTerraformResourceIdField returns Terraform identifier field for this EcrRepository
