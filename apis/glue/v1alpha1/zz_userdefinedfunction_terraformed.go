...
// GetTerraformResourceIDField returns Terraform identifier field for this UserDefinedFunction
func (tr *UserDefinedFunction) GetTerraformResourceIDField() string {
	return "id"
}
