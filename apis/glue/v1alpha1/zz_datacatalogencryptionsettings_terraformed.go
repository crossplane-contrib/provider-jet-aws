...
// GetTerraformResourceIDField returns Terraform identifier field for this DataCatalogEncryptionSettings
func (tr *DataCatalogEncryptionSettings) GetTerraformResourceIDField() string {
	return "id"
}
