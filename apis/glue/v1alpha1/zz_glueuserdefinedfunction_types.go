...
var (
	...
	GlueUserDefinedFunctionGroupKind        = schema.GroupKind{Group: Group, Kind: GlueUserDefinedFunctionKind}.String()
	GlueUserDefinedFunctionKindAPIVersion   = GlueUserDefinedFunctionKind + "." + GroupVersion.String()
	GlueUserDefinedFunctionGroupVersionKind = GroupVersion.WithKind(GlueUserDefinedFunctionKind)
)
