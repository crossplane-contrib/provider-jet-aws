...
var (
	...
	GlueCrawlerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlueCrawlerKind}.String()
	GlueCrawlerKindAPIVersion   = GlueCrawlerKind + "." + v1alpha1.GroupVersion.String()
	GlueCrawlerGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlueCrawlerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlueCrawler{}, &GlueCrawlerList{})
}
