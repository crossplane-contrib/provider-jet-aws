...
var (
	CatalogDatabaseKind             = "CatalogDatabase"
	CatalogDatabaseGroupKind        = schema.GroupKind{Group: Group, Kind: CatalogDatabaseKind}.String()
	CatalogDatabaseKindAPIVersion   = CatalogDatabaseKind + "." + GroupVersion.String()
	CatalogDatabaseGroupVersionKind = GroupVersion.WithKind(CatalogDatabaseKind)
)
