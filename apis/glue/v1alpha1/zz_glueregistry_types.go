...
var (
	...
	GlueRegistryGroupKind        = schema.GroupKind{Group: Group, Kind: GlueRegistryKind}.String()
	GlueRegistryKindAPIVersion   = GlueRegistryKind + "." + GroupVersion.String()
	GlueRegistryGroupVersionKind = GroupVersion.WithKind(GlueRegistryKind)
)
