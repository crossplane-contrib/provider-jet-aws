...
var (
	...
	GlueCatalogTableGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlueCatalogTableKind}.String()
	GlueCatalogTableKindAPIVersion   = GlueCatalogTableKind + "." + v1alpha1.GroupVersion.String()
	GlueCatalogTableGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlueCatalogTableKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlueCatalogTable{}, &GlueCatalogTableList{})
}
