...
var (
	...
	GlueDevEndpointGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlueDevEndpointKind}.String()
	GlueDevEndpointKindAPIVersion   = GlueDevEndpointKind + "." + v1alpha1.GroupVersion.String()
	GlueDevEndpointGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlueDevEndpointKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlueDevEndpoint{}, &GlueDevEndpointList{})
}
