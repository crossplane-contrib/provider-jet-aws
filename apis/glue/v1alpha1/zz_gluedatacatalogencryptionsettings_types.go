...
var (
	...
	GlueDataCatalogEncryptionSettingsGroupKind        = schema.GroupKind{Group: Group, Kind: GlueDataCatalogEncryptionSettingsKind}.String()
	GlueDataCatalogEncryptionSettingsKindAPIVersion   = GlueDataCatalogEncryptionSettingsKind + "." + GroupVersion.String()
	GlueDataCatalogEncryptionSettingsGroupVersionKind = GroupVersion.WithKind(GlueDataCatalogEncryptionSettingsKind)
)
