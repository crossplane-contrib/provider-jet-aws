...
var (
	...
	GlueSchemaGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GlueSchemaKind}.String()
	GlueSchemaKindAPIVersion   = GlueSchemaKind + "." + v1alpha1.GroupVersion.String()
	GlueSchemaGroupVersionKind = v1alpha1.GroupVersion.WithKind(GlueSchemaKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GlueSchema{}, &GlueSchemaList{})
}
