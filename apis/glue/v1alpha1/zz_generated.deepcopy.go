...
func (in *DevEndpointObservation) DeepCopy() *DevEndpointObservation {
	...
	out := new(DevEndpointObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MLTransformObservation) DeepCopy() *MLTransformObservation {
	...
	out := new(MLTransformObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PartitionParameters) DeepCopyInto(out *PartitionParameters) {
	*out = *in
	...
	if in.StorageDescriptor != nil {
		in, out := &in.StorageDescriptor, &out.StorageDescriptor
		*out = make([]PartitionStorageDescriptorParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PartitionStorageDescriptorObservation) DeepCopy() *PartitionStorageDescriptorObservation {
	...
	out := new(PartitionStorageDescriptorObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PartitionStorageDescriptorParameters) DeepCopy() *PartitionStorageDescriptorParameters {
	...
	out := new(PartitionStorageDescriptorParameters)
	in.DeepCopyInto(out)
	return out
}
