...
// GetTerraformResourceIDField returns Terraform identifier field for this OriginAccessIdentity
func (tr *OriginAccessIdentity) GetTerraformResourceIDField() string {
	return "id"
}
