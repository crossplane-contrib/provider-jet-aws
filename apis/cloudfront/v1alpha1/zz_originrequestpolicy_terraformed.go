...
// GetTerraformResourceIDField returns Terraform identifier field for this OriginRequestPolicy
func (tr *OriginRequestPolicy) GetTerraformResourceIDField() string {
	return "id"
}
