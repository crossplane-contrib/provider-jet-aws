...
var (
	...
	CloudfrontKeyGroupGroupKind        = schema.GroupKind{Group: Group, Kind: CloudfrontKeyGroupKind}.String()
	CloudfrontKeyGroupKindAPIVersion   = CloudfrontKeyGroupKind + "." + GroupVersion.String()
	CloudfrontKeyGroupGroupVersionKind = GroupVersion.WithKind(CloudfrontKeyGroupKind)
)
