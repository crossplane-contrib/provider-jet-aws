...
// GetTerraformResourceIDField returns Terraform identifier field for this MonitoringSubscription
func (tr *MonitoringSubscription) GetTerraformResourceIDField() string {
	return "id"
}
