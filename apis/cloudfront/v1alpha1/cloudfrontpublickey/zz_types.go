...
var (
	...
	CloudfrontPublicKeyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CloudfrontPublicKeyKind}.String()
	CloudfrontPublicKeyKindAPIVersion   = CloudfrontPublicKeyKind + "." + v1alpha1.GroupVersion.String()
	CloudfrontPublicKeyGroupVersionKind = v1alpha1.GroupVersion.WithKind(CloudfrontPublicKeyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CloudfrontPublicKey{}, &CloudfrontPublicKeyList{})
}
