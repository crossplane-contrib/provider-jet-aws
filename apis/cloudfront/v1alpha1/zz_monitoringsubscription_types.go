...
var (
	MonitoringSubscriptionKind             = "MonitoringSubscription"
	MonitoringSubscriptionGroupKind        = schema.GroupKind{Group: Group, Kind: MonitoringSubscriptionKind}.String()
	MonitoringSubscriptionKindAPIVersion   = MonitoringSubscriptionKind + "." + GroupVersion.String()
	MonitoringSubscriptionGroupVersionKind = GroupVersion.WithKind(MonitoringSubscriptionKind)
)
