...
var (
	...
	DxHostedPublicVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: DxHostedPublicVirtualInterfaceKind}.String()
	DxHostedPublicVirtualInterfaceKindAPIVersion   = DxHostedPublicVirtualInterfaceKind + "." + GroupVersion.String()
	DxHostedPublicVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(DxHostedPublicVirtualInterfaceKind)
)

func init() {
	SchemeBuilder.Register(&DxHostedPublicVirtualInterface{}, &DxHostedPublicVirtualInterfaceList{})
}
