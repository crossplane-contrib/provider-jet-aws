...
// GetTerraformResourceIDField returns Terraform identifier field for this PublicVirtualInterface
func (tr *PublicVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
