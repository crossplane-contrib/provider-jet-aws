...
var (
	ConnectionAssociationKind             = "ConnectionAssociation"
	ConnectionAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: ConnectionAssociationKind}.String()
	ConnectionAssociationKindAPIVersion   = ConnectionAssociationKind + "." + GroupVersion.String()
	ConnectionAssociationGroupVersionKind = GroupVersion.WithKind(ConnectionAssociationKind)
)
