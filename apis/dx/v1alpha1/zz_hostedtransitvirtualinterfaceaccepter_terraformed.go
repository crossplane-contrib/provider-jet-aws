...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedTransitVirtualInterfaceAccepter
func (tr *HostedTransitVirtualInterfaceAccepter) GetTerraformResourceIDField() string {
	return "id"
}
