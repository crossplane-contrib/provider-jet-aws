...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedPublicVirtualInterface
func (tr *HostedPublicVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
