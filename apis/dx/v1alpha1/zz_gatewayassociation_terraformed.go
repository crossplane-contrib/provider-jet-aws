...
// GetTerraformResourceIDField returns Terraform identifier field for this GatewayAssociation
func (tr *GatewayAssociation) GetTerraformResourceIDField() string {
	return "id"
}
