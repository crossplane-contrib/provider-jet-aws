...
// GetTerraformResourceIDField returns Terraform identifier field for this ConnectionAssociation
func (tr *ConnectionAssociation) GetTerraformResourceIDField() string {
	return "id"
}
