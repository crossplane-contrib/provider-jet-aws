...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedPrivateVirtualInterfaceAccepter
func (tr *HostedPrivateVirtualInterfaceAccepter) GetTerraformResourceIDField() string {
	return "id"
}
