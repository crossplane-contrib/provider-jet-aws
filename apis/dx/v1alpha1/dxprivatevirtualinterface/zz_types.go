...
// DxPrivateVirtualInterfaceStatus defines the observed state of DxPrivateVirtualInterface.
type DxPrivateVirtualInterfaceStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          DxPrivateVirtualInterfaceObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// DxPrivateVirtualInterface is the Schema for the DxPrivateVirtualInterfaces API
...
// DxPrivateVirtualInterfaceList contains a list of DxPrivateVirtualInterfaces
...
var (
	DxPrivateVirtualInterfaceKind             = "DxPrivateVirtualInterface"
	DxPrivateVirtualInterfaceGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DxPrivateVirtualInterfaceKind}.String()
	DxPrivateVirtualInterfaceKindAPIVersion   = DxPrivateVirtualInterfaceKind + "." + v1alpha1.GroupVersion.String()
	DxPrivateVirtualInterfaceGroupVersionKind = v1alpha1.GroupVersion.WithKind(DxPrivateVirtualInterfaceKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DxPrivateVirtualInterface{}, &DxPrivateVirtualInterfaceList{})
}
