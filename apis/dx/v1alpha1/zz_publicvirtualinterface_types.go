...
var (
	PublicVirtualInterfaceKind             = "PublicVirtualInterface"
	PublicVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: PublicVirtualInterfaceKind}.String()
	PublicVirtualInterfaceKindAPIVersion   = PublicVirtualInterfaceKind + "." + GroupVersion.String()
	PublicVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(PublicVirtualInterfaceKind)
)
