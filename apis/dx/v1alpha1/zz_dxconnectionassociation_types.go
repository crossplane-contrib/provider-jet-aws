...
var (
	...
	DxConnectionAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: DxConnectionAssociationKind}.String()
	DxConnectionAssociationKindAPIVersion   = DxConnectionAssociationKind + "." + GroupVersion.String()
	DxConnectionAssociationGroupVersionKind = GroupVersion.WithKind(DxConnectionAssociationKind)
)

func init() {
	SchemeBuilder.Register(&DxConnectionAssociation{}, &DxConnectionAssociationList{})
}
