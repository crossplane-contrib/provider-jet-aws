...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedPublicVirtualInterfaceAccepter
func (tr *HostedPublicVirtualInterfaceAccepter) GetTerraformResourceIDField() string {
	return "id"
}
