...
// HostedPrivateVirtualInterface is the Schema for the HostedPrivateVirtualInterfaces API
...
var (
	HostedPrivateVirtualInterfaceKind             = "HostedPrivateVirtualInterface"
	HostedPrivateVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: HostedPrivateVirtualInterfaceKind}.String()
	HostedPrivateVirtualInterfaceKindAPIVersion   = HostedPrivateVirtualInterfaceKind + "." + GroupVersion.String()
	HostedPrivateVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(HostedPrivateVirtualInterfaceKind)
)
