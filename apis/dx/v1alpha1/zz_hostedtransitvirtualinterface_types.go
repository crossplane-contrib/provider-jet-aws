...
var (
	HostedTransitVirtualInterfaceKind             = "HostedTransitVirtualInterface"
	HostedTransitVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: HostedTransitVirtualInterfaceKind}.String()
	HostedTransitVirtualInterfaceKindAPIVersion   = HostedTransitVirtualInterfaceKind + "." + GroupVersion.String()
	HostedTransitVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(HostedTransitVirtualInterfaceKind)
)
