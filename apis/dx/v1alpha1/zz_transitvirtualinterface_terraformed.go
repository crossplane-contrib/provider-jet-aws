...
// GetTerraformResourceIDField returns Terraform identifier field for this TransitVirtualInterface
func (tr *TransitVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
