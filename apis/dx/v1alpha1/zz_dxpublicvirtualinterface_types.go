...
var (
	...
	DxPublicVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: DxPublicVirtualInterfaceKind}.String()
	DxPublicVirtualInterfaceKindAPIVersion   = DxPublicVirtualInterfaceKind + "." + GroupVersion.String()
	DxPublicVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(DxPublicVirtualInterfaceKind)
)

func init() {
	SchemeBuilder.Register(&DxPublicVirtualInterface{}, &DxPublicVirtualInterfaceList{})
}
