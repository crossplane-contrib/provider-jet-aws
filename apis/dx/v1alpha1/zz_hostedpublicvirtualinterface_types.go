...
// HostedPublicVirtualInterface is the Schema for the HostedPublicVirtualInterfaces API
...
var (
	HostedPublicVirtualInterfaceKind             = "HostedPublicVirtualInterface"
	HostedPublicVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: HostedPublicVirtualInterfaceKind}.String()
	HostedPublicVirtualInterfaceKindAPIVersion   = HostedPublicVirtualInterfaceKind + "." + GroupVersion.String()
	HostedPublicVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(HostedPublicVirtualInterfaceKind)
)
