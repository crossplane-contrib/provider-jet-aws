...
var (
	...
	DxHostedPublicVirtualInterfaceAccepterGroupKind        = schema.GroupKind{Group: Group, Kind: DxHostedPublicVirtualInterfaceAccepterKind}.String()
	DxHostedPublicVirtualInterfaceAccepterKindAPIVersion   = DxHostedPublicVirtualInterfaceAccepterKind + "." + GroupVersion.String()
	DxHostedPublicVirtualInterfaceAccepterGroupVersionKind = GroupVersion.WithKind(DxHostedPublicVirtualInterfaceAccepterKind)
)

func init() {
	SchemeBuilder.Register(&DxHostedPublicVirtualInterfaceAccepter{}, &DxHostedPublicVirtualInterfaceAccepterList{})
}
