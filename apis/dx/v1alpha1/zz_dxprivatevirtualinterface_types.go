...
var (
	...
	DxPrivateVirtualInterfaceGroupKind        = schema.GroupKind{Group: Group, Kind: DxPrivateVirtualInterfaceKind}.String()
	DxPrivateVirtualInterfaceKindAPIVersion   = DxPrivateVirtualInterfaceKind + "." + GroupVersion.String()
	DxPrivateVirtualInterfaceGroupVersionKind = GroupVersion.WithKind(DxPrivateVirtualInterfaceKind)
)

func init() {
	SchemeBuilder.Register(&DxPrivateVirtualInterface{}, &DxPrivateVirtualInterfaceList{})
}
