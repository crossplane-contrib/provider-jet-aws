...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedTransitVirtualInterface
func (tr *HostedTransitVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
