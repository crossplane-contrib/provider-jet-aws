...
// GetTerraformResourceIDField returns Terraform identifier field for this PrivateVirtualInterface
func (tr *PrivateVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
