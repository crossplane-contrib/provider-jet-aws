...
// GetTerraformResourceIDField returns Terraform identifier field for this HostedPrivateVirtualInterface
func (tr *HostedPrivateVirtualInterface) GetTerraformResourceIDField() string {
	return "id"
}
