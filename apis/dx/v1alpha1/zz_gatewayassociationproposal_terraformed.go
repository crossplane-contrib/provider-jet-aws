...
// GetTerraformResourceIDField returns Terraform identifier field for this GatewayAssociationProposal
func (tr *GatewayAssociationProposal) GetTerraformResourceIDField() string {
	return "id"
}
