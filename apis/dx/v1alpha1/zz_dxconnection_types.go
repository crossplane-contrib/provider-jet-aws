...
var (
	...
	DxConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: DxConnectionKind}.String()
	DxConnectionKindAPIVersion   = DxConnectionKind + "." + GroupVersion.String()
	DxConnectionGroupVersionKind = GroupVersion.WithKind(DxConnectionKind)
)

func init() {
	SchemeBuilder.Register(&DxConnection{}, &DxConnectionList{})
}
