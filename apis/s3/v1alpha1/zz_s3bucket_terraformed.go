...
// GetTerraformResourceIDField returns Terraform identifier field for this S3Bucket
func (tr *S3Bucket) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this S3Bucket
func (tr *S3Bucket) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *S3Bucket) SetObservation(obs map[string]interface{}) error {
...
func (tr *S3Bucket) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *S3Bucket) SetParameters(params map[string]interface{}) error {
...
// GetConnectionDetails of this S3Bucket
func (tr *S3Bucket) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
