...
// GetTerraformResourceIDField returns Terraform identifier field for this AccountPublicAccessBlock
func (tr *AccountPublicAccessBlock) GetTerraformResourceIDField() string {
	return "id"
}
