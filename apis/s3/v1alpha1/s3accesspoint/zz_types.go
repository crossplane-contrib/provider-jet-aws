...
var (
	...
	S3AccessPointGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: S3AccessPointKind}.String()
	S3AccessPointKindAPIVersion   = S3AccessPointKind + "." + v1alpha1.GroupVersion.String()
	S3AccessPointGroupVersionKind = v1alpha1.GroupVersion.WithKind(S3AccessPointKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &S3AccessPoint{}, &S3AccessPointList{})
}
