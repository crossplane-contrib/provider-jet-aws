...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketOwnershipControls
func (tr *BucketOwnershipControls) GetTerraformResourceIDField() string {
	return "id"
}
