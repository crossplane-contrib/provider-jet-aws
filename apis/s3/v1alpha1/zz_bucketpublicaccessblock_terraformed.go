...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketPublicAccessBlock
func (tr *BucketPublicAccessBlock) GetTerraformResourceIDField() string {
	return "id"
}
