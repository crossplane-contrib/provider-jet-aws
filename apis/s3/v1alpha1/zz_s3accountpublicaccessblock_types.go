...
var (
	...
	S3AccountPublicAccessBlockGroupKind        = schema.GroupKind{Group: Group, Kind: S3AccountPublicAccessBlockKind}.String()
	S3AccountPublicAccessBlockKindAPIVersion   = S3AccountPublicAccessBlockKind + "." + GroupVersion.String()
	S3AccountPublicAccessBlockGroupVersionKind = GroupVersion.WithKind(S3AccountPublicAccessBlockKind)
)

func init() {
	SchemeBuilder.Register(&S3AccountPublicAccessBlock{}, &S3AccountPublicAccessBlockList{})
}
