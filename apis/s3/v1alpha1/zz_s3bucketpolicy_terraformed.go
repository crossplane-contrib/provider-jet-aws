...
// GetTerraformResourceIDField returns Terraform identifier field for this S3BucketPolicy
func (tr *S3BucketPolicy) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this S3BucketPolicy
func (tr *S3BucketPolicy) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *S3BucketPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *S3BucketPolicy) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *S3BucketPolicy) SetParameters(params map[string]interface{}) error {
...
// GetConnectionDetails of this S3BucketPolicy
func (tr *S3BucketPolicy) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
