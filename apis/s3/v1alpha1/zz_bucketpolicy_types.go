...
var (
	BucketPolicyKind             = "BucketPolicy"
	BucketPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: BucketPolicyKind}.String()
	BucketPolicyKindAPIVersion   = BucketPolicyKind + "." + GroupVersion.String()
	BucketPolicyGroupVersionKind = GroupVersion.WithKind(BucketPolicyKind)
)
