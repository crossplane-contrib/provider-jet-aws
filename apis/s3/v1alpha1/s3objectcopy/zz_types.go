...
var (
	...
	S3ObjectCopyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: S3ObjectCopyKind}.String()
	S3ObjectCopyKindAPIVersion   = S3ObjectCopyKind + "." + v1alpha1.GroupVersion.String()
	S3ObjectCopyGroupVersionKind = v1alpha1.GroupVersion.WithKind(S3ObjectCopyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &S3ObjectCopy{}, &S3ObjectCopyList{})
}
