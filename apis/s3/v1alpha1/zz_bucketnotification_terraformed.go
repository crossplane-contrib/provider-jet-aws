...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketNotification
func (tr *BucketNotification) GetTerraformResourceIDField() string {
	return "id"
}
