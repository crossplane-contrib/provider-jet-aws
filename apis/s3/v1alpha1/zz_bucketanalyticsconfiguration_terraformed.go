...
// GetTerraformResourceIDField returns Terraform identifier field for this BucketAnalyticsConfiguration
func (tr *BucketAnalyticsConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
