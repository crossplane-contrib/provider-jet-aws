...
func (tr *S3BucketNotification) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *S3BucketNotification) SetObservation(obs map[string]interface{}) error {
...
func (tr *S3BucketNotification) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// LateInitialize this S3BucketNotification using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *S3BucketNotification) LateInitialize(attrs []byte) (bool, error) {
	params := &S3BucketNotificationParameters{}
...
// GetConnectionDetails of this S3BucketNotification
func (tr *S3BucketNotification) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
