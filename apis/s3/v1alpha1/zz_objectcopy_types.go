...
var (
	ObjectCopyKind             = "ObjectCopy"
	ObjectCopyGroupKind        = schema.GroupKind{Group: Group, Kind: ObjectCopyKind}.String()
	ObjectCopyKindAPIVersion   = ObjectCopyKind + "." + GroupVersion.String()
	ObjectCopyGroupVersionKind = GroupVersion.WithKind(ObjectCopyKind)
)
