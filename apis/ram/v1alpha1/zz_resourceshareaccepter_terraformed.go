...
// GetTerraformResourceIDField returns Terraform identifier field for this ResourceShareAccepter
func (tr *ResourceShareAccepter) GetTerraformResourceIDField() string {
	return "id"
}
