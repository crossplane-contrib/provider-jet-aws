...
// GetTerraformResourceIDField returns Terraform identifier field for this PrincipalAssociation
func (tr *PrincipalAssociation) GetTerraformResourceIDField() string {
	return "id"
}
