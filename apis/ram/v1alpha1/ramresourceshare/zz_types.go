...
var (
	...
	RamResourceShareGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: RamResourceShareKind}.String()
	RamResourceShareKindAPIVersion   = RamResourceShareKind + "." + v1alpha1.GroupVersion.String()
	RamResourceShareGroupVersionKind = v1alpha1.GroupVersion.WithKind(RamResourceShareKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &RamResourceShare{}, &RamResourceShareList{})
}
