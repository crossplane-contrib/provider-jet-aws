...
var (
	...
	RamResourceShareAccepterGroupKind        = schema.GroupKind{Group: Group, Kind: RamResourceShareAccepterKind}.String()
	RamResourceShareAccepterKindAPIVersion   = RamResourceShareAccepterKind + "." + GroupVersion.String()
	RamResourceShareAccepterGroupVersionKind = GroupVersion.WithKind(RamResourceShareAccepterKind)
)

func init() {
	SchemeBuilder.Register(&RamResourceShareAccepter{}, &RamResourceShareAccepterList{})
}
