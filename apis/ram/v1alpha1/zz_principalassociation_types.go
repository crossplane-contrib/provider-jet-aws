...
// PrincipalAssociation is the Schema for the PrincipalAssociations API
...
var (
	PrincipalAssociationKind             = "PrincipalAssociation"
	PrincipalAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: PrincipalAssociationKind}.String()
	PrincipalAssociationKindAPIVersion   = PrincipalAssociationKind + "." + GroupVersion.String()
	PrincipalAssociationGroupVersionKind = GroupVersion.WithKind(PrincipalAssociationKind)
)
