...
var (
	...
	RamResourceAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: RamResourceAssociationKind}.String()
	RamResourceAssociationKindAPIVersion   = RamResourceAssociationKind + "." + v1alpha1.GroupVersion.String()
	RamResourceAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(RamResourceAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &RamResourceAssociation{}, &RamResourceAssociationList{})
}
