...
// GetTerraformResourceIDField returns Terraform identifier field for this ResourceAssociation
func (tr *ResourceAssociation) GetTerraformResourceIDField() string {
	return "id"
}
