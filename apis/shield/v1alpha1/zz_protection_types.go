...
var (
	...
	ProtectionGroupKind        = schema.GroupKind{Group: Group, Kind: ProtectionKind}.String()
	ProtectionKindAPIVersion   = ProtectionKind + "." + GroupVersion.String()
	ProtectionGroupVersionKind = GroupVersion.WithKind(ProtectionKind)
)
