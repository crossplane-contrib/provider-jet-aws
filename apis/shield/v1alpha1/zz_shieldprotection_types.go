...
var (
	...
	ShieldProtectionGroupKind        = schema.GroupKind{Group: Group, Kind: ShieldProtectionKind}.String()
	ShieldProtectionKindAPIVersion   = ShieldProtectionKind + "." + GroupVersion.String()
	ShieldProtectionGroupVersionKind = GroupVersion.WithKind(ShieldProtectionKind)
)
