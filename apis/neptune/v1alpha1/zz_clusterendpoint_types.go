...
type ClusterEndpointParameters struct {
	...
	ClusterEndpointIdentifier *string `json:"clusterEndpointIdentifier" tf:"cluster_endpoint_identifier,omitempty"`
...
var (
	ClusterEndpointKind             = "ClusterEndpoint"
	ClusterEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: ClusterEndpointKind}.String()
	ClusterEndpointKindAPIVersion   = ClusterEndpointKind + "." + GroupVersion.String()
	ClusterEndpointGroupVersionKind = GroupVersion.WithKind(ClusterEndpointKind)
)
