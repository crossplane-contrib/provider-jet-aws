...
var (
	...
	NeptuneClusterSnapshotGroupKind        = schema.GroupKind{Group: Group, Kind: NeptuneClusterSnapshotKind}.String()
	NeptuneClusterSnapshotKindAPIVersion   = NeptuneClusterSnapshotKind + "." + GroupVersion.String()
	NeptuneClusterSnapshotGroupVersionKind = GroupVersion.WithKind(NeptuneClusterSnapshotKind)
)

func init() {
	SchemeBuilder.Register(&NeptuneClusterSnapshot{}, &NeptuneClusterSnapshotList{})
}
