...
var (
	...
	NeptuneClusterGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: NeptuneClusterKind}.String()
	NeptuneClusterKindAPIVersion   = NeptuneClusterKind + "." + v1alpha1.GroupVersion.String()
	NeptuneClusterGroupVersionKind = v1alpha1.GroupVersion.WithKind(NeptuneClusterKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &NeptuneCluster{}, &NeptuneClusterList{})
}
