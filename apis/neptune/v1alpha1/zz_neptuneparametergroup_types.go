...
type NeptuneParameterGroupParameterObservation struct {
}
...
var (
	...
	NeptuneParameterGroupGroupKind        = schema.GroupKind{Group: Group, Kind: NeptuneParameterGroupKind}.String()
	NeptuneParameterGroupKindAPIVersion   = NeptuneParameterGroupKind + "." + GroupVersion.String()
	NeptuneParameterGroupGroupVersionKind = GroupVersion.WithKind(NeptuneParameterGroupKind)
)

func init() {
	SchemeBuilder.Register(&NeptuneParameterGroup{}, &NeptuneParameterGroupList{})
}
