...
var (
	...
	NeptuneClusterInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: NeptuneClusterInstanceKind}.String()
	NeptuneClusterInstanceKindAPIVersion   = NeptuneClusterInstanceKind + "." + GroupVersion.String()
	NeptuneClusterInstanceGroupVersionKind = GroupVersion.WithKind(NeptuneClusterInstanceKind)
)

func init() {
	SchemeBuilder.Register(&NeptuneClusterInstance{}, &NeptuneClusterInstanceList{})
}
