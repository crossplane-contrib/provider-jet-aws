...
// GetTerraformResourceIDField returns Terraform identifier field for this ClusterParameterGroup
func (tr *ClusterParameterGroup) GetTerraformResourceIDField() string {
	return "id"
}
