...
var (
	...
	NeptuneClusterEndpointGroupKind        = schema.GroupKind{Group: Group, Kind: NeptuneClusterEndpointKind}.String()
	NeptuneClusterEndpointKindAPIVersion   = NeptuneClusterEndpointKind + "." + GroupVersion.String()
	NeptuneClusterEndpointGroupVersionKind = GroupVersion.WithKind(NeptuneClusterEndpointKind)
)

func init() {
	SchemeBuilder.Register(&NeptuneClusterEndpoint{}, &NeptuneClusterEndpointList{})
}
