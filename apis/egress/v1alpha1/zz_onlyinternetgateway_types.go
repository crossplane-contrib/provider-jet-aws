...
var (
	OnlyInternetGateway_Kind             = "OnlyInternetGateway"
	OnlyInternetGateway_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OnlyInternetGateway_Kind}.String()
	OnlyInternetGateway_KindAPIVersion   = OnlyInternetGateway_Kind + "." + CRDGroupVersion.String()
	OnlyInternetGateway_GroupVersionKind = CRDGroupVersion.WithKind(OnlyInternetGateway_Kind)
)
