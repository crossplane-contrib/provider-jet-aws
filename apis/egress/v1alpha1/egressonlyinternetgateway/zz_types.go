...
// +groupName=egress.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/egress/v1alpha1"
)
...
var (
	...
	EgressOnlyInternetGatewayGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EgressOnlyInternetGatewayKind}.String()
	EgressOnlyInternetGatewayKindAPIVersion   = EgressOnlyInternetGatewayKind + "." + v1alpha1.GroupVersion.String()
	EgressOnlyInternetGatewayGroupVersionKind = v1alpha1.GroupVersion.WithKind(EgressOnlyInternetGatewayKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EgressOnlyInternetGateway{}, &EgressOnlyInternetGatewayList{})
}
