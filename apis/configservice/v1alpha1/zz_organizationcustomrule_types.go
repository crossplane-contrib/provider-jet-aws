...
var (
	OrganizationCustomRule_Kind             = "OrganizationCustomRule"
	OrganizationCustomRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrganizationCustomRule_Kind}.String()
	OrganizationCustomRule_KindAPIVersion   = OrganizationCustomRule_Kind + "." + CRDGroupVersion.String()
	OrganizationCustomRule_GroupVersionKind = CRDGroupVersion.WithKind(OrganizationCustomRule_Kind)
)
