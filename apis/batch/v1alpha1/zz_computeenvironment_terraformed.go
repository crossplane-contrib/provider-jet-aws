...
// GetTerraformResourceIDField returns Terraform identifier field for this ComputeEnvironment
func (tr *ComputeEnvironment) GetTerraformResourceIDField() string {
	return "id"
}
