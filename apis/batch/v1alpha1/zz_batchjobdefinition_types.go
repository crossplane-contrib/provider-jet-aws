...
var (
	...
	BatchJobDefinitionGroupKind        = schema.GroupKind{Group: Group, Kind: BatchJobDefinitionKind}.String()
	BatchJobDefinitionKindAPIVersion   = BatchJobDefinitionKind + "." + GroupVersion.String()
	BatchJobDefinitionGroupVersionKind = GroupVersion.WithKind(BatchJobDefinitionKind)
)
