...
var (
	...
	BatchJobQueueGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: BatchJobQueueKind}.String()
	BatchJobQueueKindAPIVersion   = BatchJobQueueKind + "." + v1alpha1.GroupVersion.String()
	BatchJobQueueGroupVersionKind = v1alpha1.GroupVersion.WithKind(BatchJobQueueKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &BatchJobQueue{}, &BatchJobQueueList{})
}
