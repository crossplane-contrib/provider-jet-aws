...
// GetCondition of this AnalyticsApplication.
func (mg *AnalyticsApplication) GetCondition(ct xpv1.ConditionType) xpv1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this AnalyticsApplication.
func (mg *AnalyticsApplication) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetProviderConfigReference of this AnalyticsApplication.
func (mg *AnalyticsApplication) GetProviderConfigReference() *xpv1.Reference {
	return mg.Spec.ProviderConfigReference
}

/*
GetProviderReference of this AnalyticsApplication.
Deprecated: Use GetProviderConfigReference.
*/
func (mg *AnalyticsApplication) GetProviderReference() *xpv1.Reference {
	return mg.Spec.ProviderReference
}

// GetWriteConnectionSecretToReference of this AnalyticsApplication.
func (mg *AnalyticsApplication) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetConditions of this AnalyticsApplication.
func (mg *AnalyticsApplication) SetConditions(c ...xpv1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this AnalyticsApplication.
func (mg *AnalyticsApplication) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetProviderConfigReference of this AnalyticsApplication.
func (mg *AnalyticsApplication) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}

/*
SetProviderReference of this AnalyticsApplication.
Deprecated: Use SetProviderConfigReference.
*/
func (mg *AnalyticsApplication) SetProviderReference(r *xpv1.Reference) {
	mg.Spec.ProviderReference = r
}

// SetWriteConnectionSecretToReference of this AnalyticsApplication.
func (mg *AnalyticsApplication) SetWriteConnectionSecretToReference(r *xpv1.SecretReference) {
