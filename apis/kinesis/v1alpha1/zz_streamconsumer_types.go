...
var (
	StreamConsumerKind             = "StreamConsumer"
	StreamConsumerGroupKind        = schema.GroupKind{Group: Group, Kind: StreamConsumerKind}.String()
	StreamConsumerKindAPIVersion   = StreamConsumerKind + "." + GroupVersion.String()
	StreamConsumerGroupVersionKind = GroupVersion.WithKind(StreamConsumerKind)
)
