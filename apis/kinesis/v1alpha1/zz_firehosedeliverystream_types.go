...
var (
	FirehoseDeliveryStreamKind             = "FirehoseDeliveryStream"
	FirehoseDeliveryStreamGroupKind        = schema.GroupKind{Group: Group, Kind: FirehoseDeliveryStreamKind}.String()
	FirehoseDeliveryStreamKindAPIVersion   = FirehoseDeliveryStreamKind + "." + GroupVersion.String()
	FirehoseDeliveryStreamGroupVersionKind = GroupVersion.WithKind(FirehoseDeliveryStreamKind)
)
