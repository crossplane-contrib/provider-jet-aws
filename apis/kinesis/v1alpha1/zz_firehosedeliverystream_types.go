...
type ElasticsearchConfigurationCloudwatchLoggingOptionsObservation struct {
}

type ElasticsearchConfigurationCloudwatchLoggingOptionsParameters struct {
...
type ElasticsearchConfigurationParameters struct {
	...
	// +kubebuilder:validation:Optional
	CloudwatchLoggingOptions []ElasticsearchConfigurationCloudwatchLoggingOptionsParameters `json:"cloudwatchLoggingOptions,omitempty" tf:"cloudwatch_logging_options,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ProcessingConfiguration []ElasticsearchConfigurationProcessingConfigurationParameters `json:"processingConfiguration,omitempty" tf:"processing_configuration,omitempty"`
...
type ElasticsearchConfigurationProcessingConfigurationObservation struct {
}

type ElasticsearchConfigurationProcessingConfigurationParameters struct {
...
type FirehoseDeliveryStreamObservation struct {
	TagsAll map[string]*string `json:"tagsAll,omitempty" tf:"tags_all,omitempty"`
}

type FirehoseDeliveryStreamParameters struct {
...
// FirehoseDeliveryStreamSpec defines the desired state of FirehoseDeliveryStream
type FirehoseDeliveryStreamSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     FirehoseDeliveryStreamParameters `json:"forProvider"`
}
...
type FirehoseDeliveryStreamStatus struct {
	...
	AtProvider        FirehoseDeliveryStreamObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// FirehoseDeliveryStream is the Schema for the FirehoseDeliveryStreams API
...
type FirehoseDeliveryStream struct {
	...
	Spec              FirehoseDeliveryStreamSpec   `json:"spec"`
	Status            FirehoseDeliveryStreamStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// FirehoseDeliveryStreamList contains a list of FirehoseDeliveryStreams
...
var (
	FirehoseDeliveryStream_Kind             = "FirehoseDeliveryStream"
	FirehoseDeliveryStream_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: FirehoseDeliveryStream_Kind}.String()
	FirehoseDeliveryStream_KindAPIVersion   = FirehoseDeliveryStream_Kind + "." + CRDGroupVersion.String()
	FirehoseDeliveryStream_GroupVersionKind = CRDGroupVersion.WithKind(FirehoseDeliveryStream_Kind)
)
