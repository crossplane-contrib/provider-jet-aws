...
var (
	...
	KinesisVideoStreamGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: KinesisVideoStreamKind}.String()
	KinesisVideoStreamKindAPIVersion   = KinesisVideoStreamKind + "." + v1alpha1.GroupVersion.String()
	KinesisVideoStreamGroupVersionKind = v1alpha1.GroupVersion.WithKind(KinesisVideoStreamKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &KinesisVideoStream{}, &KinesisVideoStreamList{})
}
