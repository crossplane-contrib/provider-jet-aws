...
var (
	...
	KinesisStreamConsumerGroupKind        = schema.GroupKind{Group: Group, Kind: KinesisStreamConsumerKind}.String()
	KinesisStreamConsumerKindAPIVersion   = KinesisStreamConsumerKind + "." + GroupVersion.String()
	KinesisStreamConsumerGroupVersionKind = GroupVersion.WithKind(KinesisStreamConsumerKind)
)
