...
var (
	ConvertQueue_Kind             = "ConvertQueue"
	ConvertQueue_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ConvertQueue_Kind}.String()
	ConvertQueue_KindAPIVersion   = ConvertQueue_Kind + "." + CRDGroupVersion.String()
	ConvertQueue_GroupVersionKind = CRDGroupVersion.WithKind(ConvertQueue_Kind)
)
