...
var (
	StoreContainerPolicy_Kind             = "StoreContainerPolicy"
	StoreContainerPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: StoreContainerPolicy_Kind}.String()
	StoreContainerPolicy_KindAPIVersion   = StoreContainerPolicy_Kind + "." + CRDGroupVersion.String()
	StoreContainerPolicy_GroupVersionKind = CRDGroupVersion.WithKind(StoreContainerPolicy_Kind)
)
