...
var (
	...
	MediaStoreContainerGroupKind        = schema.GroupKind{Group: Group, Kind: MediaStoreContainerKind}.String()
	MediaStoreContainerKindAPIVersion   = MediaStoreContainerKind + "." + GroupVersion.String()
	MediaStoreContainerGroupVersionKind = GroupVersion.WithKind(MediaStoreContainerKind)
)

func init() {
	SchemeBuilder.Register(&MediaStoreContainer{}, &MediaStoreContainerList{})
}
