...
var (
	...
	ImagebuilderImageGroupKind        = schema.GroupKind{Group: Group, Kind: ImagebuilderImageKind}.String()
	ImagebuilderImageKindAPIVersion   = ImagebuilderImageKind + "." + GroupVersion.String()
	ImagebuilderImageGroupVersionKind = GroupVersion.WithKind(ImagebuilderImageKind)
)
