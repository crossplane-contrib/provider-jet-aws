...
// GetTerraformResourceIDField returns Terraform identifier field for this DistributionConfiguration
func (tr *DistributionConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
