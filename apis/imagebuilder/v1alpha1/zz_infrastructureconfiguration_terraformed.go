...
// GetTerraformResourceIDField returns Terraform identifier field for this InfrastructureConfiguration
func (tr *InfrastructureConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
