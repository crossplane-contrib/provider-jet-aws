...
type AppmeshMeshSpecObservation struct {
}
...
var (
	...
	AppmeshMeshGroupKind        = schema.GroupKind{Group: Group, Kind: AppmeshMeshKind}.String()
	AppmeshMeshKindAPIVersion   = AppmeshMeshKind + "." + GroupVersion.String()
	AppmeshMeshGroupVersionKind = GroupVersion.WithKind(AppmeshMeshKind)
)

func init() {
	SchemeBuilder.Register(&AppmeshMesh{}, &AppmeshMeshList{})
}
