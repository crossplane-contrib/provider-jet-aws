...
var (
	...
	AppmeshVirtualRouterGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppmeshVirtualRouterKind}.String()
	AppmeshVirtualRouterKindAPIVersion   = AppmeshVirtualRouterKind + "." + v1alpha1.GroupVersion.String()
	AppmeshVirtualRouterGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppmeshVirtualRouterKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppmeshVirtualRouter{}, &AppmeshVirtualRouterList{})
}
