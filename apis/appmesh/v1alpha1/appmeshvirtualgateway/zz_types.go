...
var (
	...
	AppmeshVirtualGatewayGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AppmeshVirtualGatewayKind}.String()
	AppmeshVirtualGatewayKindAPIVersion   = AppmeshVirtualGatewayKind + "." + v1alpha1.GroupVersion.String()
	AppmeshVirtualGatewayGroupVersionKind = v1alpha1.GroupVersion.WithKind(AppmeshVirtualGatewayKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AppmeshVirtualGateway{}, &AppmeshVirtualGatewayList{})
}
