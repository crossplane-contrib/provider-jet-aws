...
// GetItems of this DmsCertificateList.
func (l *DmsCertificateList) GetItems() []resource.Managed {
...
// GetItems of this DmsEndpointList.
func (l *DmsEndpointList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
func (l *DmsReplicationSubnetGroupList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
