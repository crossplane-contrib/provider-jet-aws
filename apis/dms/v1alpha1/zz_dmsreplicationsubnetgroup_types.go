...
var (
	...
	DmsReplicationSubnetGroupGroupKind        = schema.GroupKind{Group: Group, Kind: DmsReplicationSubnetGroupKind}.String()
	DmsReplicationSubnetGroupKindAPIVersion   = DmsReplicationSubnetGroupKind + "." + GroupVersion.String()
	DmsReplicationSubnetGroupGroupVersionKind = GroupVersion.WithKind(DmsReplicationSubnetGroupKind)
)
