...
// GetTerraformResourceIDField returns Terraform identifier field for this ReplicationSubnetGroup
func (tr *ReplicationSubnetGroup) GetTerraformResourceIDField() string {
	return "id"
}
