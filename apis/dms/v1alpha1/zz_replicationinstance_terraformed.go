...
// GetTerraformResourceIDField returns Terraform identifier field for this ReplicationInstance
func (tr *ReplicationInstance) GetTerraformResourceIDField() string {
	return "id"
}
