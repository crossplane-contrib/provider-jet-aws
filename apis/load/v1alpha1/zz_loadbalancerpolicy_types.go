...
var (
	...
	LoadBalancerPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: LoadBalancerPolicyKind}.String()
	LoadBalancerPolicyKindAPIVersion   = LoadBalancerPolicyKind + "." + GroupVersion.String()
	LoadBalancerPolicyGroupVersionKind = GroupVersion.WithKind(LoadBalancerPolicyKind)
)
