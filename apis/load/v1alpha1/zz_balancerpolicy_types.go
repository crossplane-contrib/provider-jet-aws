...
var (
	BalancerPolicy_Kind             = "BalancerPolicy"
	BalancerPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BalancerPolicy_Kind}.String()
	BalancerPolicy_KindAPIVersion   = BalancerPolicy_Kind + "." + CRDGroupVersion.String()
	BalancerPolicy_GroupVersionKind = CRDGroupVersion.WithKind(BalancerPolicy_Kind)
)
