...
var (
	...
	LoadBalancerBackendServerPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: LoadBalancerBackendServerPolicyKind}.String()
	LoadBalancerBackendServerPolicyKindAPIVersion   = LoadBalancerBackendServerPolicyKind + "." + GroupVersion.String()
	LoadBalancerBackendServerPolicyGroupVersionKind = GroupVersion.WithKind(LoadBalancerBackendServerPolicyKind)
)

func init() {
	SchemeBuilder.Register(&LoadBalancerBackendServerPolicy{}, &LoadBalancerBackendServerPolicyList{})
}
