...
var (
	...
	AcmCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: AcmCertificateKind}.String()
	AcmCertificateKindAPIVersion   = AcmCertificateKind + "." + GroupVersion.String()
	AcmCertificateGroupVersionKind = GroupVersion.WithKind(AcmCertificateKind)
)

func init() {
	SchemeBuilder.Register(&AcmCertificate{}, &AcmCertificateList{})
}
