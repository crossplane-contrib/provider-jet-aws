...
var (
	CertificateValidationKind             = "CertificateValidation"
	CertificateValidationGroupKind        = schema.GroupKind{Group: Group, Kind: CertificateValidationKind}.String()
	CertificateValidationKindAPIVersion   = CertificateValidationKind + "." + GroupVersion.String()
	CertificateValidationGroupVersionKind = GroupVersion.WithKind(CertificateValidationKind)
)
