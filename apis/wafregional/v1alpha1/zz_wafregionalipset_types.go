...
var (
	...
	WafregionalIpsetGroupKind        = schema.GroupKind{Group: Group, Kind: WafregionalIpsetKind}.String()
	WafregionalIpsetKindAPIVersion   = WafregionalIpsetKind + "." + GroupVersion.String()
	WafregionalIpsetGroupVersionKind = GroupVersion.WithKind(WafregionalIpsetKind)
)

func init() {
	SchemeBuilder.Register(&WafregionalIpset{}, &WafregionalIpsetList{})
}
