...
var (
	...
	WafregionalSizeConstraintSetGroupKind        = schema.GroupKind{Group: Group, Kind: WafregionalSizeConstraintSetKind}.String()
	WafregionalSizeConstraintSetKindAPIVersion   = WafregionalSizeConstraintSetKind + "." + GroupVersion.String()
	WafregionalSizeConstraintSetGroupVersionKind = GroupVersion.WithKind(WafregionalSizeConstraintSetKind)
)

func init() {
	SchemeBuilder.Register(&WafregionalSizeConstraintSet{}, &WafregionalSizeConstraintSetList{})
}
