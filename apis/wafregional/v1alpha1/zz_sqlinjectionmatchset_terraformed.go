...
// GetTerraformResourceIDField returns Terraform identifier field for this SqlInjectionMatchSet
func (tr *SqlInjectionMatchSet) GetTerraformResourceIDField() string {
	return "id"
}
