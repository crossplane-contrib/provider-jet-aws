...
// WafregionalSqlInjectionMatchSetStatus defines the observed state of WafregionalSqlInjectionMatchSet.
type WafregionalSqlInjectionMatchSetStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          WafregionalSqlInjectionMatchSetObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// WafregionalSqlInjectionMatchSet is the Schema for the WafregionalSqlInjectionMatchSets API
...
// WafregionalSqlInjectionMatchSetList contains a list of WafregionalSqlInjectionMatchSets
...
var (
	WafregionalSqlInjectionMatchSetKind             = "WafregionalSqlInjectionMatchSet"
	WafregionalSqlInjectionMatchSetGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: WafregionalSqlInjectionMatchSetKind}.String()
	WafregionalSqlInjectionMatchSetKindAPIVersion   = WafregionalSqlInjectionMatchSetKind + "." + v1alpha1.GroupVersion.String()
	WafregionalSqlInjectionMatchSetGroupVersionKind = v1alpha1.GroupVersion.WithKind(WafregionalSqlInjectionMatchSetKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &WafregionalSqlInjectionMatchSet{}, &WafregionalSqlInjectionMatchSetList{})
}
