...
var (
	...
	SignerSigningProfilePermissionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SignerSigningProfilePermissionKind}.String()
	SignerSigningProfilePermissionKindAPIVersion   = SignerSigningProfilePermissionKind + "." + v1alpha1.GroupVersion.String()
	SignerSigningProfilePermissionGroupVersionKind = v1alpha1.GroupVersion.WithKind(SignerSigningProfilePermissionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SignerSigningProfilePermission{}, &SignerSigningProfilePermissionList{})
}
