...
// GetTerraformResourceIDField returns Terraform identifier field for this SigningProfilePermission
func (tr *SigningProfilePermission) GetTerraformResourceIDField() string {
	return "id"
}
