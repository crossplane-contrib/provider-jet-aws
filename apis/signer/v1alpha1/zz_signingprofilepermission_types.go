...
var (
	SigningProfilePermissionKind             = "SigningProfilePermission"
	SigningProfilePermissionGroupKind        = schema.GroupKind{Group: Group, Kind: SigningProfilePermissionKind}.String()
	SigningProfilePermissionKindAPIVersion   = SigningProfilePermissionKind + "." + GroupVersion.String()
	SigningProfilePermissionGroupVersionKind = GroupVersion.WithKind(SigningProfilePermissionKind)
)
