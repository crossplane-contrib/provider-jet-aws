...
var (
	...
	DatapipelinePipelineGroupKind        = schema.GroupKind{Group: Group, Kind: DatapipelinePipelineKind}.String()
	DatapipelinePipelineKindAPIVersion   = DatapipelinePipelineKind + "." + GroupVersion.String()
	DatapipelinePipelineGroupVersionKind = GroupVersion.WithKind(DatapipelinePipelineKind)
)

func init() {
	SchemeBuilder.Register(&DatapipelinePipeline{}, &DatapipelinePipelineList{})
}
