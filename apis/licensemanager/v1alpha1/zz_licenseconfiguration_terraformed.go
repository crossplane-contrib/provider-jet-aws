...
// GetTerraformResourceIDField returns Terraform identifier field for this LicenseConfiguration
func (tr *LicenseConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
