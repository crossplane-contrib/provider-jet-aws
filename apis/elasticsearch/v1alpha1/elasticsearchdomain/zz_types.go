...
var (
	...
	ElasticsearchDomainGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ElasticsearchDomainKind}.String()
	ElasticsearchDomainKindAPIVersion   = ElasticsearchDomainKind + "." + v1alpha1.GroupVersion.String()
	ElasticsearchDomainGroupVersionKind = v1alpha1.GroupVersion.WithKind(ElasticsearchDomainKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ElasticsearchDomain{}, &ElasticsearchDomainList{})
}
