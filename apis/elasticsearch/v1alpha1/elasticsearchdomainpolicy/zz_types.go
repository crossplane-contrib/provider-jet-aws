...
var (
	...
	ElasticsearchDomainPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ElasticsearchDomainPolicyKind}.String()
	ElasticsearchDomainPolicyKindAPIVersion   = ElasticsearchDomainPolicyKind + "." + v1alpha1.GroupVersion.String()
	ElasticsearchDomainPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(ElasticsearchDomainPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ElasticsearchDomainPolicy{}, &ElasticsearchDomainPolicyList{})
}
