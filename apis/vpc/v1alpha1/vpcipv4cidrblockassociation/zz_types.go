...
var (
	...
	VpcIpv4CidrBlockAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcIpv4CidrBlockAssociationKind}.String()
	VpcIpv4CidrBlockAssociationKindAPIVersion   = VpcIpv4CidrBlockAssociationKind + "." + v1alpha1.GroupVersion.String()
	VpcIpv4CidrBlockAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcIpv4CidrBlockAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpcIpv4CidrBlockAssociation{}, &VpcIpv4CidrBlockAssociationList{})
}
