...
// GetTerraformResourceIDField returns Terraform identifier field for this VpcEndpointSubnetAssociation
func (tr *VpcEndpointSubnetAssociation) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this VpcEndpointSubnetAssociation
func (tr *VpcEndpointSubnetAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *VpcEndpointSubnetAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this VpcEndpointSubnetAssociation
func (tr *VpcEndpointSubnetAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
