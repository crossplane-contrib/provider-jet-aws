...
var (
	...
	VpcPeeringConnectionOptionsGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcPeeringConnectionOptionsKind}.String()
	VpcPeeringConnectionOptionsKindAPIVersion   = VpcPeeringConnectionOptionsKind + "." + v1alpha1.GroupVersion.String()
	VpcPeeringConnectionOptionsGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcPeeringConnectionOptionsKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpcPeeringConnectionOptions{}, &VpcPeeringConnectionOptionsList{})
}
