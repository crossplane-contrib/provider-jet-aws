...
var (
	...
	VpcEndpointGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcEndpointKind}.String()
	VpcEndpointKindAPIVersion   = VpcEndpointKind + "." + v1alpha1.GroupVersion.String()
	VpcEndpointGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcEndpointKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpcEndpoint{}, &VpcEndpointList{})
}
