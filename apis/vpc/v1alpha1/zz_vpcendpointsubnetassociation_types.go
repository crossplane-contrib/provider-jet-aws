...
var (
	...
	VpcEndpointSubnetAssociationGroupKind        = schema.GroupKind{Group: Group, Kind: VpcEndpointSubnetAssociationKind}.String()
	VpcEndpointSubnetAssociationKindAPIVersion   = VpcEndpointSubnetAssociationKind + "." + GroupVersion.String()
	VpcEndpointSubnetAssociationGroupVersionKind = GroupVersion.WithKind(VpcEndpointSubnetAssociationKind)
)
