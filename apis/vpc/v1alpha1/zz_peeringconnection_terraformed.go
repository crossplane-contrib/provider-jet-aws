...
// GetTerraformResourceIDField returns Terraform identifier field for this PeeringConnection
func (tr *PeeringConnection) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *PeeringConnection) GetObservation() (map[string]interface{}, error) {
...
func (tr *PeeringConnection) SetObservation(obs map[string]interface{}) error {
...
func (tr *PeeringConnection) GetParameters() (map[string]interface{}, error) {
...
func (tr *PeeringConnection) SetParameters(params map[string]interface{}) error {
