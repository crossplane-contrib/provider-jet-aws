...
func (tr *VpcEndpointServiceAllowedPrincipal) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *VpcEndpointServiceAllowedPrincipal) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this VpcEndpointServiceAllowedPrincipal
func (tr *VpcEndpointServiceAllowedPrincipal) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
