...
func (tr *VpcIpv4CidrBlockAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *VpcIpv4CidrBlockAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this VpcIpv4CidrBlockAssociation
func (tr *VpcIpv4CidrBlockAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
