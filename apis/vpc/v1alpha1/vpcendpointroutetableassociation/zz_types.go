...
var (
	...
	VpcEndpointRouteTableAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcEndpointRouteTableAssociationKind}.String()
	VpcEndpointRouteTableAssociationKindAPIVersion   = VpcEndpointRouteTableAssociationKind + "." + v1alpha1.GroupVersion.String()
	VpcEndpointRouteTableAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcEndpointRouteTableAssociationKind)
)
