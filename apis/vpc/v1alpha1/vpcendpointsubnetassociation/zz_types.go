...
var (
	VpcEndpointSubnetAssociationKind             = "VpcEndpointSubnetAssociation"
	VpcEndpointSubnetAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcEndpointSubnetAssociationKind}.String()
	VpcEndpointSubnetAssociationKindAPIVersion   = VpcEndpointSubnetAssociationKind + "." + v1alpha1.GroupVersion.String()
	VpcEndpointSubnetAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcEndpointSubnetAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpcEndpointSubnetAssociation{}, &VpcEndpointSubnetAssociationList{})
}
