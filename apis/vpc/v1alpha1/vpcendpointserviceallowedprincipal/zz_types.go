...
var (
	...
	VpcEndpointServiceAllowedPrincipalGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: VpcEndpointServiceAllowedPrincipalKind}.String()
	VpcEndpointServiceAllowedPrincipalKindAPIVersion   = VpcEndpointServiceAllowedPrincipalKind + "." + v1alpha1.GroupVersion.String()
	VpcEndpointServiceAllowedPrincipalGroupVersionKind = v1alpha1.GroupVersion.WithKind(VpcEndpointServiceAllowedPrincipalKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &VpcEndpointServiceAllowedPrincipal{}, &VpcEndpointServiceAllowedPrincipalList{})
}
