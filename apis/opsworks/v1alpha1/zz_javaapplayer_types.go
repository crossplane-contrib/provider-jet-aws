...
var (
	JavaAppLayerKind             = "JavaAppLayer"
	JavaAppLayerGroupKind        = schema.GroupKind{Group: Group, Kind: JavaAppLayerKind}.String()
	JavaAppLayerKindAPIVersion   = JavaAppLayerKind + "." + GroupVersion.String()
	JavaAppLayerGroupVersionKind = GroupVersion.WithKind(JavaAppLayerKind)
)
