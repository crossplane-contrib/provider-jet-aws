...
var (
	StaticWebLayerKind             = "StaticWebLayer"
	StaticWebLayerGroupKind        = schema.GroupKind{Group: Group, Kind: StaticWebLayerKind}.String()
	StaticWebLayerKindAPIVersion   = StaticWebLayerKind + "." + GroupVersion.String()
	StaticWebLayerGroupVersionKind = GroupVersion.WithKind(StaticWebLayerKind)
)
