...
type OpsworksNodejsAppLayerEbsVolumeObservation struct {
}

type OpsworksNodejsAppLayerEbsVolumeParameters struct {
...
type OpsworksNodejsAppLayerParameters struct {
	...
	EbsVolume []OpsworksNodejsAppLayerEbsVolumeParameters `json:"ebsVolume,omitempty" tf:"ebs_volume"`
...
var (
	...
	OpsworksNodejsAppLayerGroupKind        = schema.GroupKind{Group: Group, Kind: OpsworksNodejsAppLayerKind}.String()
	OpsworksNodejsAppLayerKindAPIVersion   = OpsworksNodejsAppLayerKind + "." + GroupVersion.String()
	OpsworksNodejsAppLayerGroupVersionKind = GroupVersion.WithKind(OpsworksNodejsAppLayerKind)
)

func init() {
	SchemeBuilder.Register(&OpsworksNodejsAppLayer{}, &OpsworksNodejsAppLayerList{})
}
