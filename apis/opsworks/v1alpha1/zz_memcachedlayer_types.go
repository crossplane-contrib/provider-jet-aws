...
var (
	MemcachedLayerKind             = "MemcachedLayer"
	MemcachedLayerGroupKind        = schema.GroupKind{Group: Group, Kind: MemcachedLayerKind}.String()
	MemcachedLayerKindAPIVersion   = MemcachedLayerKind + "." + GroupVersion.String()
	MemcachedLayerGroupVersionKind = GroupVersion.WithKind(MemcachedLayerKind)
)
