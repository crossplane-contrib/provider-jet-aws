...
var (
	...
	OpsworksRdsDbInstanceGroupKind        = schema.GroupKind{Group: Group, Kind: OpsworksRdsDbInstanceKind}.String()
	OpsworksRdsDbInstanceKindAPIVersion   = OpsworksRdsDbInstanceKind + "." + GroupVersion.String()
	OpsworksRdsDbInstanceGroupVersionKind = GroupVersion.WithKind(OpsworksRdsDbInstanceKind)
)

func init() {
	SchemeBuilder.Register(&OpsworksRdsDbInstance{}, &OpsworksRdsDbInstanceList{})
}
