...
var (
	CustomLayerKind             = "CustomLayer"
	CustomLayerGroupKind        = schema.GroupKind{Group: Group, Kind: CustomLayerKind}.String()
	CustomLayerKindAPIVersion   = CustomLayerKind + "." + GroupVersion.String()
	CustomLayerGroupVersionKind = GroupVersion.WithKind(CustomLayerKind)
)
