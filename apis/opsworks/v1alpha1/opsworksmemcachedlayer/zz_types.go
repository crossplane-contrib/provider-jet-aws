...
var (
	...
	OpsworksMemcachedLayerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: OpsworksMemcachedLayerKind}.String()
	OpsworksMemcachedLayerKindAPIVersion   = OpsworksMemcachedLayerKind + "." + v1alpha1.GroupVersion.String()
	OpsworksMemcachedLayerGroupVersionKind = v1alpha1.GroupVersion.WithKind(OpsworksMemcachedLayerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &OpsworksMemcachedLayer{}, &OpsworksMemcachedLayerList{})
}
