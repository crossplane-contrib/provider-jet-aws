...
var (
	NodejsAppLayerKind             = "NodejsAppLayer"
	NodejsAppLayerGroupKind        = schema.GroupKind{Group: Group, Kind: NodejsAppLayerKind}.String()
	NodejsAppLayerKindAPIVersion   = NodejsAppLayerKind + "." + GroupVersion.String()
	NodejsAppLayerGroupVersionKind = GroupVersion.WithKind(NodejsAppLayerKind)
)
