...
var (
	...
	OpsworksHaproxyLayerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: OpsworksHaproxyLayerKind}.String()
	OpsworksHaproxyLayerKindAPIVersion   = OpsworksHaproxyLayerKind + "." + v1alpha1.GroupVersion.String()
	OpsworksHaproxyLayerGroupVersionKind = v1alpha1.GroupVersion.WithKind(OpsworksHaproxyLayerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &OpsworksHaproxyLayer{}, &OpsworksHaproxyLayerList{})
}
