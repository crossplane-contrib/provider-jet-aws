...
var (
	MysqlLayerKind             = "MysqlLayer"
	MysqlLayerGroupKind        = schema.GroupKind{Group: Group, Kind: MysqlLayerKind}.String()
	MysqlLayerKindAPIVersion   = MysqlLayerKind + "." + GroupVersion.String()
	MysqlLayerGroupVersionKind = GroupVersion.WithKind(MysqlLayerKind)
)
