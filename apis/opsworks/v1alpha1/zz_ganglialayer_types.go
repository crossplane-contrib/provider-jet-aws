...
// GangliaLayer is the Schema for the GangliaLayers API
...
var (
	GangliaLayerKind             = "GangliaLayer"
	GangliaLayerGroupKind        = schema.GroupKind{Group: Group, Kind: GangliaLayerKind}.String()
	GangliaLayerKindAPIVersion   = GangliaLayerKind + "." + GroupVersion.String()
	GangliaLayerGroupVersionKind = GroupVersion.WithKind(GangliaLayerKind)
)
