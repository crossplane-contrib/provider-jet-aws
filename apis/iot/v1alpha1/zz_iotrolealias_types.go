...
var (
	...
	IotRoleAliasGroupKind        = schema.GroupKind{Group: Group, Kind: IotRoleAliasKind}.String()
	IotRoleAliasKindAPIVersion   = IotRoleAliasKind + "." + GroupVersion.String()
	IotRoleAliasGroupVersionKind = GroupVersion.WithKind(IotRoleAliasKind)
)

func init() {
	SchemeBuilder.Register(&IotRoleAlias{}, &IotRoleAliasList{})
}
