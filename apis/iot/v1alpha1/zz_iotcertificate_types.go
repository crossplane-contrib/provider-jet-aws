...
var (
	...
	IotCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: IotCertificateKind}.String()
	IotCertificateKindAPIVersion   = IotCertificateKind + "." + GroupVersion.String()
	IotCertificateGroupVersionKind = GroupVersion.WithKind(IotCertificateKind)
)

func init() {
	SchemeBuilder.Register(&IotCertificate{}, &IotCertificateList{})
}
