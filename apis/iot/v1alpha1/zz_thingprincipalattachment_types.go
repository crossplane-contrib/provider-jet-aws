...
// ThingPrincipalAttachment is the Schema for the ThingPrincipalAttachments API
...
var (
	ThingPrincipalAttachmentKind             = "ThingPrincipalAttachment"
	ThingPrincipalAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: ThingPrincipalAttachmentKind}.String()
	ThingPrincipalAttachmentKindAPIVersion   = ThingPrincipalAttachmentKind + "." + GroupVersion.String()
	ThingPrincipalAttachmentGroupVersionKind = GroupVersion.WithKind(ThingPrincipalAttachmentKind)
)
