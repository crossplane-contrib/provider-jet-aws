...
var (
	...
	IotPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: IotPolicyKind}.String()
	IotPolicyKindAPIVersion   = IotPolicyKind + "." + GroupVersion.String()
	IotPolicyGroupVersionKind = GroupVersion.WithKind(IotPolicyKind)
)

func init() {
	SchemeBuilder.Register(&IotPolicy{}, &IotPolicyList{})
}
