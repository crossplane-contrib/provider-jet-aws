...
var (
	QueuePolicyKind             = "QueuePolicy"
	QueuePolicyGroupKind        = schema.GroupKind{Group: Group, Kind: QueuePolicyKind}.String()
	QueuePolicyKindAPIVersion   = QueuePolicyKind + "." + GroupVersion.String()
	QueuePolicyGroupVersionKind = GroupVersion.WithKind(QueuePolicyKind)
)
