...
var (
	...
	DbProxyTargetGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: DbProxyTargetKind}.String()
	DbProxyTargetKindAPIVersion   = DbProxyTargetKind + "." + v1alpha1.GroupVersion.String()
	DbProxyTargetGroupVersionKind = v1alpha1.GroupVersion.WithKind(DbProxyTargetKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &DbProxyTarget{}, &DbProxyTargetList{})
}
