...
var (
	...
	EfsAccessPointGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EfsAccessPointKind}.String()
	EfsAccessPointKindAPIVersion   = EfsAccessPointKind + "." + v1alpha1.GroupVersion.String()
	EfsAccessPointGroupVersionKind = v1alpha1.GroupVersion.WithKind(EfsAccessPointKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EfsAccessPoint{}, &EfsAccessPointList{})
}
