...
var (
	...
	EfsBackupPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EfsBackupPolicyKind}.String()
	EfsBackupPolicyKindAPIVersion   = EfsBackupPolicyKind + "." + v1alpha1.GroupVersion.String()
	EfsBackupPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(EfsBackupPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EfsBackupPolicy{}, &EfsBackupPolicyList{})
}
