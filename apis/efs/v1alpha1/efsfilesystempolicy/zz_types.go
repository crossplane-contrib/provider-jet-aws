...
var (
	...
	EfsFileSystemPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EfsFileSystemPolicyKind}.String()
	EfsFileSystemPolicyKindAPIVersion   = EfsFileSystemPolicyKind + "." + v1alpha1.GroupVersion.String()
	EfsFileSystemPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(EfsFileSystemPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EfsFileSystemPolicy{}, &EfsFileSystemPolicyList{})
}
