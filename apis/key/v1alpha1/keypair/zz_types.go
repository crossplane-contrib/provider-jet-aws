...
// +groupName=key.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/key/v1alpha1"
)
...
var (
	KeyPairKind             = "KeyPair"
	KeyPairGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: KeyPairKind}.String()
	KeyPairKindAPIVersion   = KeyPairKind + "." + v1alpha1.GroupVersion.String()
	KeyPairGroupVersionKind = v1alpha1.GroupVersion.WithKind(KeyPairKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &KeyPair{}, &KeyPairList{})
}
