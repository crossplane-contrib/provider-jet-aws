...
var (
	PairKind             = "Pair"
	PairGroupKind        = schema.GroupKind{Group: Group, Kind: PairKind}.String()
	PairKindAPIVersion   = PairKind + "." + GroupVersion.String()
	PairGroupVersionKind = GroupVersion.WithKind(PairKind)
)
