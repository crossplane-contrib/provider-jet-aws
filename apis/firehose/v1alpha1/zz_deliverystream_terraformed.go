...
func (tr *DeliveryStream) GetObservation() (map[string]interface{}, error) {
...
func (tr *DeliveryStream) SetObservation(obs map[string]interface{}) error {
...
func (tr *DeliveryStream) GetParameters() (map[string]interface{}, error) {
...
func (tr *DeliveryStream) SetParameters(params map[string]interface{}) error {
