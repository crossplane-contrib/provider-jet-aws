...
var (
	SnapshotImportKind             = "SnapshotImport"
	SnapshotImportGroupKind        = schema.GroupKind{Group: Group, Kind: SnapshotImportKind}.String()
	SnapshotImportKindAPIVersion   = SnapshotImportKind + "." + GroupVersion.String()
	SnapshotImportGroupVersionKind = GroupVersion.WithKind(SnapshotImportKind)
)
