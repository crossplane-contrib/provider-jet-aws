...
var (
	...
	EbsSnapshotGroupKind        = schema.GroupKind{Group: Group, Kind: EbsSnapshotKind}.String()
	EbsSnapshotKindAPIVersion   = EbsSnapshotKind + "." + GroupVersion.String()
	EbsSnapshotGroupVersionKind = GroupVersion.WithKind(EbsSnapshotKind)
)
