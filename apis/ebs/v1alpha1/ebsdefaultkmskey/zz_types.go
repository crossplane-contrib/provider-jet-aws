...
var (
	...
	EbsDefaultKmsKeyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: EbsDefaultKmsKeyKind}.String()
	EbsDefaultKmsKeyKindAPIVersion   = EbsDefaultKmsKeyKind + "." + v1alpha1.GroupVersion.String()
	EbsDefaultKmsKeyGroupVersionKind = v1alpha1.GroupVersion.WithKind(EbsDefaultKmsKeyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &EbsDefaultKmsKey{}, &EbsDefaultKmsKeyList{})
}
