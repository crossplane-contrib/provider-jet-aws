...
// GetTerraformResourceType returns Terraform resource type for this CodedeployApp
func (mg *CodedeployApp) GetTerraformResourceType() string {
	return "aws_codedeploy_app"
}

// GetTerraformResourceIdField returns Terraform identifier field for this CodedeployApp
