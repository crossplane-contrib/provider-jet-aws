...
var (
	...
	CodedeployAppGroupKind        = schema.GroupKind{Group: Group, Kind: CodedeployAppKind}.String()
	CodedeployAppKindAPIVersion   = CodedeployAppKind + "." + GroupVersion.String()
	CodedeployAppGroupVersionKind = GroupVersion.WithKind(CodedeployAppKind)
)

func init() {
	SchemeBuilder.Register(&CodedeployApp{}, &CodedeployAppList{})
}
