...
var (
	...
	CodedeployDeploymentConfigGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CodedeployDeploymentConfigKind}.String()
	CodedeployDeploymentConfigKindAPIVersion   = CodedeployDeploymentConfigKind + "." + v1alpha1.GroupVersion.String()
	CodedeployDeploymentConfigGroupVersionKind = v1alpha1.GroupVersion.WithKind(CodedeployDeploymentConfigKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CodedeployDeploymentConfig{}, &CodedeployDeploymentConfigList{})
}
