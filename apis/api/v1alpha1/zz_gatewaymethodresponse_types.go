...
var (
	GatewayMethodResponse_Kind             = "GatewayMethodResponse"
	GatewayMethodResponse_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayMethodResponse_Kind}.String()
	GatewayMethodResponse_KindAPIVersion   = GatewayMethodResponse_Kind + "." + CRDGroupVersion.String()
	GatewayMethodResponse_GroupVersionKind = CRDGroupVersion.WithKind(GatewayMethodResponse_Kind)
)
