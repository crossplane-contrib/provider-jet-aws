...
var (
	...
	ApiGatewayUsagePlanKeyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayUsagePlanKeyKind}.String()
	ApiGatewayUsagePlanKeyKindAPIVersion   = ApiGatewayUsagePlanKeyKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayUsagePlanKeyGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayUsagePlanKeyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayUsagePlanKey{}, &ApiGatewayUsagePlanKeyList{})
}
