...
var (
	GatewayMethodSettings_Kind             = "GatewayMethodSettings"
	GatewayMethodSettings_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayMethodSettings_Kind}.String()
	GatewayMethodSettings_KindAPIVersion   = GatewayMethodSettings_Kind + "." + CRDGroupVersion.String()
	GatewayMethodSettings_GroupVersionKind = CRDGroupVersion.WithKind(GatewayMethodSettings_Kind)
)
