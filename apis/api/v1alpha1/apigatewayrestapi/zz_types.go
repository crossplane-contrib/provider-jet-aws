...
var (
	...
	ApiGatewayRestApiGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayRestApiKind}.String()
	ApiGatewayRestApiKindAPIVersion   = ApiGatewayRestApiKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayRestApiGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayRestApiKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayRestApi{}, &ApiGatewayRestApiList{})
}
