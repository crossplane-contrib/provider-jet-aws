...
var (
	...
	ApiGatewayAccountGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayAccountKind}.String()
	ApiGatewayAccountKindAPIVersion   = ApiGatewayAccountKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayAccountGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayAccountKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayAccount{}, &ApiGatewayAccountList{})
}
