...
var (
	...
	ApiGatewayResourceGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayResourceKind}.String()
	ApiGatewayResourceKindAPIVersion   = ApiGatewayResourceKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayResourceGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayResourceKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayResource{}, &ApiGatewayResourceList{})
}
