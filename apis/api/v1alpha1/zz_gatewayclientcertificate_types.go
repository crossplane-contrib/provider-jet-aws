...
var (
	GatewayClientCertificate_Kind             = "GatewayClientCertificate"
	GatewayClientCertificate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayClientCertificate_Kind}.String()
	GatewayClientCertificate_KindAPIVersion   = GatewayClientCertificate_Kind + "." + CRDGroupVersion.String()
	GatewayClientCertificate_GroupVersionKind = CRDGroupVersion.WithKind(GatewayClientCertificate_Kind)
)
