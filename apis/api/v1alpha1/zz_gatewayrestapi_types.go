...
var (
	GatewayRestApi_Kind             = "GatewayRestApi"
	GatewayRestApi_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayRestApi_Kind}.String()
	GatewayRestApi_KindAPIVersion   = GatewayRestApi_Kind + "." + CRDGroupVersion.String()
	GatewayRestApi_GroupVersionKind = CRDGroupVersion.WithKind(GatewayRestApi_Kind)
)
