...
var (
	GatewayIntegration_Kind             = "GatewayIntegration"
	GatewayIntegration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayIntegration_Kind}.String()
	GatewayIntegration_KindAPIVersion   = GatewayIntegration_Kind + "." + CRDGroupVersion.String()
	GatewayIntegration_GroupVersionKind = CRDGroupVersion.WithKind(GatewayIntegration_Kind)
)
