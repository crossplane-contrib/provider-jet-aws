...
var (
	...
	ApiGatewayRestApiPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: ApiGatewayRestApiPolicyKind}.String()
	ApiGatewayRestApiPolicyKindAPIVersion   = ApiGatewayRestApiPolicyKind + "." + GroupVersion.String()
	ApiGatewayRestApiPolicyGroupVersionKind = GroupVersion.WithKind(ApiGatewayRestApiPolicyKind)
)

func init() {
	SchemeBuilder.Register(&ApiGatewayRestApiPolicy{}, &ApiGatewayRestApiPolicyList{})
}
