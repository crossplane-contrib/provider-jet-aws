...
var (
	GatewayUsagePlanKey_Kind             = "GatewayUsagePlanKey"
	GatewayUsagePlanKey_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayUsagePlanKey_Kind}.String()
	GatewayUsagePlanKey_KindAPIVersion   = GatewayUsagePlanKey_Kind + "." + CRDGroupVersion.String()
	GatewayUsagePlanKey_GroupVersionKind = CRDGroupVersion.WithKind(GatewayUsagePlanKey_Kind)
)
