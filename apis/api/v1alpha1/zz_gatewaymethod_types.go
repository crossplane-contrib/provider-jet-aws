...
var (
	GatewayMethod_Kind             = "GatewayMethod"
	GatewayMethod_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayMethod_Kind}.String()
	GatewayMethod_KindAPIVersion   = GatewayMethod_Kind + "." + CRDGroupVersion.String()
	GatewayMethod_GroupVersionKind = CRDGroupVersion.WithKind(GatewayMethod_Kind)
)
