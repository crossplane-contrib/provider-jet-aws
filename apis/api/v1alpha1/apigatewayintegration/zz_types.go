...
var (
	...
	ApiGatewayIntegrationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayIntegrationKind}.String()
	ApiGatewayIntegrationKindAPIVersion   = ApiGatewayIntegrationKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayIntegrationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayIntegrationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayIntegration{}, &ApiGatewayIntegrationList{})
}
