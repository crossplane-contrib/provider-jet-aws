...
var (
	GatewayApiKey_Kind             = "GatewayApiKey"
	GatewayApiKey_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GatewayApiKey_Kind}.String()
	GatewayApiKey_KindAPIVersion   = GatewayApiKey_Kind + "." + CRDGroupVersion.String()
	GatewayApiKey_GroupVersionKind = CRDGroupVersion.WithKind(GatewayApiKey_Kind)
)
