...
var (
	...
	ApiGatewayGatewayResponseGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ApiGatewayGatewayResponseKind}.String()
	ApiGatewayGatewayResponseKindAPIVersion   = ApiGatewayGatewayResponseKind + "." + v1alpha1.GroupVersion.String()
	ApiGatewayGatewayResponseGroupVersionKind = v1alpha1.GroupVersion.WithKind(ApiGatewayGatewayResponseKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ApiGatewayGatewayResponse{}, &ApiGatewayGatewayResponseList{})
}
