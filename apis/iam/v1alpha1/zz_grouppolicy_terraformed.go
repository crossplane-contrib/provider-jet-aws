...
func (tr *GroupPolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *GroupPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *GroupPolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *GroupPolicy) SetParameters(params map[string]interface{}) error {
