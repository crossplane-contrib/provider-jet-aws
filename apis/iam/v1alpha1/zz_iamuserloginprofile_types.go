...
var (
	...
	IamUserLoginProfileGroupKind        = schema.GroupKind{Group: Group, Kind: IamUserLoginProfileKind}.String()
	IamUserLoginProfileKindAPIVersion   = IamUserLoginProfileKind + "." + GroupVersion.String()
	IamUserLoginProfileGroupVersionKind = GroupVersion.WithKind(IamUserLoginProfileKind)
)

func init() {
	SchemeBuilder.Register(&IamUserLoginProfile{}, &IamUserLoginProfileList{})
}
