...
var (
	...
	IamRolePolicyAttachmentKindAPIVersion   = IamRolePolicyAttachmentKind + "." + GroupVersion.String()
	IamRolePolicyAttachmentGroupVersionKind = GroupVersion.WithKind(IamRolePolicyAttachmentKind)
)
