...
var (
	IamRoleKind             = "IamRole"
	IamRoleGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamRoleKind}.String()
	IamRoleKindAPIVersion   = IamRoleKind + "." + v1alpha1.GroupVersion.String()
	IamRoleGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamRoleKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamRole{}, &IamRoleList{})
}
