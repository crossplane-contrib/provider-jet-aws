...
var (
	UserSshKeyKind             = "UserSshKey"
	UserSshKeyGroupKind        = schema.GroupKind{Group: Group, Kind: UserSshKeyKind}.String()
	UserSshKeyKindAPIVersion   = UserSshKeyKind + "." + GroupVersion.String()
	UserSshKeyGroupVersionKind = GroupVersion.WithKind(UserSshKeyKind)
)
