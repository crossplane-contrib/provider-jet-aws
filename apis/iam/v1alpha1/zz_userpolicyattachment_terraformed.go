...
// GetTerraformResourceIDField returns Terraform identifier field for this UserPolicyAttachment
func (tr *UserPolicyAttachment) GetTerraformResourceIDField() string {
	return "id"
}
