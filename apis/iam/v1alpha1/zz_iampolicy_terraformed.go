...
// GetTerraformResourceIDField returns Terraform identifier field for this IamPolicy
func (tr *IamPolicy) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this IamPolicy
func (tr *IamPolicy) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *IamPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *IamPolicy) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *IamPolicy) SetParameters(params map[string]interface{}) error {
...
// GetConnectionDetails of this IamPolicy
func (tr *IamPolicy) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
