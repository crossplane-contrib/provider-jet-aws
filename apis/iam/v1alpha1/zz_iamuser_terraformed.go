...
func (tr *IamUser) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *IamUser) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// LateInitialize this IamUser using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IamUser) LateInitialize(attrs []byte) (bool, error) {
	params := &IamUserParameters{}
...
// GetConnectionDetails of this IamUser
func (tr *IamUser) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
