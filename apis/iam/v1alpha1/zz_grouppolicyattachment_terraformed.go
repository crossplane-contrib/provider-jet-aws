...
// GetTerraformResourceIDField returns Terraform identifier field for this GroupPolicyAttachment
func (tr *GroupPolicyAttachment) GetTerraformResourceIDField() string {
	return "id"
}
