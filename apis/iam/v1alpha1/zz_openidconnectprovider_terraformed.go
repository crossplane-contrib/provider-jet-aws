...
// GetTerraformResourceIDField returns Terraform identifier field for this OpenidConnectProvider
func (tr *OpenidConnectProvider) GetTerraformResourceIDField() string {
	return "id"
}
