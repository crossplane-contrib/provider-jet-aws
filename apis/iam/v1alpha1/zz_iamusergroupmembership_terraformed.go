...
func (tr *IamUserGroupMembership) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *IamUserGroupMembership) SetObservation(obs map[string]interface{}) error {
...
func (tr *IamUserGroupMembership) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// LateInitialize this IamUserGroupMembership using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *IamUserGroupMembership) LateInitialize(attrs []byte) (bool, error) {
	params := &IamUserGroupMembershipParameters{}
...
// GetConnectionDetails of this IamUserGroupMembership
func (tr *IamUserGroupMembership) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
