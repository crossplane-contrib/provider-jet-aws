...
// IamOpenidConnectProvider is the Schema for the IamOpenidConnectProviders API
...
// IamOpenidConnectProviderList contains a list of IamOpenidConnectProviders
...
var (
	IamOpenidConnectProviderKind             = "IamOpenidConnectProvider"
	IamOpenidConnectProviderGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamOpenidConnectProviderKind}.String()
	IamOpenidConnectProviderKindAPIVersion   = IamOpenidConnectProviderKind + "." + v1alpha1.GroupVersion.String()
	IamOpenidConnectProviderGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamOpenidConnectProviderKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamOpenidConnectProvider{}, &IamOpenidConnectProviderList{})
}
