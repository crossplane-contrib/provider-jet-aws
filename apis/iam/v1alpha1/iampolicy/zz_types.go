...
var (
	...
	IamPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamPolicyKind}.String()
	IamPolicyKindAPIVersion   = IamPolicyKind + "." + v1alpha1.GroupVersion.String()
	IamPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamPolicy{}, &IamPolicyList{})
}
