...
var (
	...
	IamServerCertificateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamServerCertificateKind}.String()
	IamServerCertificateKindAPIVersion   = IamServerCertificateKind + "." + v1alpha1.GroupVersion.String()
	IamServerCertificateGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamServerCertificateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamServerCertificate{}, &IamServerCertificateList{})
}
