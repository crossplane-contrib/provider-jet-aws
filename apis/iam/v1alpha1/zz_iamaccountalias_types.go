...
var (
	...
	IamAccountAliasGroupKind        = schema.GroupKind{Group: Group, Kind: IamAccountAliasKind}.String()
	IamAccountAliasKindAPIVersion   = IamAccountAliasKind + "." + GroupVersion.String()
	IamAccountAliasGroupVersionKind = GroupVersion.WithKind(IamAccountAliasKind)
)

func init() {
	SchemeBuilder.Register(&IamAccountAlias{}, &IamAccountAliasList{})
}
