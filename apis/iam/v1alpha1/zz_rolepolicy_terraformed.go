...
// GetTerraformResourceIDField returns Terraform identifier field for this RolePolicy
func (tr *RolePolicy) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *RolePolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *RolePolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *RolePolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *RolePolicy) SetParameters(params map[string]interface{}) error {
