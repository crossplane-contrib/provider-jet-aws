...
var (
	IamUserKind             = "IamUser"
	IamUserGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamUserKind}.String()
	IamUserKindAPIVersion   = IamUserKind + "." + v1alpha1.GroupVersion.String()
	IamUserGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamUserKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamUser{}, &IamUserList{})
}
