...
// GetTerraformResourceIDField returns Terraform identifier field for this AccountPasswordPolicy
func (tr *AccountPasswordPolicy) GetTerraformResourceIDField() string {
	return "id"
}
