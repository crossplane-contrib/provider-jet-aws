...
var (
	...
	IamRolePolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: IamRolePolicyKind}.String()
	IamRolePolicyKindAPIVersion   = IamRolePolicyKind + "." + v1alpha1.GroupVersion.String()
	IamRolePolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(IamRolePolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &IamRolePolicy{}, &IamRolePolicyList{})
}
