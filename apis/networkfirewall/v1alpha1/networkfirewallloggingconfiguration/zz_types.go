...
var (
	...
	NetworkfirewallLoggingConfigurationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: NetworkfirewallLoggingConfigurationKind}.String()
	NetworkfirewallLoggingConfigurationKindAPIVersion   = NetworkfirewallLoggingConfigurationKind + "." + v1alpha1.GroupVersion.String()
	NetworkfirewallLoggingConfigurationGroupVersionKind = v1alpha1.GroupVersion.WithKind(NetworkfirewallLoggingConfigurationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &NetworkfirewallLoggingConfiguration{}, &NetworkfirewallLoggingConfigurationList{})
}
