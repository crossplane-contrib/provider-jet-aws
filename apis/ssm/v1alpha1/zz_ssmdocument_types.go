...
var (
	...
	SsmDocumentGroupKind        = schema.GroupKind{Group: Group, Kind: SsmDocumentKind}.String()
	SsmDocumentKindAPIVersion   = SsmDocumentKind + "." + GroupVersion.String()
	SsmDocumentGroupVersionKind = GroupVersion.WithKind(SsmDocumentKind)
)
