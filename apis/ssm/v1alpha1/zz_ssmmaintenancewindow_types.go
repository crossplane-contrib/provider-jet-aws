...
var (
	...
	SsmMaintenanceWindowGroupKind        = schema.GroupKind{Group: Group, Kind: SsmMaintenanceWindowKind}.String()
	SsmMaintenanceWindowKindAPIVersion   = SsmMaintenanceWindowKind + "." + GroupVersion.String()
	SsmMaintenanceWindowGroupVersionKind = GroupVersion.WithKind(SsmMaintenanceWindowKind)
)
