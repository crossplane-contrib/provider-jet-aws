...
var (
	...
	SsmResourceDataSyncGroupKind        = schema.GroupKind{Group: Group, Kind: SsmResourceDataSyncKind}.String()
	SsmResourceDataSyncKindAPIVersion   = SsmResourceDataSyncKind + "." + GroupVersion.String()
	SsmResourceDataSyncGroupVersionKind = GroupVersion.WithKind(SsmResourceDataSyncKind)
)
