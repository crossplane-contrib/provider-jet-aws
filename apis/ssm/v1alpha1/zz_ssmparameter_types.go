...
var (
	...
	SsmParameterGroupKind        = schema.GroupKind{Group: Group, Kind: SsmParameterKind}.String()
	SsmParameterKindAPIVersion   = SsmParameterKind + "." + GroupVersion.String()
	SsmParameterGroupVersionKind = GroupVersion.WithKind(SsmParameterKind)
)
