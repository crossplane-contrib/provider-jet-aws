...
var (
	...
	SsmActivationGroupKind        = schema.GroupKind{Group: Group, Kind: SsmActivationKind}.String()
	SsmActivationKindAPIVersion   = SsmActivationKind + "." + GroupVersion.String()
	SsmActivationGroupVersionKind = GroupVersion.WithKind(SsmActivationKind)
)

func init() {
	SchemeBuilder.Register(&SsmActivation{}, &SsmActivationList{})
}
