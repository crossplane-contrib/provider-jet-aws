...
// GetTerraformResourceIDField returns Terraform identifier field for this MaintenanceWindowTask
func (tr *MaintenanceWindowTask) GetTerraformResourceIDField() string {
	return "id"
}
