...
func (tr *Route53QueryLog) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Route53QueryLog) SetObservation(obs map[string]interface{}) error {
...
func (tr *Route53QueryLog) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Route53QueryLog) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Route53QueryLog using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Route53QueryLog) LateInitialize(attrs []byte) (bool, error) {
	params := &Route53QueryLogParameters{}
...
// GetConnectionDetails of this Route53QueryLog
func (tr *Route53QueryLog) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
