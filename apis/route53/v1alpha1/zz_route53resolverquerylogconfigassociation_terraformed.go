...
func (tr *Route53ResolverQueryLogConfigAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Route53ResolverQueryLogConfigAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this Route53ResolverQueryLogConfigAssociation
func (tr *Route53ResolverQueryLogConfigAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
