...
// GetID returns ID of underlying Terraform resource of this ResolverRule
func (tr *ResolverRule) GetID() string {
...
// LateInitialize this ResolverRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverRule) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverRuleParameters{}
