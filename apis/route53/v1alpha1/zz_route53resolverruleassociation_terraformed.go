...
func (tr *Route53ResolverRuleAssociation) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Route53ResolverRuleAssociation) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Route53ResolverRuleAssociation) SetParameters(params map[string]interface{}) error {
...
// GetConnectionDetails of this Route53ResolverRuleAssociation
func (tr *Route53ResolverRuleAssociation) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
