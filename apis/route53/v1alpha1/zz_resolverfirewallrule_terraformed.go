...
// GetID returns ID of underlying Terraform resource of this ResolverFirewallRule
func (tr *ResolverFirewallRule) GetID() string {
...
// LateInitialize this ResolverFirewallRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverFirewallRule) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverFirewallRuleParameters{}
