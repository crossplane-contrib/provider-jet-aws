...
var (
	...
	Route53ZoneAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Route53ZoneAssociationKind}.String()
	Route53ZoneAssociationKindAPIVersion   = Route53ZoneAssociationKind + "." + v1alpha1.GroupVersion.String()
	Route53ZoneAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(Route53ZoneAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Route53ZoneAssociation{}, &Route53ZoneAssociationList{})
}
