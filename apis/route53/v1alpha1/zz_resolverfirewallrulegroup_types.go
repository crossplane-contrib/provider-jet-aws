...
// ResolverFirewallRuleGroup is the Schema for the ResolverFirewallRuleGroups API
...
func init() {
	SchemeBuilder.Register(&ResolverFirewallRuleGroup{}, &ResolverFirewallRuleGroupList{})
}
