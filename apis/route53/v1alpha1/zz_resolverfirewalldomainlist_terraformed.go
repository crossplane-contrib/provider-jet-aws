...
// GetID returns ID of underlying Terraform resource of this ResolverFirewallDomainList
func (tr *ResolverFirewallDomainList) GetID() string {
...
// LateInitialize this ResolverFirewallDomainList using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverFirewallDomainList) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverFirewallDomainListParameters{}
