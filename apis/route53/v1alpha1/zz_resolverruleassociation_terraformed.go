...
// GetID returns ID of underlying Terraform resource of this ResolverRuleAssociation
func (tr *ResolverRuleAssociation) GetID() string {
...
// LateInitialize this ResolverRuleAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverRuleAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverRuleAssociationParameters{}
