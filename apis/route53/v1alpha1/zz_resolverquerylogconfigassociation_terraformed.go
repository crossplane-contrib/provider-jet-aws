...
// GetID returns ID of underlying Terraform resource of this ResolverQueryLogConfigAssociation
func (tr *ResolverQueryLogConfigAssociation) GetID() string {
...
// LateInitialize this ResolverQueryLogConfigAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverQueryLogConfigAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverQueryLogConfigAssociationParameters{}
