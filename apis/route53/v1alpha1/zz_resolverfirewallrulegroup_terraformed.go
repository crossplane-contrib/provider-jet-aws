...
// GetID returns ID of underlying Terraform resource of this ResolverFirewallRuleGroup
func (tr *ResolverFirewallRuleGroup) GetID() string {
...
// LateInitialize this ResolverFirewallRuleGroup using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverFirewallRuleGroup) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverFirewallRuleGroupParameters{}
