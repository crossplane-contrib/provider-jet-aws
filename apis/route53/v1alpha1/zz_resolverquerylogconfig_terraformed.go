...
// GetID returns ID of underlying Terraform resource of this ResolverQueryLogConfig
func (tr *ResolverQueryLogConfig) GetID() string {
...
// LateInitialize this ResolverQueryLogConfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverQueryLogConfig) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverQueryLogConfigParameters{}
