...
// GetID returns ID of underlying Terraform resource of this ResolverFirewallRuleGroupAssociation
func (tr *ResolverFirewallRuleGroupAssociation) GetID() string {
...
// LateInitialize this ResolverFirewallRuleGroupAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverFirewallRuleGroupAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverFirewallRuleGroupAssociationParameters{}
