...
func (tr *Route53ResolverQueryLogConfigAssociation) GetObservation() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Status.AtProvider)
}

// SetObservation for this Route53ResolverQueryLogConfigAssociation
func (tr *Route53ResolverQueryLogConfigAssociation) SetObservation(data []byte) error {
	return conversion.TFParser.Unmarshal(data, &tr.Status.AtProvider)
}

// GetParameters of this Route53ResolverQueryLogConfigAssociation
func (tr *Route53ResolverQueryLogConfigAssociation) GetParameters() ([]byte, error) {
	return conversion.TFParser.Marshal(tr.Spec.ForProvider)
}

// SetParameters for this Route53ResolverQueryLogConfigAssociation
func (tr *Route53ResolverQueryLogConfigAssociation) SetParameters(data []byte) error {
