...
var (
	...
	Route53ResolverQueryLogConfigAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: Route53ResolverQueryLogConfigAssociationKind}.String()
	Route53ResolverQueryLogConfigAssociationKindAPIVersion   = Route53ResolverQueryLogConfigAssociationKind + "." + v1alpha1.GroupVersion.String()
	Route53ResolverQueryLogConfigAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(Route53ResolverQueryLogConfigAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &Route53ResolverQueryLogConfigAssociation{}, &Route53ResolverQueryLogConfigAssociationList{})
}
