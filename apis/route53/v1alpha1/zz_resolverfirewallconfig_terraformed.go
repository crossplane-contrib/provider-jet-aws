...
// GetID returns ID of underlying Terraform resource of this ResolverFirewallConfig
func (tr *ResolverFirewallConfig) GetID() string {
...
// LateInitialize this ResolverFirewallConfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ResolverFirewallConfig) LateInitialize(attrs []byte) (bool, error) {
	params := &ResolverFirewallConfigParameters{}
