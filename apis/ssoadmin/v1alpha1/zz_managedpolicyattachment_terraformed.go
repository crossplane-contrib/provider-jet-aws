...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagedPolicyAttachment
func (tr *ManagedPolicyAttachment) GetTerraformResourceIDField() string {
	return "id"
}
