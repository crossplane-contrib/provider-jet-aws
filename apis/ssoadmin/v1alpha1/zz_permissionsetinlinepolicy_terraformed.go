...
// GetTerraformResourceIDField returns Terraform identifier field for this PermissionSetInlinePolicy
func (tr *PermissionSetInlinePolicy) GetTerraformResourceIDField() string {
	return "id"
}
