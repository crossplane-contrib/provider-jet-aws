...
var (
	PermissionSetInlinePolicyKind             = "PermissionSetInlinePolicy"
	PermissionSetInlinePolicyGroupKind        = schema.GroupKind{Group: Group, Kind: PermissionSetInlinePolicyKind}.String()
	PermissionSetInlinePolicyKindAPIVersion   = PermissionSetInlinePolicyKind + "." + GroupVersion.String()
	PermissionSetInlinePolicyGroupVersionKind = GroupVersion.WithKind(PermissionSetInlinePolicyKind)
)
