...
// GetTerraformResourceIDField returns Terraform identifier field for this ReportDefinition
func (tr *ReportDefinition) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ReportDefinition) GetObservation() (map[string]interface{}, error) {
...
func (tr *ReportDefinition) SetObservation(obs map[string]interface{}) error {
...
func (tr *ReportDefinition) GetParameters() (map[string]interface{}, error) {
...
func (tr *ReportDefinition) SetParameters(params map[string]interface{}) error {
