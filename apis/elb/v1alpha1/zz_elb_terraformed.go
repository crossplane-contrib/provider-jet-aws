...
// GetTerraformResourceIDField returns Terraform identifier field for this Elb
func (tr *Elb) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this Elb
func (tr *Elb) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *Elb) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this Elb
func (tr *Elb) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
