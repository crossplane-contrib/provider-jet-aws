...
// GetTerraformResourceIDField returns Terraform identifier field for this ConfigurationAggregator
func (tr *ConfigurationAggregator) GetTerraformResourceIDField() string {
	return "id"
}
