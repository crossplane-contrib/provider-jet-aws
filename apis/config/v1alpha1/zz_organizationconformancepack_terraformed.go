...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationConformancePack
func (tr *OrganizationConformancePack) GetTerraformResourceIDField() string {
	return "id"
}
