...
var (
	DeliveryChannelKind             = "DeliveryChannel"
	DeliveryChannelGroupKind        = schema.GroupKind{Group: Group, Kind: DeliveryChannelKind}.String()
	DeliveryChannelKindAPIVersion   = DeliveryChannelKind + "." + GroupVersion.String()
	DeliveryChannelGroupVersionKind = GroupVersion.WithKind(DeliveryChannelKind)
)
