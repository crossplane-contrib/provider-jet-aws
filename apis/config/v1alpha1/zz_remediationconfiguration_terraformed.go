...
// GetTerraformResourceIDField returns Terraform identifier field for this RemediationConfiguration
func (tr *RemediationConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
