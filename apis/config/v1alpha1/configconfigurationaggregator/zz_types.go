...
var (
	...
	ConfigConfigurationAggregatorGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ConfigConfigurationAggregatorKind}.String()
	ConfigConfigurationAggregatorKindAPIVersion   = ConfigConfigurationAggregatorKind + "." + v1alpha1.GroupVersion.String()
	ConfigConfigurationAggregatorGroupVersionKind = v1alpha1.GroupVersion.WithKind(ConfigConfigurationAggregatorKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ConfigConfigurationAggregator{}, &ConfigConfigurationAggregatorList{})
}
