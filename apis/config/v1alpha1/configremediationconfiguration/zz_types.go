...
var (
	...
	ConfigRemediationConfigurationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ConfigRemediationConfigurationKind}.String()
	ConfigRemediationConfigurationKindAPIVersion   = ConfigRemediationConfigurationKind + "." + v1alpha1.GroupVersion.String()
	ConfigRemediationConfigurationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ConfigRemediationConfigurationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ConfigRemediationConfiguration{}, &ConfigRemediationConfigurationList{})
}
