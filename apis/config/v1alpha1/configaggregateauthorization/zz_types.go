...
var (
	...
	ConfigAggregateAuthorizationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ConfigAggregateAuthorizationKind}.String()
	ConfigAggregateAuthorizationKindAPIVersion   = ConfigAggregateAuthorizationKind + "." + v1alpha1.GroupVersion.String()
	ConfigAggregateAuthorizationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ConfigAggregateAuthorizationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ConfigAggregateAuthorization{}, &ConfigAggregateAuthorizationList{})
}
