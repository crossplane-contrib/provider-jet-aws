...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationCustomRule
func (tr *OrganizationCustomRule) GetTerraformResourceIDField() string {
	return "id"
}
