...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationManagedRule
func (tr *OrganizationManagedRule) GetTerraformResourceIDField() string {
	return "id"
}
