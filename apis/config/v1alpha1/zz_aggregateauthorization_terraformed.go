...
// GetTerraformResourceIDField returns Terraform identifier field for this AggregateAuthorization
func (tr *AggregateAuthorization) GetTerraformResourceIDField() string {
	return "id"
}
