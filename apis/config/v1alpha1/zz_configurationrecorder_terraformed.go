...
// GetTerraformResourceIDField returns Terraform identifier field for this ConfigurationRecorder
func (tr *ConfigurationRecorder) GetTerraformResourceIDField() string {
	return "id"
}
