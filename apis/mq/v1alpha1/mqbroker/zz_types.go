...
var (
	...
	MqBrokerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: MqBrokerKind}.String()
	MqBrokerKindAPIVersion   = MqBrokerKind + "." + v1alpha1.GroupVersion.String()
	MqBrokerGroupVersionKind = v1alpha1.GroupVersion.WithKind(MqBrokerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &MqBroker{}, &MqBrokerList{})
}
