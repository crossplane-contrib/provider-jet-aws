...
var (
	...
	ElasticacheSecurityGroupGroupKind        = schema.GroupKind{Group: Group, Kind: ElasticacheSecurityGroupKind}.String()
	ElasticacheSecurityGroupKindAPIVersion   = ElasticacheSecurityGroupKind + "." + GroupVersion.String()
	ElasticacheSecurityGroupGroupVersionKind = GroupVersion.WithKind(ElasticacheSecurityGroupKind)
)

func init() {
	SchemeBuilder.Register(&ElasticacheSecurityGroup{}, &ElasticacheSecurityGroupList{})
}
