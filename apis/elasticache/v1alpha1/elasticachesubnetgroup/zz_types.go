...
var (
	...
	ElasticacheSubnetGroupGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ElasticacheSubnetGroupKind}.String()
	ElasticacheSubnetGroupKindAPIVersion   = ElasticacheSubnetGroupKind + "." + v1alpha1.GroupVersion.String()
	ElasticacheSubnetGroupGroupVersionKind = v1alpha1.GroupVersion.WithKind(ElasticacheSubnetGroupKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ElasticacheSubnetGroup{}, &ElasticacheSubnetGroupList{})
}
