...
var (
	...
	ElasticacheUserGroupKind        = schema.GroupKind{Group: Group, Kind: ElasticacheUserKind}.String()
	ElasticacheUserKindAPIVersion   = ElasticacheUserKind + "." + GroupVersion.String()
	ElasticacheUserGroupVersionKind = GroupVersion.WithKind(ElasticacheUserKind)
)
