...
// GetTerraformResourceIDField returns Terraform identifier field for this CloudformationStack
func (tr *CloudformationStack) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *CloudformationStack) GetObservation() (map[string]interface{}, error) {
...
func (tr *CloudformationStack) SetObservation(obs map[string]interface{}) error {
...
func (tr *CloudformationStack) GetParameters() (map[string]interface{}, error) {
...
func (tr *CloudformationStack) SetParameters(params map[string]interface{}) error {
