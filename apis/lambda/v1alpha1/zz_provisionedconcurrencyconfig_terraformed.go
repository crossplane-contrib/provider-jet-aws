...
// GetTerraformResourceIDField returns Terraform identifier field for this ProvisionedConcurrencyConfig
func (tr *ProvisionedConcurrencyConfig) GetTerraformResourceIDField() string {
	return "id"
}
