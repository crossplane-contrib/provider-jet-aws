...
// GetTerraformResourceIDField returns Terraform identifier field for this EventSourceMapping
func (tr *EventSourceMapping) GetTerraformResourceIDField() string {
	return "id"
}
