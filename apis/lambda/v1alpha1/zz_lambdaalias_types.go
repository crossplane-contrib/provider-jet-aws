...
var (
	...
	LambdaAliasGroupKind        = schema.GroupKind{Group: Group, Kind: LambdaAliasKind}.String()
	LambdaAliasKindAPIVersion   = LambdaAliasKind + "." + GroupVersion.String()
	LambdaAliasGroupVersionKind = GroupVersion.WithKind(LambdaAliasKind)
)
