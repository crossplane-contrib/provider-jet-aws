...
// GetTerraformResourceIDField returns Terraform identifier field for this FunctionEventInvokeConfig
func (tr *FunctionEventInvokeConfig) GetTerraformResourceIDField() string {
	return "id"
}
