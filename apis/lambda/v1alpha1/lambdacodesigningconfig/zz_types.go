...
var (
	...
	LambdaCodeSigningConfigGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LambdaCodeSigningConfigKind}.String()
	LambdaCodeSigningConfigKindAPIVersion   = LambdaCodeSigningConfigKind + "." + v1alpha1.GroupVersion.String()
	LambdaCodeSigningConfigGroupVersionKind = v1alpha1.GroupVersion.WithKind(LambdaCodeSigningConfigKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LambdaCodeSigningConfig{}, &LambdaCodeSigningConfigList{})
}
