...
// +groupName=resourcegroups.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/resourcegroups/v1alpha1"
)
...
var (
	...
	ResourcegroupsGroupGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ResourcegroupsGroupKind}.String()
	ResourcegroupsGroupKindAPIVersion   = ResourcegroupsGroupKind + "." + v1alpha1.GroupVersion.String()
	ResourcegroupsGroupGroupVersionKind = v1alpha1.GroupVersion.WithKind(ResourcegroupsGroupKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ResourcegroupsGroup{}, &ResourcegroupsGroupList{})
}
