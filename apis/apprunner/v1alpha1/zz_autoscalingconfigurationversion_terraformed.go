...
// GetTerraformResourceIDField returns Terraform identifier field for this AutoScalingConfigurationVersion
func (tr *AutoScalingConfigurationVersion) GetTerraformResourceIDField() string {
	return "id"
}
