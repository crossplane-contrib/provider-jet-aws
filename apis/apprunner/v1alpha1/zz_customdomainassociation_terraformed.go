...
// GetTerraformResourceIDField returns Terraform identifier field for this CustomDomainAssociation
func (tr *CustomDomainAssociation) GetTerraformResourceIDField() string {
	return "id"
}
