...
var (
	...
	ApprunnerConnectionGroupKind        = schema.GroupKind{Group: Group, Kind: ApprunnerConnectionKind}.String()
	ApprunnerConnectionKindAPIVersion   = ApprunnerConnectionKind + "." + GroupVersion.String()
	ApprunnerConnectionGroupVersionKind = GroupVersion.WithKind(ApprunnerConnectionKind)
)

func init() {
	SchemeBuilder.Register(&ApprunnerConnection{}, &ApprunnerConnectionList{})
}
