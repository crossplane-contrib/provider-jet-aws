...
var (
	...
	ApprunnerAutoScalingConfigurationVersionGroupKind        = schema.GroupKind{Group: Group, Kind: ApprunnerAutoScalingConfigurationVersionKind}.String()
	ApprunnerAutoScalingConfigurationVersionKindAPIVersion   = ApprunnerAutoScalingConfigurationVersionKind + "." + GroupVersion.String()
	ApprunnerAutoScalingConfigurationVersionGroupVersionKind = GroupVersion.WithKind(ApprunnerAutoScalingConfigurationVersionKind)
)

func init() {
	SchemeBuilder.Register(&ApprunnerAutoScalingConfigurationVersion{}, &ApprunnerAutoScalingConfigurationVersionList{})
}
