...
var (
	...
	LexBotAliasGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LexBotAliasKind}.String()
	LexBotAliasKindAPIVersion   = LexBotAliasKind + "." + v1alpha1.GroupVersion.String()
	LexBotAliasGroupVersionKind = v1alpha1.GroupVersion.WithKind(LexBotAliasKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LexBotAlias{}, &LexBotAliasList{})
}
