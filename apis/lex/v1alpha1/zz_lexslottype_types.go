...
var (
	...
	LexSlotTypeGroupKind        = schema.GroupKind{Group: Group, Kind: LexSlotTypeKind}.String()
	LexSlotTypeKindAPIVersion   = LexSlotTypeKind + "." + GroupVersion.String()
	LexSlotTypeGroupVersionKind = GroupVersion.WithKind(LexSlotTypeKind)
)

func init() {
	SchemeBuilder.Register(&LexSlotType{}, &LexSlotTypeList{})
}
