...
var (
	...
	BackupRegionSettingsGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: BackupRegionSettingsKind}.String()
	BackupRegionSettingsKindAPIVersion   = BackupRegionSettingsKind + "." + v1alpha1.GroupVersion.String()
	BackupRegionSettingsGroupVersionKind = v1alpha1.GroupVersion.WithKind(BackupRegionSettingsKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &BackupRegionSettings{}, &BackupRegionSettingsList{})
}
