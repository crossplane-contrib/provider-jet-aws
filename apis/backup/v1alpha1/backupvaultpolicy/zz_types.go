...
var (
	...
	BackupVaultPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: BackupVaultPolicyKind}.String()
	BackupVaultPolicyKindAPIVersion   = BackupVaultPolicyKind + "." + v1alpha1.GroupVersion.String()
	BackupVaultPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(BackupVaultPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &BackupVaultPolicy{}, &BackupVaultPolicyList{})
}
