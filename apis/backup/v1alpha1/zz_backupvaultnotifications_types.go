...
var (
	...
	BackupVaultNotificationsGroupKind        = schema.GroupKind{Group: Group, Kind: BackupVaultNotificationsKind}.String()
	BackupVaultNotificationsKindAPIVersion   = BackupVaultNotificationsKind + "." + GroupVersion.String()
	BackupVaultNotificationsGroupVersionKind = GroupVersion.WithKind(BackupVaultNotificationsKind)
)

func init() {
	SchemeBuilder.Register(&BackupVaultNotifications{}, &BackupVaultNotificationsList{})
}
