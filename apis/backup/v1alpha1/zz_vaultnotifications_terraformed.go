...
// GetTerraformResourceIDField returns Terraform identifier field for this VaultNotifications
func (tr *VaultNotifications) GetTerraformResourceIDField() string {
	return "id"
}
