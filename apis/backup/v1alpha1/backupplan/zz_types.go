...
var (
	...
	BackupPlanGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: BackupPlanKind}.String()
	BackupPlanKindAPIVersion   = BackupPlanKind + "." + v1alpha1.GroupVersion.String()
	BackupPlanGroupVersionKind = v1alpha1.GroupVersion.WithKind(BackupPlanKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &BackupPlan{}, &BackupPlanList{})
}
