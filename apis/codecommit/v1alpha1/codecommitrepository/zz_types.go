...
var (
	...
	CodecommitRepositoryGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CodecommitRepositoryKind}.String()
	CodecommitRepositoryKindAPIVersion   = CodecommitRepositoryKind + "." + v1alpha1.GroupVersion.String()
	CodecommitRepositoryGroupVersionKind = v1alpha1.GroupVersion.WithKind(CodecommitRepositoryKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CodecommitRepository{}, &CodecommitRepositoryList{})
}
