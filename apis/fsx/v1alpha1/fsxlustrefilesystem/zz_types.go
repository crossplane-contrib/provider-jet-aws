...
var (
	...
	FsxLustreFileSystemGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: FsxLustreFileSystemKind}.String()
	FsxLustreFileSystemKindAPIVersion   = FsxLustreFileSystemKind + "." + v1alpha1.GroupVersion.String()
	FsxLustreFileSystemGroupVersionKind = v1alpha1.GroupVersion.WithKind(FsxLustreFileSystemKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &FsxLustreFileSystem{}, &FsxLustreFileSystemList{})
}
