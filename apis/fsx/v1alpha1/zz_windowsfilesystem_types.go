...
var (
	WindowsFileSystemKind             = "WindowsFileSystem"
	WindowsFileSystemGroupKind        = schema.GroupKind{Group: Group, Kind: WindowsFileSystemKind}.String()
	WindowsFileSystemKindAPIVersion   = WindowsFileSystemKind + "." + GroupVersion.String()
	WindowsFileSystemGroupVersionKind = GroupVersion.WithKind(WindowsFileSystemKind)
)
