...
// +groupName=main.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/main/v1alpha1"
)
...
var (
	...
	MainRouteTableAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: MainRouteTableAssociationKind}.String()
	MainRouteTableAssociationKindAPIVersion   = MainRouteTableAssociationKind + "." + v1alpha1.GroupVersion.String()
	MainRouteTableAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(MainRouteTableAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &MainRouteTableAssociation{}, &MainRouteTableAssociationList{})
}
