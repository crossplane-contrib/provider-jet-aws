...
// GetTerraformResourceIDField returns Terraform identifier field for this PublishingDestination
func (tr *PublishingDestination) GetTerraformResourceIDField() string {
	return "id"
}
