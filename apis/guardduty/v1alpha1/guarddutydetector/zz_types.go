...
// GuarddutyDetectorSpec defines the desired state of GuarddutyDetector
...
type GuarddutyDetectorStatus struct {
	...
	AtProvider          GuarddutyDetectorObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// GuarddutyDetector is the Schema for the GuarddutyDetectors API
...
// GuarddutyDetectorList contains a list of GuarddutyDetectors
...
var (
	GuarddutyDetectorKind             = "GuarddutyDetector"
	GuarddutyDetectorGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GuarddutyDetectorKind}.String()
	GuarddutyDetectorKindAPIVersion   = GuarddutyDetectorKind + "." + v1alpha1.GroupVersion.String()
	GuarddutyDetectorGroupVersionKind = v1alpha1.GroupVersion.WithKind(GuarddutyDetectorKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GuarddutyDetector{}, &GuarddutyDetectorList{})
}
