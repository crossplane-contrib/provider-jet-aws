...
var (
	...
	GuarddutyOrganizationConfigurationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GuarddutyOrganizationConfigurationKind}.String()
	GuarddutyOrganizationConfigurationKindAPIVersion   = GuarddutyOrganizationConfigurationKind + "." + v1alpha1.GroupVersion.String()
	GuarddutyOrganizationConfigurationGroupVersionKind = v1alpha1.GroupVersion.WithKind(GuarddutyOrganizationConfigurationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GuarddutyOrganizationConfiguration{}, &GuarddutyOrganizationConfigurationList{})
}
