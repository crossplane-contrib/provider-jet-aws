...
// GetTerraformResourceIDField returns Terraform identifier field for this OrganizationConfiguration
func (tr *OrganizationConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
