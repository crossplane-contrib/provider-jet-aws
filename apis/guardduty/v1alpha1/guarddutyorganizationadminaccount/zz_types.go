...
var (
	...
	GuarddutyOrganizationAdminAccountGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: GuarddutyOrganizationAdminAccountKind}.String()
	GuarddutyOrganizationAdminAccountKindAPIVersion   = GuarddutyOrganizationAdminAccountKind + "." + v1alpha1.GroupVersion.String()
	GuarddutyOrganizationAdminAccountGroupVersionKind = v1alpha1.GroupVersion.WithKind(GuarddutyOrganizationAdminAccountKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &GuarddutyOrganizationAdminAccount{}, &GuarddutyOrganizationAdminAccountList{})
}
