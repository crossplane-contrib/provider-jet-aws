...
var (
	...
	GuarddutyDetectorGroupKind        = schema.GroupKind{Group: Group, Kind: GuarddutyDetectorKind}.String()
	GuarddutyDetectorKindAPIVersion   = GuarddutyDetectorKind + "." + GroupVersion.String()
	GuarddutyDetectorGroupVersionKind = GroupVersion.WithKind(GuarddutyDetectorKind)
)
