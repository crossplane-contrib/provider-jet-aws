...
// GetTerraformResourceIDField returns Terraform identifier field for this DomainAssociation
func (tr *DomainAssociation) GetTerraformResourceIDField() string {
	return "id"
}
...
// LateInitialize this DomainAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DomainAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &DomainAssociationParameters{}
