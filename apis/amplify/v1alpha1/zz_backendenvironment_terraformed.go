...
// GetTerraformResourceIDField returns Terraform identifier field for this BackendEnvironment
func (tr *BackendEnvironment) GetTerraformResourceIDField() string {
	return "id"
}
