...
var (
	...
	AmplifyBackendEnvironmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AmplifyBackendEnvironmentKind}.String()
	AmplifyBackendEnvironmentKindAPIVersion   = AmplifyBackendEnvironmentKind + "." + v1alpha1.GroupVersion.String()
	AmplifyBackendEnvironmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(AmplifyBackendEnvironmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AmplifyBackendEnvironment{}, &AmplifyBackendEnvironmentList{})
}
