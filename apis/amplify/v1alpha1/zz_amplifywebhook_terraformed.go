...
// GetTerraformResourceType returns Terraform resource type for this AmplifyWebhook
func (mg *AmplifyWebhook) GetTerraformResourceType() string {
	return "aws_amplify_webhook"
}

// GetTerraformResourceIdField returns Terraform identifier field for this AmplifyWebhook
