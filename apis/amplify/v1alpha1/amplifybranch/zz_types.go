...
var (
	...
	AmplifyBranchGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AmplifyBranchKind}.String()
	AmplifyBranchKindAPIVersion   = AmplifyBranchKind + "." + v1alpha1.GroupVersion.String()
	AmplifyBranchGroupVersionKind = v1alpha1.GroupVersion.WithKind(AmplifyBranchKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AmplifyBranch{}, &AmplifyBranchList{})
}
