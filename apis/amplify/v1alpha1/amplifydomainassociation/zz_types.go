...
var (
	...
	AmplifyDomainAssociationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AmplifyDomainAssociationKind}.String()
	AmplifyDomainAssociationKindAPIVersion   = AmplifyDomainAssociationKind + "." + v1alpha1.GroupVersion.String()
	AmplifyDomainAssociationGroupVersionKind = v1alpha1.GroupVersion.WithKind(AmplifyDomainAssociationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AmplifyDomainAssociation{}, &AmplifyDomainAssociationList{})
}
