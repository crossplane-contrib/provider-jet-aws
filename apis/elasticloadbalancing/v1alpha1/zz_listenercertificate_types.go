...
var (
	ListenerCertificate_Kind             = "ListenerCertificate"
	ListenerCertificate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ListenerCertificate_Kind}.String()
	ListenerCertificate_KindAPIVersion   = ListenerCertificate_Kind + "." + CRDGroupVersion.String()
	ListenerCertificate_GroupVersionKind = CRDGroupVersion.WithKind(ListenerCertificate_Kind)
)
