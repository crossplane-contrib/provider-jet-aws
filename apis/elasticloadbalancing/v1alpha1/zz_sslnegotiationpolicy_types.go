...
var (
	SslNegotiationPolicy_Kind             = "SslNegotiationPolicy"
	SslNegotiationPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SslNegotiationPolicy_Kind}.String()
	SslNegotiationPolicy_KindAPIVersion   = SslNegotiationPolicy_Kind + "." + CRDGroupVersion.String()
	SslNegotiationPolicy_GroupVersionKind = CRDGroupVersion.WithKind(SslNegotiationPolicy_Kind)
)
