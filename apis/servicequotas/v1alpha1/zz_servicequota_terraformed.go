...
// GetTerraformResourceIDField returns Terraform identifier field for this ServiceQuota
func (tr *ServiceQuota) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ServiceQuota) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServiceQuota) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServiceQuota) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServiceQuota) SetParameters(params map[string]interface{}) error {
