...
var (
	...
	QuicksightGroupGroupKind        = schema.GroupKind{Group: Group, Kind: QuicksightGroupKind}.String()
	QuicksightGroupKindAPIVersion   = QuicksightGroupKind + "." + GroupVersion.String()
	QuicksightGroupGroupVersionKind = GroupVersion.WithKind(QuicksightGroupKind)
)

func init() {
	SchemeBuilder.Register(&QuicksightGroup{}, &QuicksightGroupList{})
}
