...
var (
	...
	CodeartifactDomainGroupKind        = schema.GroupKind{Group: Group, Kind: CodeartifactDomainKind}.String()
	CodeartifactDomainKindAPIVersion   = CodeartifactDomainKind + "." + GroupVersion.String()
	CodeartifactDomainGroupVersionKind = GroupVersion.WithKind(CodeartifactDomainKind)
)
