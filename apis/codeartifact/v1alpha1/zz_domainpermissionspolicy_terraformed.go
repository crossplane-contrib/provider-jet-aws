...
// GetTerraformResourceIDField returns Terraform identifier field for this DomainPermissionsPolicy
func (tr *DomainPermissionsPolicy) GetTerraformResourceIDField() string {
	return "id"
}
