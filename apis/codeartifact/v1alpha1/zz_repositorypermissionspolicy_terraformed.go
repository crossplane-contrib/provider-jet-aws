...
// GetTerraformResourceIDField returns Terraform identifier field for this RepositoryPermissionsPolicy
func (tr *RepositoryPermissionsPolicy) GetTerraformResourceIDField() string {
	return "id"
}
