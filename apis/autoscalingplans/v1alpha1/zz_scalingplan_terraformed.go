...
// GetTerraformResourceIDField returns Terraform identifier field for this ScalingPlan
func (tr *ScalingPlan) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *ScalingPlan) GetObservation() (map[string]interface{}, error) {
...
func (tr *ScalingPlan) SetObservation(obs map[string]interface{}) error {
...
func (tr *ScalingPlan) GetParameters() (map[string]interface{}, error) {
...
func (tr *ScalingPlan) SetParameters(params map[string]interface{}) error {
