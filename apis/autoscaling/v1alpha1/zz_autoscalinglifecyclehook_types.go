...
var (
	...
	AutoscalingLifecycleHookGroupKind        = schema.GroupKind{Group: Group, Kind: AutoscalingLifecycleHookKind}.String()
	AutoscalingLifecycleHookKindAPIVersion   = AutoscalingLifecycleHookKind + "." + GroupVersion.String()
	AutoscalingLifecycleHookGroupVersionKind = GroupVersion.WithKind(AutoscalingLifecycleHookKind)
)
