...
// AutoscalingAttachmentStatus defines the observed state of AutoscalingAttachment.
type AutoscalingAttachmentStatus struct {
	xpv1.ResourceStatus `json:",inline"`
	AtProvider          AutoscalingAttachmentObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// AutoscalingAttachment is the Schema for the AutoscalingAttachments API
...
// AutoscalingAttachmentList contains a list of AutoscalingAttachments
...
var (
	AutoscalingAttachmentKind             = "AutoscalingAttachment"
	AutoscalingAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AutoscalingAttachmentKind}.String()
	AutoscalingAttachmentKindAPIVersion   = AutoscalingAttachmentKind + "." + v1alpha1.GroupVersion.String()
	AutoscalingAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(AutoscalingAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AutoscalingAttachment{}, &AutoscalingAttachmentList{})
}
