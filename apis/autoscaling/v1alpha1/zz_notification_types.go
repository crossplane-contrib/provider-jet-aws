...
var (
	...
	NotificationGroupKind        = schema.GroupKind{Group: Group, Kind: NotificationKind}.String()
	NotificationKindAPIVersion   = NotificationKind + "." + GroupVersion.String()
	NotificationGroupVersionKind = GroupVersion.WithKind(NotificationKind)
)
