...
func (tr *GroupTag) GetObservation() (map[string]interface{}, error) {
...
func (tr *GroupTag) SetObservation(obs map[string]interface{}) error {
...
func (tr *GroupTag) GetParameters() (map[string]interface{}, error) {
...
func (tr *GroupTag) SetParameters(params map[string]interface{}) error {
...
func (tr *LaunchConfiguration) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *LaunchConfiguration) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
func (tr *LaunchConfiguration) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *LaunchConfiguration) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
