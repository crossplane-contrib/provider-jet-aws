...
var (
	LbListenerCertificateKind             = "LbListenerCertificate"
	LbListenerCertificateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LbListenerCertificateKind}.String()
	LbListenerCertificateKindAPIVersion   = LbListenerCertificateKind + "." + v1alpha1.GroupVersion.String()
	LbListenerCertificateGroupVersionKind = v1alpha1.GroupVersion.WithKind(LbListenerCertificateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LbListenerCertificate{}, &LbListenerCertificateList{})
}
