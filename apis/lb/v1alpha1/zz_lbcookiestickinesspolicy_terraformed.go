...
// GetTerraformResourceIDField returns Terraform identifier field for this LbCookieStickinessPolicy
func (tr *LbCookieStickinessPolicy) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this LbCookieStickinessPolicy
func (tr *LbCookieStickinessPolicy) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *LbCookieStickinessPolicy) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this LbCookieStickinessPolicy
func (tr *LbCookieStickinessPolicy) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
