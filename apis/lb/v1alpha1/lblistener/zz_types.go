...
var (
	...
	LbListenerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LbListenerKind}.String()
	LbListenerKindAPIVersion   = LbListenerKind + "." + v1alpha1.GroupVersion.String()
	LbListenerGroupVersionKind = v1alpha1.GroupVersion.WithKind(LbListenerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LbListener{}, &LbListenerList{})
}
