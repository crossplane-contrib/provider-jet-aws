...
var (
	...
	LbSslNegotiationPolicyGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LbSslNegotiationPolicyKind}.String()
	LbSslNegotiationPolicyKindAPIVersion   = LbSslNegotiationPolicyKind + "." + v1alpha1.GroupVersion.String()
	LbSslNegotiationPolicyGroupVersionKind = v1alpha1.GroupVersion.WithKind(LbSslNegotiationPolicyKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LbSslNegotiationPolicy{}, &LbSslNegotiationPolicyList{})
}
