...
var (
	LbTargetGroupAttachmentKind             = "LbTargetGroupAttachment"
	LbTargetGroupAttachmentGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: LbTargetGroupAttachmentKind}.String()
	LbTargetGroupAttachmentKindAPIVersion   = LbTargetGroupAttachmentKind + "." + v1alpha1.GroupVersion.String()
	LbTargetGroupAttachmentGroupVersionKind = v1alpha1.GroupVersion.WithKind(LbTargetGroupAttachmentKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &LbTargetGroupAttachment{}, &LbTargetGroupAttachmentList{})
}
