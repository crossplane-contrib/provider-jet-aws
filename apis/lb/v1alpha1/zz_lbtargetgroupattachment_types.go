...
var (
	...
	LbTargetGroupAttachmentGroupKind        = schema.GroupKind{Group: Group, Kind: LbTargetGroupAttachmentKind}.String()
	LbTargetGroupAttachmentKindAPIVersion   = LbTargetGroupAttachmentKind + "." + GroupVersion.String()
	LbTargetGroupAttachmentGroupVersionKind = GroupVersion.WithKind(LbTargetGroupAttachmentKind)
)
