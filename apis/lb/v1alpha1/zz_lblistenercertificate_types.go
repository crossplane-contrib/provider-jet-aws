...
var (
	...
	LbListenerCertificateGroupKind        = schema.GroupKind{Group: Group, Kind: LbListenerCertificateKind}.String()
	LbListenerCertificateKindAPIVersion   = LbListenerCertificateKind + "." + GroupVersion.String()
	LbListenerCertificateGroupVersionKind = GroupVersion.WithKind(LbListenerCertificateKind)
)
