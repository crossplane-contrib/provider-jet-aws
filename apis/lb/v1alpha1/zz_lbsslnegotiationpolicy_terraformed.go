...
// GetTerraformResourceIDField returns Terraform identifier field for this LbSslNegotiationPolicy
func (tr *LbSslNegotiationPolicy) GetTerraformResourceIDField() string {
	return "id"
}

// GetObservation of this LbSslNegotiationPolicy
func (tr *LbSslNegotiationPolicy) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *LbSslNegotiationPolicy) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
// GetConnectionDetails of this LbSslNegotiationPolicy
func (tr *LbSslNegotiationPolicy) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return nil, nil
}
