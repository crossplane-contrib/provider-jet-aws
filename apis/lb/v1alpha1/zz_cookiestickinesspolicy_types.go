...
var (
	CookieStickinessPolicyKind             = "CookieStickinessPolicy"
	CookieStickinessPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: CookieStickinessPolicyKind}.String()
	CookieStickinessPolicyKindAPIVersion   = CookieStickinessPolicyKind + "." + GroupVersion.String()
	CookieStickinessPolicyGroupVersionKind = GroupVersion.WithKind(CookieStickinessPolicyKind)
)
