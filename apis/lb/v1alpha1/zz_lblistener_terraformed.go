...
func (tr *LbListener) GetObservation(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
...
func (tr *LbListener) GetParameters(ctx context.Context, c resource.SecretClient) (map[string]interface{}, error) {
	...
	return base, resource.GetSensitiveParameters(ctx, c, tr, base, map[string]string{"default_action[*].authenticate_oidc[*].client_secret": "defaultAction[*].authenticateOidc[*].clientSecretSecretRef"})
}
...
// GetConnectionDetails of this LbListener
func (tr *LbListener) GetConnectionDetails(obs map[string]interface{}) (map[string][]byte, error) {
	return resource.GetConnectionDetails(obs, map[string]string{"default_action[*].authenticate_oidc[*].client_secret": "defaultAction[*].authenticateOidc[*].clientSecretSecretRef"})
}
