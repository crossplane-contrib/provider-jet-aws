...
type WorkspacePropertiesParameters struct {
	...
	// +kubebuilder:validation:Optional
	RootVolumeSizeGib *float64 `json:"rootVolumeSizeGib,omitempty" tf:"root_volume_size_gib,omitempty"`

	// +kubebuilder:validation:Optional
	RunningMode *string `json:"runningMode,omitempty" tf:"running_mode,omitempty"`

	// +kubebuilder:validation:Optional
	RunningModeAutoStopTimeoutInMinutes *float64 `json:"runningModeAutoStopTimeoutInMinutes,omitempty" tf:"running_mode_auto_stop_timeout_in_minutes,omitempty"`

	// +kubebuilder:validation:Optional
	UserVolumeSizeGib *float64 `json:"userVolumeSizeGib,omitempty" tf:"user_volume_size_gib,omitempty"`
}
