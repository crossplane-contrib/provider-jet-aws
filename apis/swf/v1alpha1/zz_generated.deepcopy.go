...
func (in *SwfDomainObservation) DeepCopy() *SwfDomainObservation {
	if in == nil {
		return nil
	}
	out := new(SwfDomainObservation)
	in.DeepCopyInto(out)
	return out
}
