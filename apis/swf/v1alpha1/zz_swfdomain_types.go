...
var (
	...
	SwfDomainGroupKind        = schema.GroupKind{Group: Group, Kind: SwfDomainKind}.String()
	SwfDomainKindAPIVersion   = SwfDomainKind + "." + GroupVersion.String()
	SwfDomainGroupVersionKind = GroupVersion.WithKind(SwfDomainKind)
)

func init() {
	SchemeBuilder.Register(&SwfDomain{}, &SwfDomainList{})
}
