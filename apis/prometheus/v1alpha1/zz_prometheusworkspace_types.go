...
var (
	...
	PrometheusWorkspaceGroupKind        = schema.GroupKind{Group: Group, Kind: PrometheusWorkspaceKind}.String()
	PrometheusWorkspaceKindAPIVersion   = PrometheusWorkspaceKind + "." + GroupVersion.String()
	PrometheusWorkspaceGroupVersionKind = GroupVersion.WithKind(PrometheusWorkspaceKind)
)
