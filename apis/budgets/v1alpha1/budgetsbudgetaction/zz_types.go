...
var (
	...
	BudgetsBudgetActionGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: BudgetsBudgetActionKind}.String()
	BudgetsBudgetActionKindAPIVersion   = BudgetsBudgetActionKind + "." + v1alpha1.GroupVersion.String()
	BudgetsBudgetActionGroupVersionKind = v1alpha1.GroupVersion.WithKind(BudgetsBudgetActionKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &BudgetsBudgetAction{}, &BudgetsBudgetActionList{})
}
