...
var (
	DiscoveryHttpNamespace_Kind             = "DiscoveryHttpNamespace"
	DiscoveryHttpNamespace_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DiscoveryHttpNamespace_Kind}.String()
	DiscoveryHttpNamespace_KindAPIVersion   = DiscoveryHttpNamespace_Kind + "." + CRDGroupVersion.String()
	DiscoveryHttpNamespace_GroupVersionKind = CRDGroupVersion.WithKind(DiscoveryHttpNamespace_Kind)
)
