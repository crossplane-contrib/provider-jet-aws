...
var (
	InstanceFleetKind             = "InstanceFleet"
	InstanceFleetGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceFleetKind}.String()
	InstanceFleetKindAPIVersion   = InstanceFleetKind + "." + GroupVersion.String()
	InstanceFleetGroupVersionKind = GroupVersion.WithKind(InstanceFleetKind)
)
