...
// GetTerraformResourceIDField returns Terraform identifier field for this SecurityConfiguration
func (tr *SecurityConfiguration) GetTerraformResourceIDField() string {
	return "id"
}
