...
// GetTerraformResourceIDField returns Terraform identifier field for this ManagedScalingPolicy
func (tr *ManagedScalingPolicy) GetTerraformResourceIDField() string {
	return "id"
}
