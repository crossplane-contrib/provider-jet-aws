...
var (
	TopicPolicyKind             = "TopicPolicy"
	TopicPolicyGroupKind        = schema.GroupKind{Group: Group, Kind: TopicPolicyKind}.String()
	TopicPolicyKindAPIVersion   = TopicPolicyKind + "." + GroupVersion.String()
	TopicPolicyGroupVersionKind = GroupVersion.WithKind(TopicPolicyKind)
)
