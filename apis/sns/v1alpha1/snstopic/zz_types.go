...
var (
	...
	SnsTopicGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SnsTopicKind}.String()
	SnsTopicKindAPIVersion   = SnsTopicKind + "." + v1alpha1.GroupVersion.String()
	SnsTopicGroupVersionKind = v1alpha1.GroupVersion.WithKind(SnsTopicKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SnsTopic{}, &SnsTopicList{})
}
