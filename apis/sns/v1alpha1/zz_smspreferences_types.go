...
var (
	SmsPreferencesKind             = "SmsPreferences"
	SmsPreferencesGroupKind        = schema.GroupKind{Group: Group, Kind: SmsPreferencesKind}.String()
	SmsPreferencesKindAPIVersion   = SmsPreferencesKind + "." + GroupVersion.String()
	SmsPreferencesGroupVersionKind = GroupVersion.WithKind(SmsPreferencesKind)
)
