...
var (
	...
	SnsSmsPreferencesGroupKind        = schema.GroupKind{Group: Group, Kind: SnsSmsPreferencesKind}.String()
	SnsSmsPreferencesKindAPIVersion   = SnsSmsPreferencesKind + "." + GroupVersion.String()
	SnsSmsPreferencesGroupVersionKind = GroupVersion.WithKind(SnsSmsPreferencesKind)
)

func init() {
	SchemeBuilder.Register(&SnsSmsPreferences{}, &SnsSmsPreferencesList{})
}
