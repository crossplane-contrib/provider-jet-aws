...
// GetTerraformResourceIDField returns Terraform identifier field for this PlatformApplication
func (tr *PlatformApplication) GetTerraformResourceIDField() string {
	return "id"
}
