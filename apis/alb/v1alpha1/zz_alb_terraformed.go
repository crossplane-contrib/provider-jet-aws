...
// GetTerraformResourceIDField returns Terraform identifier field for this Alb
func (tr *Alb) GetTerraformResourceIDField() string {
	return "id"
}
...
func (tr *Alb) GetObservation() (map[string]interface{}, error) {
...
func (tr *Alb) SetObservation(obs map[string]interface{}) error {
...
func (tr *Alb) GetParameters() (map[string]interface{}, error) {
...
func (tr *Alb) SetParameters(params map[string]interface{}) error {
