...
var (
	...
	AlbListenerCertificateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AlbListenerCertificateKind}.String()
	AlbListenerCertificateKindAPIVersion   = AlbListenerCertificateKind + "." + v1alpha1.GroupVersion.String()
	AlbListenerCertificateGroupVersionKind = v1alpha1.GroupVersion.WithKind(AlbListenerCertificateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AlbListenerCertificate{}, &AlbListenerCertificateList{})
}
