...
var (
	...
	AlbListenerGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AlbListenerKind}.String()
	AlbListenerKindAPIVersion   = AlbListenerKind + "." + v1alpha1.GroupVersion.String()
	AlbListenerGroupVersionKind = v1alpha1.GroupVersion.WithKind(AlbListenerKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AlbListener{}, &AlbListenerList{})
}
