...
// +groupName=customer.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/customer/v1alpha1"
)
...
var (
	CustomerGatewayKind             = "CustomerGateway"
	CustomerGatewayGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: CustomerGatewayKind}.String()
	CustomerGatewayKindAPIVersion   = CustomerGatewayKind + "." + v1alpha1.GroupVersion.String()
	CustomerGatewayGroupVersionKind = v1alpha1.GroupVersion.WithKind(CustomerGatewayKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &CustomerGateway{}, &CustomerGatewayList{})
}
