...
var (
	...
	ElasticBeanstalkApplicationGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: ElasticBeanstalkApplicationKind}.String()
	ElasticBeanstalkApplicationKindAPIVersion   = ElasticBeanstalkApplicationKind + "." + v1alpha1.GroupVersion.String()
	ElasticBeanstalkApplicationGroupVersionKind = v1alpha1.GroupVersion.WithKind(ElasticBeanstalkApplicationKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &ElasticBeanstalkApplication{}, &ElasticBeanstalkApplicationList{})
}
