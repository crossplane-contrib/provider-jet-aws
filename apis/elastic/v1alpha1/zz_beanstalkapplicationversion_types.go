...
var (
	BeanstalkApplicationVersionKind             = "BeanstalkApplicationVersion"
	BeanstalkApplicationVersionGroupKind        = schema.GroupKind{Group: Group, Kind: BeanstalkApplicationVersionKind}.String()
	BeanstalkApplicationVersionKindAPIVersion   = BeanstalkApplicationVersionKind + "." + GroupVersion.String()
	BeanstalkApplicationVersionGroupVersionKind = GroupVersion.WithKind(BeanstalkApplicationVersionKind)
)
