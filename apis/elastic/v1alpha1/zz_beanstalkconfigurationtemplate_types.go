...
var (
	BeanstalkConfigurationTemplate_Kind             = "BeanstalkConfigurationTemplate"
	BeanstalkConfigurationTemplate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BeanstalkConfigurationTemplate_Kind}.String()
	BeanstalkConfigurationTemplate_KindAPIVersion   = BeanstalkConfigurationTemplate_Kind + "." + CRDGroupVersion.String()
	BeanstalkConfigurationTemplate_GroupVersionKind = CRDGroupVersion.WithKind(BeanstalkConfigurationTemplate_Kind)
)
