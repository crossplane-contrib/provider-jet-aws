...
// GetTerraformResourceIDField returns Terraform identifier field for this AssessmentTemplate
func (tr *AssessmentTemplate) GetTerraformResourceIDField() string {
	return "id"
}
