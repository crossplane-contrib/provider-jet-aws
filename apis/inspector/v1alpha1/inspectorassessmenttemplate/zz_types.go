...
var (
	...
	InspectorAssessmentTemplateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: InspectorAssessmentTemplateKind}.String()
	InspectorAssessmentTemplateKindAPIVersion   = InspectorAssessmentTemplateKind + "." + v1alpha1.GroupVersion.String()
	InspectorAssessmentTemplateGroupVersionKind = v1alpha1.GroupVersion.WithKind(InspectorAssessmentTemplateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &InspectorAssessmentTemplate{}, &InspectorAssessmentTemplateList{})
}
