...
// GetTerraformResourceIDField returns Terraform identifier field for this CertificateAuthority
func (tr *CertificateAuthority) GetTerraformResourceIDField() string {
	return "id"
}
