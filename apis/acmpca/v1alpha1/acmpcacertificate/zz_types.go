...
var (
	...
	AcmpcaCertificateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AcmpcaCertificateKind}.String()
	AcmpcaCertificateKindAPIVersion   = AcmpcaCertificateKind + "." + v1alpha1.GroupVersion.String()
	AcmpcaCertificateGroupVersionKind = v1alpha1.GroupVersion.WithKind(AcmpcaCertificateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AcmpcaCertificate{}, &AcmpcaCertificateList{})
}
