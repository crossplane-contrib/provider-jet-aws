...
var (
	...
	AcmpcaCertificateAuthorityGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AcmpcaCertificateAuthorityKind}.String()
	AcmpcaCertificateAuthorityKindAPIVersion   = AcmpcaCertificateAuthorityKind + "." + v1alpha1.GroupVersion.String()
	AcmpcaCertificateAuthorityGroupVersionKind = v1alpha1.GroupVersion.WithKind(AcmpcaCertificateAuthorityKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AcmpcaCertificateAuthority{}, &AcmpcaCertificateAuthorityList{})
}
