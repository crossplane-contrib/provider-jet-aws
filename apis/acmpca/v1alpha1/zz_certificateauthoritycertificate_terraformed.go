...
// GetTerraformResourceIDField returns Terraform identifier field for this CertificateAuthorityCertificate
func (tr *CertificateAuthorityCertificate) GetTerraformResourceIDField() string {
	return "id"
}
