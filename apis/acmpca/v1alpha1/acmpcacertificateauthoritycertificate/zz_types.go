...
// +groupName=acmpca.aws.tf.crossplane.io
...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-tf-aws/apis/acmpca/v1alpha1"
)
...
var (
	...
	AcmpcaCertificateAuthorityCertificateGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: AcmpcaCertificateAuthorityCertificateKind}.String()
	AcmpcaCertificateAuthorityCertificateKindAPIVersion   = AcmpcaCertificateAuthorityCertificateKind + "." + v1alpha1.GroupVersion.String()
	AcmpcaCertificateAuthorityCertificateGroupVersionKind = v1alpha1.GroupVersion.WithKind(AcmpcaCertificateAuthorityCertificateKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &AcmpcaCertificateAuthorityCertificate{}, &AcmpcaCertificateAuthorityCertificateList{})
}
