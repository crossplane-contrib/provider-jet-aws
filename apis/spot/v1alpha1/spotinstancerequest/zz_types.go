...
var (
	...
	SpotInstanceRequestGroupKind        = schema.GroupKind{Group: v1alpha1.Group, Kind: SpotInstanceRequestKind}.String()
	SpotInstanceRequestKindAPIVersion   = SpotInstanceRequestKind + "." + v1alpha1.GroupVersion.String()
	SpotInstanceRequestGroupVersionKind = v1alpha1.GroupVersion.WithKind(SpotInstanceRequestKind)
)

func init() {
	apis.SchemaMap[v1alpha1.GroupVersion] = append(apis.SchemaMap[v1alpha1.GroupVersion], &SpotInstanceRequest{}, &SpotInstanceRequestList{})
}
