...
var (
	InstanceRequestKind             = "InstanceRequest"
	InstanceRequestGroupKind        = schema.GroupKind{Group: Group, Kind: InstanceRequestKind}.String()
	InstanceRequestKindAPIVersion   = InstanceRequestKind + "." + GroupVersion.String()
	InstanceRequestGroupVersionKind = GroupVersion.WithKind(InstanceRequestKind)
)
