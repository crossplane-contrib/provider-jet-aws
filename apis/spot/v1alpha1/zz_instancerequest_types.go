...
type InstanceRequestEbsBlockDeviceObservation struct {
	VolumeID *string `json:"volumeId,omitempty" tf:"volume_id,omitempty"`
}

type InstanceRequestEbsBlockDeviceParameters struct {
...
type InstanceRequestEphemeralBlockDeviceObservation struct {
}

type InstanceRequestEphemeralBlockDeviceParameters struct {
...
type InstanceRequestObservation struct {
...
type InstanceRequestParameters struct {
	...
	// +kubebuilder:validation:Optional
	EbsBlockDevice []InstanceRequestEbsBlockDeviceParameters `json:"ebsBlockDevice,omitempty" tf:"ebs_block_device,omitempty"`
	...
	// +kubebuilder:validation:Optional
	EphemeralBlockDevice []InstanceRequestEphemeralBlockDeviceParameters `json:"ephemeralBlockDevice,omitempty" tf:"ephemeral_block_device,omitempty"`
	...
	// +kubebuilder:validation:Optional
	RootBlockDevice []InstanceRequestRootBlockDeviceParameters `json:"rootBlockDevice,omitempty" tf:"root_block_device,omitempty"`
...
type InstanceRequestRootBlockDeviceObservation struct {
	DeviceName *string `json:"deviceName,omitempty" tf:"device_name,omitempty"`

	VolumeID *string `json:"volumeId,omitempty" tf:"volume_id,omitempty"`
}

type InstanceRequestRootBlockDeviceParameters struct {
...
// InstanceRequestSpec defines the desired state of InstanceRequest
type InstanceRequestSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     InstanceRequestParameters `json:"forProvider"`
}

// InstanceRequestStatus defines the observed state of InstanceRequest.
type InstanceRequestStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        InstanceRequestObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// InstanceRequest is the Schema for the InstanceRequests API
...
// InstanceRequestList contains a list of InstanceRequests
...
var (
	InstanceRequest_Kind             = "InstanceRequest"
	InstanceRequest_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: InstanceRequest_Kind}.String()
	InstanceRequest_KindAPIVersion   = InstanceRequest_Kind + "." + CRDGroupVersion.String()
	InstanceRequest_GroupVersionKind = CRDGroupVersion.WithKind(InstanceRequest_Kind)
)

func init() {
	SchemeBuilder.Register(&InstanceRequest{}, &InstanceRequestList{})
}
