...
var (
	DatafeedSubscription_Kind             = "DatafeedSubscription"
	DatafeedSubscription_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DatafeedSubscription_Kind}.String()
	DatafeedSubscription_KindAPIVersion   = DatafeedSubscription_Kind + "." + CRDGroupVersion.String()
	DatafeedSubscription_GroupVersionKind = CRDGroupVersion.WithKind(DatafeedSubscription_Kind)
)
