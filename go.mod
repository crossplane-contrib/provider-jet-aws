...
require (
	github.com/crossplane-contrib/terrajet v0.0.0-20210819124559-48f7e68db859
...
replace github.com/crossplane-contrib/terrajet => /Users/hasanturken/Workspace/crossplane-contrib/terrajet
