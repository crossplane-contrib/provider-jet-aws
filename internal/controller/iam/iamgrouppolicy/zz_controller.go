...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, ps terraform.SetupFn, concurrency int) error {
	name := managed.ControllerName(v1alpha1.IamGroupPolicyGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.IamGroupPolicyGroupVersionKind),
