...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, concurrency int) error {
	name := managed.ControllerName(v1alpha1.Ec2CarrierGatewayGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.Ec2CarrierGatewayGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.Ec2CarrierGateway{}).
		Complete(r)
}
