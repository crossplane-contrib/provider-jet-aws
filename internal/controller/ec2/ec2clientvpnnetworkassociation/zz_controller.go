...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, concurrency int) error {
	name := managed.ControllerName(v1alpha1.Ec2ClientVpnNetworkAssociationGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.Ec2ClientVpnNetworkAssociationGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.Ec2ClientVpnNetworkAssociation{}).
		Complete(r)
}
