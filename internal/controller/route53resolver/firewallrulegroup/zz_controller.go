...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["aws_route53_resolver_firewall_rule_group"].InitializerFns {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["aws_route53_resolver_firewall_rule_group"])),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.FirewallRuleGroup{}).
