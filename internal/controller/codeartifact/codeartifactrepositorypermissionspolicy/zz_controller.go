...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter) error {
	name := managed.ControllerName(v1alpha1.CodeartifactRepositoryPermissionsPolicyGroupVersionKind.String())
	r := managed.NewReconciler(mgr,
		xpresource.ManagedKind(v1alpha1.CodeartifactRepositoryPermissionsPolicyGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.CodeartifactRepositoryPermissionsPolicy{}).
		Complete(r)
}
